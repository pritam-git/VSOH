 ...
 *
 *
 * @filesource /library/PRJ/Entity/Edit/BeforeSave.php
 ...
 *
 */
class PRJ_Entity_Edit_BeforeSave
{
	...
	public function beforeSave($modelID, $modelName, $formValues, $form)
	{
		 ...
		 */
		if(isset($_POST['entity_parent_user_id']) && $_POST['entity_parent_user_id'] !='' ) {
