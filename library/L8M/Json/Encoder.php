 ...
 *
 *
 * @filesource /library/L8M/Json/Encoder.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: Encoder.php 433 2015-09-28 13:41:31Z nm $
 */

/**
 *
 * Encode PHP constructs to JSON
 * makes constant functions out of strings similar to "function:my_function"
 * L8M_Jason_Encoder
 *
 *
 */

class L8M_Json_Encoder
{
    /**
    ...
    protected function _encodeString(&$string)
    {
		...
		if (substr($string, 0, strlen('function:')) == 'function:') {
			return substr($string, strlen('function:'));
		} else {
        	return '"' . $string . '"';
		}
    }
