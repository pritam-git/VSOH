 ...
 */
class L8M_Validate_Alnum extends Zend_Validate_Abstract
{
	...
	public function __construct($allowWhiteSpace = false)
	{
		...
		$this->_messageTemplates[self::INVALID]	= $view->translate("Invalid type given. String, integer or float expected");
		$this->_messageTemplates[self::NOT_ALNUM] = $view->translate("'%value%' contains characters which are non alphabetic and no digits");
