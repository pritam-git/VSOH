 ...
 */
class L8M_Validate_NotEmpty extends Zend_Validate_Abstract
{
	const BOOLEAN		= 1;
	const INTEGER		= 2;
	const FLOAT			= 4;
	...
	public function __construct($options = null)
	{
		...
		$this->_messageTemplates[self::IS_EMPTY] = $view->translate($this->_messageTemplates[self::IS_EMPTY]);
		$this->_messageTemplates[self::INVALID] = $view->translate($this->_messageTemplates[self::INVALID]);
	}
