 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR . 'Hostname.php';
 ...
 */
class L8M_Validate_EmailAddress extends Zend_Validate_Abstract
{
	...
	public function __construct($options = array())
	{
		...
		$this->_messageTemplates[self::INVALID_FORMAT] = $view->translate("'%value%' is no valid email address in the basic format local-part@hostname");
		$this->_messageTemplates[self::INVALID_HOSTNAME] = $view->translate("'%hostname%' is no valid hostname for email address '%value%'");
		$this->_messageTemplates[self::INVALID_MX_RECORD] = $view->translate("'%hostname%' does not appear to have a valid MX record for the email address '%value%'");
		$this->_messageTemplates[self::INVALID_SEGMENT] = $view->translate("'%hostname%' is not in a routable network segment. The email address '%value%' should not be resolved from public network");
		$this->_messageTemplates[self::DOT_ATOM] = $view->translate("'%localPart%' can not be matched against dot-atom format");
		$this->_messageTemplates[self::QUOTED_STRING] = $view->translate("'%localPart%' can not be matched against quoted-string format");
		$this->_messageTemplates[self::INVALID_LOCAL_PART] = $view->translate("'%localPart%' is no valid local part for email address '%value%'");
		$this->_messageTemplates[self::LENGTH_EXCEEDED] = $view->translate("'%value%' exceeds the allowed length");
	}
