 ...
 *
 *
 * @filesource /library/L8M/Controller/Router/Rewirte.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: Rewrite.php 433 2015-09-28 13:41:31Z nm $
 */

/**
 *
 *
 * L8M_Controller_Router_Rewrite
 *
 *
 */
class L8M_Controller_Router_Rewrite extends Zend_Controller_Router_Abstract
{
	 ...
	 */
	public function assemble($userParams, $name = null, $reset = FALSE, $encode = TRUE, $prefetchLink = FALSE)
	{
		if ($name == null) {
			try {
		...
		$url   = $route->assemble($params, $reset, $encode, FALSE, $prefetchLink);
