 ...
 * @version   $Id: Unix.php 435 2015-09-28 15:14:38Z nm $
 */
...
abstract class ZendX_Console_Process_Unix
{
    ...
    public function __construct($puid = null, $guid = null, $umask = null)
    {
        if (substr(PHP_OS, 0, 3) === 'WIN') {
            require_once 'ZendX' . DIRECTORY_SEPARATOR . 'Console' . DIRECTORY_SEPARATOR . 'Process' . DIRECTORY_SEPARATOR . 'Exception.php';
