 ...
 * @version     $Id: UiWidget.php 438 2015-09-29 09:22:47Z nm $
 */
    ...
    public function getDecorators()
    {
        ...
        if(count($decorators) > 0) {
            ...
            if($foundUiWidgetElementMarker === false) {
                require_once 'ZendX' . DIRECTORY_SEPARATOR . 'JQuery' . DIRECTORY_SEPARATOR . 'Form' . DIRECTORY_SEPARATOR . 'Exception.php';
