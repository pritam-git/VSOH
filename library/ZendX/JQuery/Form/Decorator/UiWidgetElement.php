 ...
 * @version     $Id: UiWidgetElement.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Form_Decorator_ViewHelper
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Form' . DIRECTORY_SEPARATOR . 'Decorator' . DIRECTORY_SEPARATOR . 'ViewHelper.php';

/**
 * @see ZendX_JQuery_Form_Decorator_UiWidgetElementMarker
 */
require_once 'ZendX' . DIRECTORY_SEPARATOR . 'JQuery' . DIRECTORY_SEPARATOR . 'Form' . DIRECTORY_SEPARATOR . 'Decorator' . DIRECTORY_SEPARATOR . 'UiWidgetElementMarker.php';
    ...
    implements ZendX_JQuery_Form_Decorator_UiWidgetElementMarker
{
    ...
    public function render($content)
    {
        ...
        if (null === $view) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Form' . DIRECTORY_SEPARATOR . 'Decorator' . DIRECTORY_SEPARATOR . 'Exception.php';
