 ...
 * @version     $Id: Container.php 564 2018-05-10 12:49:13Z nm $
 */

/**
 * @see ZendX_JQuery
 */
require_once 'ZendX' . DIRECTORY_SEPARATOR . 'JQuery.php';
...
//             $scriptTags .= '<script type="text/javascript" src="' . $source . '"></script>'.PHP_EOL;
            ...
            if (L8M_Config::getOption('resources.jquery.migration.enabled')) {
                $httpPrefix = 'http://';
                if($this->_loadSslCdnPath == true) {
                    $httpPrefix = 'https://';
                }
//                 $scriptTags .= '<script type="text/javascript" src="' . $httpPrefix . L8M_Config::getOption('resources.jquery.migration.cdn_url') . 'jquery-migrate-' . L8M_Config::getOption('resources.jquery.migration.version') . '.min.js"></script>' . PHP_EOL;
                $scriptTags .= '<script src="' . $httpPrefix . L8M_Config::getOption('resources.jquery.migration.cdn_url') . 'jquery-migrate-' . L8M_Config::getOption('resources.jquery.migration.version') . '.min.js"></script>' . PHP_EOL;
            }
