 ...
 * @version     $Id: AccordionContainer.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see ZendX_JQuery_View_Helper_UiWidget
 */
require_once 'ZendX' . DIRECTORY_SEPARATOR . 'JQuery' . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR . 'Helper' . DIRECTORY_SEPARATOR . 'UiWidget.php';
...
class ZendX_JQuery_View_Helper_AccordionContainer extends ZendX_JQuery_View_Helper_UiWidget
{
    ...
    public function setElementHtmlTemplate($htmlTemplate)
    {
        if(substr_count($htmlTemplate, '%s') != 2) {
            require_once 'ZendX' . DIRECTORY_SEPARATOR . 'JQuery' . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR . 'Exception.php';
