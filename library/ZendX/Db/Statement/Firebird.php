 ...
 * @version    $Id: Firebird.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Db_Statement
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Statement.php';
...
class ZendX_Db_Statement_Firebird extends Zend_Db_Statement
{
    ...
    public function _prepare($sql)
    {
        ...
        if ($this->_stmtPrepared === false) {
             ...
             */
            require_once 'ZendX' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Statement' . DIRECTORY_SEPARATOR . 'Firebird' . DIRECTORY_SEPARATOR . 'Exception.php';
