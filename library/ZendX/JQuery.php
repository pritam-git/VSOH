 ...
 * @version     $Id: JQuery.php 438 2015-09-29 09:22:47Z nm $
 */
...
class ZendX_JQuery
{
    ...
    {
        $form->addPrefixPath('ZendX_JQuery_Form_Decorator', 'ZendX'. DIRECTORY_SEPARATOR . 'JQuery'. DIRECTORY_SEPARATOR . 'Form'. DIRECTORY_SEPARATOR . 'Decorator', 'decorator')
