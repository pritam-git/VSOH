 ...
 * @version    $Id: Flickr.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_Flickr
{
    ...
    public function tagSearch($query, array $options = array())
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Flickr' . DIRECTORY_SEPARATOR . 'ResultSet.php';
    ...
    public function getImageDetails($id)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Flickr' . DIRECTORY_SEPARATOR . 'Image.php';
    ...
    protected function _validateUserSearch(array $options)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR . 'Int.php';
