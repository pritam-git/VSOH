 ...
 * @version    $Id: SlideShare.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 * Zend_Cache
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cache.php';

/**
 * Zend_Service_SlideShare_SlideShow
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'SlideShare' . DIRECTORY_SEPARATOR . 'SlideShow.php';
...
class Zend_Service_SlideShare
{
    ...
    public function uploadSlideShow(Zend_Service_SlideShare_SlideShow $ss, $make_src_public = true)
    {
        ...
        if(!file_exists($filename) || !is_readable($filename)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'SlideShare' . DIRECTORY_SEPARATOR . 'Exception.php';
