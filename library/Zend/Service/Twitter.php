 ...
 * @version    $Id: Twitter.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Rest' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Result.php';

/**
 * @see Zend_Oauth_Consumer
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Oauth' . DIRECTORY_SEPARATOR . 'Consumer.php';
...
class Zend_Service_Twitter extends Zend_Rest_Client
{
    ...
    public function __get($type)
    {
        if (!in_array($type, $this->_methodTypes)) {
            include_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Twitter' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    protected function _init()
    {
        if (!$this->isAuthorised() && $this->getUsername() !== null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Twitter' . DIRECTORY_SEPARATOR . 'Exception.php';
            throw new Zend_Service_Twitter_Exception(
    ...
    protected function _prepare($path)
    {
        ...
        if (!$this->_uri instanceof Zend_Uri_Http) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Rest' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Exception.php';
