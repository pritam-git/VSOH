 ...
 * @version    $Id: DailyCountsResultSet.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'ResultSet.php';

/**
 * @see Zend_Service_Technorati_Utils
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'Utils.php';
...
class Zend_Service_Technorati_DailyCountsResultSet extends Zend_Service_Technorati_ResultSet
{
    ...
    public function current()
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'DailyCountsResult.php';
