 ...
 * @version    $Id: CosmosResultSet.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_Technorati_CosmosResultSet extends Zend_Service_Technorati_ResultSet
{
    ...
    public function __construct(DomDocument $dom, $options = array())
    {
        ...
        if ($result->length == 1) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'Weblog.php';
    ...
    public function current()
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'CosmosResult.php';
