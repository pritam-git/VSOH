 ...
 * @version    $Id: GetInfoResult.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_Technorati_GetInfoResult
{
    ...
    public function __construct(DomDocument $dom)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'Author.php';
