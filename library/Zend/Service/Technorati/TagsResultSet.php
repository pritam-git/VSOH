 ...
 * @version    $Id: TagsResultSet.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_Technorati_TagsResultSet extends Zend_Service_Technorati_ResultSet
{
    ...
    public function current()
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'TagsResult.php';
