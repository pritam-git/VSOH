 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'StrikeIron' . DIRECTORY_SEPARATOR . 'Decorator.php';
...
class Zend_Service_StrikeIron_Base
{
    ...
    public function __construct($options = array())
    {
        if (!extension_loaded('soap')) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'StrikeIron' . DIRECTORY_SEPARATOR . 'Exception.php';
