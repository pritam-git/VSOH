 ...
 * @version    $Id: Yahoo.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_Yahoo
{
    ...
    public function inlinkDataSearch($query, array $options = array())
    {
        ...
        if ($response->isError()) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Exception.php';
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Yahoo' . DIRECTORY_SEPARATOR . 'InlinkDataResultSet.php';
    ...
    public function imageSearch($query, array $options = array())
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Yahoo' . DIRECTORY_SEPARATOR . 'ImageResultSet.php';
    ...
    public function localSearch($query, array $options = array())
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Yahoo' . DIRECTORY_SEPARATOR . 'LocalResultSet.php';
    ...
    public function newsSearch($query, array $options = array())
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Yahoo' . DIRECTORY_SEPARATOR . 'NewsResultSet.php';
    ...
    public function pageDataSearch($query, array $options = array())
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Yahoo' . DIRECTORY_SEPARATOR . 'PageDataResultSet.php';
    ...
    public function videoSearch($query, array $options = array())
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Yahoo' . DIRECTORY_SEPARATOR . 'VideoResultSet.php';
    ...
    public function webSearch($query, array $options = array())
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Yahoo' . DIRECTORY_SEPARATOR . 'WebResultSet.php';
    ...
    protected function _validateInlinkDataSearch(array $options)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR . 'Between.php';
