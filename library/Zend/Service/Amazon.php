 ...
 * @version    $Id: Amazon.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_Amazon
{
    ...
    public function itemSearch(array $options)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'ResultSet.php';
    ...
    public function itemLookup($asin, array $options = array())
    {
        ...
        if ($items->length == 1) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'Item.php';
