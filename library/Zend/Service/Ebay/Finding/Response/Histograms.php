 ...
 * @version    $Id: Histograms.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Service_Ebay_Finding_Response_Abstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'Abstract.php';
...
class Zend_Service_Ebay_Finding_Response_Histograms extends Zend_Service_Ebay_Finding_Response_Abstract
{
    ...
    protected function _init()
    {
        ...
        if ($node) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'Aspect' . DIRECTORY_SEPARATOR . 'Histogram' . DIRECTORY_SEPARATOR . 'Container.php';
        ...
        if ($node) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'Category' . DIRECTORY_SEPARATOR . 'Histogram' . DIRECTORY_SEPARATOR . 'Container.php';
