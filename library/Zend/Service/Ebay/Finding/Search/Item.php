...
class Zend_Service_Ebay_Finding_Search_Item extends Zend_Service_Ebay_Finding_Abstract
{
    ...
    protected function _init()
    {
        ...
        if ($node) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'ListingInfo.php';
        ...
        if ($node) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'Category.php';
        ...
        if ($node) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'SellerInfo.php';
        ...
        if ($node) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'SellingStatus.php';
        ...
        if ($node) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'ShippingInfo.php';
        ...
        if ($node) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'Storefront.php';
