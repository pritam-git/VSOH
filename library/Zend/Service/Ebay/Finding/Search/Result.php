 ...
 * @version    $Id: Result.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_Ebay_Finding_Search_Result extends Zend_Service_Ebay_Finding_Abstract
{
    ...
    protected function _init()
    {
        ...
        if ($nodes) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Item' . DIRECTORY_SEPARATOR . 'Set.php';
