...
class Zend_Service_Ebay_Finding_Aspect_Histogram_Value_Set extends Zend_Service_Ebay_Finding_Set_Abstract
{
    ...
    public function current()
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'Aspect' . DIRECTORY_SEPARATOR . 'Histogram' . DIRECTORY_SEPARATOR . 'Value.php';
