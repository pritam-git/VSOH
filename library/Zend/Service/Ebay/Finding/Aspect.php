 ...
 * @version    $Id: Aspect.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_Ebay_Finding_Aspect extends Zend_Service_Ebay_Finding_Abstract
{
    ...
    protected function _init()
    {
        ...
        if ($nodes->length > 0) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'Aspect' . DIRECTORY_SEPARATOR . 'Histogram' . DIRECTORY_SEPARATOR . 'Value' . DIRECTORY_SEPARATOR . 'Set.php';
