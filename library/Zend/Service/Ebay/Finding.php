 ...
 * @version    $Id: Finding.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Service_Ebay_Abstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Abstract.php';
...
class Zend_Service_Ebay_Finding extends Zend_Service_Ebay_Abstract
{
    ...
    public function __construct($options)
    {
        ...
        if (is_string($options)) {
            ...
            if (!array_key_exists(self::OPTION_APP_ID, $options)) {
                 ...
                 */
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    protected function _findItems(array $options, $operation)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'Items.php';
    ...
    public function getHistograms($categoryId, $options = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'Histograms.php';
    ...
    public function getSearchKeywordsRecommendation($keywords, $options = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Ebay' . DIRECTORY_SEPARATOR . 'Finding' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'Keywords.php';
