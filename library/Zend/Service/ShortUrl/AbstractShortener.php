 ...
 * @version    $Id: AbstractShortener.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Service_Abstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Abstract.php';

/**
 * @see Zend_Service_ShortUrl_Shortener
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'ShortUrl' . DIRECTORY_SEPARATOR . 'Shortener.php';
    ...
    implements Zend_Service_ShortUrl_Shortener
{
    ...
    protected function _validateUri($url)
    {
        ...
        if (!Zend_Uri::check($url)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'ShortUrl' . DIRECTORY_SEPARATOR . 'Exception.php';
