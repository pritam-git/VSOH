...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'ReCaptcha.php';
 ...
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 * @version    $Id: MailHide.php 435 2015-09-28 15:14:38Z nm $
 */
class Zend_Service_ReCaptcha_MailHide extends Zend_Service_ReCaptcha
{
    ...
    protected function _requireMcrypt()
    {
        if (!extension_loaded('mcrypt')) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'ReCaptcha' . DIRECTORY_SEPARATOR . 'MailHide' . DIRECTORY_SEPARATOR . 'Exception.php';
