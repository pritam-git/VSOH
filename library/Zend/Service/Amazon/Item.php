 ...
 * @version    $Id: Item.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_Amazon_Item
{
    ...
    {
        if (null === $dom) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'Exception.php';
        ...
        foreach (array('SmallImage', 'MediumImage', 'LargeImage') as $im) {
            ...
            if ($result->length == 1) {
                 ...
                 */
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'Image.php';
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'CustomerReview.php';
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'EditorialReview.php';
            foreach ($result as $r) {
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'SimilarProduct.php';
            foreach ($result as $r) {
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'ListmaniaList.php';
            foreach ($result as $r) {
        ...
        if ($result->length > 1 || $resultSummary->length == 1) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'OfferSet.php';
        ...
        if ($result->length > 1) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'Accessories.php';
            foreach ($result as $r) {
