 ...
 * @version    $Id: S3.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_Amazon_S3 extends Zend_Service_Amazon_Abstract
{
    ...
    public function setEndpoint($endpoint)
    {
        ...
        if (!$endpoint->valid()) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'S3' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    public function registerStreamWrapper($name='s3')
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'S3' . DIRECTORY_SEPARATOR . 'Stream.php';
