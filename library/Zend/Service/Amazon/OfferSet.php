 ...
 * @version    $Id: OfferSet.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_Amazon_OfferSet
{
    ...
    public function __construct(DOMElement $dom)
    {
        ...
        if ($offers->length >= 1) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'Offer.php';
