 ...
 * @version    $Id: Sqs.php 435 2015-09-28 15:14:38Z nm $
 */
        ...
        do {
            ...
            if (!isset($result->CreateQueueResult->QueueUrl)
                ...
                if ($result->Error->Code == 'AWS.SimpleQueueService.QueueNameExists') {
                    ...
                    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'Sqs' . DIRECTORY_SEPARATOR . 'Exception.php';
