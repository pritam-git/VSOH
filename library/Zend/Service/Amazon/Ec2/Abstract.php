 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'Ec2' . DIRECTORY_SEPARATOR . 'Response.php';

/**
 * @see Zend_Service_Amazon_Ec2_Exception
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'Ec2' . DIRECTORY_SEPARATOR . 'Exception.php';
