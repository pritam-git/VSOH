 ...
 * @version    $Id: Delicious.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Json' . DIRECTORY_SEPARATOR . 'Decoder.php';

/**
 * @see Zend_Service_Delicious_SimplePost
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Delicious' . DIRECTORY_SEPARATOR . 'SimplePost.php';

/**
 * @see Zend_Service_Delicious_Post
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Delicious' . DIRECTORY_SEPARATOR . 'Post.php';

/**
 * @see Zend_Service_Delicious_PostList
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Delicious' . DIRECTORY_SEPARATOR . 'PostList.php';
...
class Zend_Service_Delicious
{
    ...
    public function getLastUpdate()
    {
        ...
        if ($rootNode && $rootNode->nodeName == 'update') {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Delicious' . DIRECTORY_SEPARATOR . 'Exception.php';
