 ...
 * @version    $Id: Blob.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Service_WindowsAzure_Credentials_CredentialsAbstract_SharedKey
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Credentials' . DIRECTORY_SEPARATOR . 'SharedKey.php';

/**
 * @see Zend_Service_WindowsAzure_Credentials_SharedAccessSignature
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Credentials' . DIRECTORY_SEPARATOR . 'SharedAccessSignature.php';

/**
 * @see Zend_Service_WindowsAzure_RetryPolicy_RetryPolicyAbstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'RetryPolicy' . DIRECTORY_SEPARATOR . 'RetryPolicyAbstract.php';

/**
 * @see Zend_Http_Client
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'Client.php';

/**
 * @see Zend_Http_Response
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'Response.php';

/**
 * @see Zend_Service_WindowsAzure_Storage
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Storage.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_BlobContainer
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'BlobContainer.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_BlobInstance
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'BlobInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_PageRegionInstance
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'PageRegionInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_LeaseInstance
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'LeaseInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_SignedIdentifier
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'SignedIdentifier.php';

/**
 * @see Zend_Service_WindowsAzure_Exception
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Exception.php';
...
class Zend_Service_WindowsAzure_Storage_Blob extends Zend_Service_WindowsAzure_Storage
{
	...
	public function registerStreamWrapper($name = 'azure')
	{
		 ...
		 */
		require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'Blob' . DIRECTORY_SEPARATOR . 'Stream.php';
