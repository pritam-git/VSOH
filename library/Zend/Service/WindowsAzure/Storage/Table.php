 ...
 * @version    $Id: Table.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Service_WindowsAzure_Credentials_CredentialsAbstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Credentials' . DIRECTORY_SEPARATOR . 'CredentialsAbstract.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Credentials' . DIRECTORY_SEPARATOR . 'SharedKeyLite.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'BatchStorageAbstract.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_TableInstance
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'TableInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_TableEntity
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'TableEntity.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_DynamicTableEntity
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'DynamicTableEntity.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_TableEntityQuery
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'TableEntityQuery.php';
