 ...
 * @version    $Id: ConfigurationDataSources.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Service_WindowsAzure_Diagnostics_Exception
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Diagnostics' . DIRECTORY_SEPARATOR . 'Exception.php';

/**
 * @see Zend_Service_WindowsAzure_Diagnostics_ConfigurationObjectBaseAbstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Diagnostics' . DIRECTORY_SEPARATOR . 'ConfigurationObjectBaseAbstract.php';

/**
 * @see Zend_Service_WindowsAzure_Diagnostics_ConfigurationLogs
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Diagnostics' . DIRECTORY_SEPARATOR . 'ConfigurationLogs.php';

/**
 * @see Zend_Service_WindowsAzure_Diagnostics_ConfigurationDiagnosticInfrastructureLogs
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Diagnostics' . DIRECTORY_SEPARATOR . 'ConfigurationDiagnosticInfrastructureLogs.php';

/**
 * @see Zend_Service_WindowsAzure_Diagnostics_ConfigurationPerformanceCounters
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Diagnostics' . DIRECTORY_SEPARATOR . 'ConfigurationPerformanceCounters.php';

/**
 * @see Zend_Service_WindowsAzure_Diagnostics_ConfigurationWindowsEventLog
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Diagnostics' . DIRECTORY_SEPARATOR . 'ConfigurationWindowsEventLog.php';

/**
 * @see Zend_Service_WindowsAzure_Diagnostics_ConfigurationDirectories
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Diagnostics' . DIRECTORY_SEPARATOR . 'ConfigurationDirectories.php';
