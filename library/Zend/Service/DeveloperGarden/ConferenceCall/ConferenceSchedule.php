 ...
 * @version    $Id: ConferenceSchedule.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_DeveloperGarden_ConferenceCall_ConferenceSchedule
{
    ...
    public function setRecurring($recurring)
    {
        if (!array_key_exists($recurring, $this->_recurringValues)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'ConferenceCall' . DIRECTORY_SEPARATOR . 'Exception.php';
