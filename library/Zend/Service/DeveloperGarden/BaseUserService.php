 ...
 * @version    $Id: BaseUserService.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'BaseUserService' . DIRECTORY_SEPARATOR . 'GetQuotaInformationResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_BaseUserService_ChangeQuotaPoolResponse
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'BaseUserService' . DIRECTORY_SEPARATOR . 'ChangeQuotaPoolResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_BaseUserService_GetAccountBalanceResponse
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'BaseUserService' . DIRECTORY_SEPARATOR . 'GetAccountBalanceResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_BaseUserService_AccountBalance
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'BaseUserService' . DIRECTORY_SEPARATOR . 'AccountBalance.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_BaseUserService_GetQuotaInformation
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Request' . DIRECTORY_SEPARATOR . 'BaseUserService' . DIRECTORY_SEPARATOR . 'GetQuotaInformation.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_BaseUserService_ChangeQuotaPool
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Request' . DIRECTORY_SEPARATOR . 'BaseUserService' . DIRECTORY_SEPARATOR . 'ChangeQuotaPool.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_BaseUserService_GetAccountBalance
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Request' . DIRECTORY_SEPARATOR . 'BaseUserService' . DIRECTORY_SEPARATOR . 'GetAccountBalance.php';
...
class Zend_Service_DeveloperGarden_BaseUserService extends Zend_Service_DeveloperGarden_Client_ClientAbstract
{
    ...
    protected function _checkModuleId($moduleId)
    {
        if (!in_array($moduleId, $this->_moduleIds)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Exception.php';
