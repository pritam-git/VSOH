 ...
 * @version    $Id: ClientAbstract.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Service_DeveloperGarden_Client_Soap
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Soap.php';

/**
 * @see Zend_Service_DeveloperGarden_Credential
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Credential.php';

/**
 * @see Zend_Service_DeveloperGarden_SecurityTokenServer
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'SecurityTokenServer.php';
...
abstract class Zend_Service_DeveloperGarden_Client_ClientAbstract
{
    ...
    public function __construct(array $options = array())
    {
        ...
        if (empty($this->_wsdlFile)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Exception.php';
