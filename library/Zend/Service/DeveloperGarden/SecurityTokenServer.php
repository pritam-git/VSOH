 ...
 * @version    $Id: SecurityTokenServer.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Service_DeveloperGarden_SecurityTokenServer_Cache
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'SecurityTokenServer' . DIRECTORY_SEPARATOR . 'Cache.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'SecurityTokenServer' . DIRECTORY_SEPARATOR . 'SecurityTokenResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_SecurityTokenServer_GetTokensResponse
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'SecurityTokenServer' . DIRECTORY_SEPARATOR . 'GetTokensResponse.php';
