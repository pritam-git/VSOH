 ...
 * @version    $Id: SendSms.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'SendSms' . DIRECTORY_SEPARATOR . 'SendSMSResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_SendSms_SendFlashSMSResponse
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'SendSms' . DIRECTORY_SEPARATOR . 'SendFlashSMSResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_SendSms_SendSMS
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Request' . DIRECTORY_SEPARATOR . 'SendSms' . DIRECTORY_SEPARATOR . 'SendSMS.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_SendSms_SendFlashSMS
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Request' . DIRECTORY_SEPARATOR . 'SendSms' . DIRECTORY_SEPARATOR . 'SendFlashSMS.php';
