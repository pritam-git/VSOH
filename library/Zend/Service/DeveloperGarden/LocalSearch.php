 ...
 * @version    $Id: LocalSearch.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'LocalSearch' . DIRECTORY_SEPARATOR . 'LocalSearchResponseType.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_LocalSearch_LocalSearchRequest
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Request' . DIRECTORY_SEPARATOR . 'LocalSearch' . DIRECTORY_SEPARATOR . 'LocalSearchRequest.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_LocalSearch_LocalSearchResponse
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'LocalSearch' . DIRECTORY_SEPARATOR . 'LocalSearchResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_LocalSearch_SearchParameters
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'LocalSearch' . DIRECTORY_SEPARATOR . 'SearchParameters.php';
