 ...
 * @version    $Id: SearchParameters.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_DeveloperGarden_LocalSearch_SearchParameters
{
    ...
    public function setHits($hits = 10)
    {
        ...
        if (!$validator->isValid($hits)) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'LocalSearch' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR . 'NotEmpty.php';
