 ...
 * @version    $Id: SecurityTokenResponse.php 435 2015-09-28 15:14:38Z nm $
 */
    ...
    implements Zend_Service_DeveloperGarden_Response_SecurityTokenServer_Interface
{
    ...
    public function getTokenData()
    {
        if (empty($this->tokenData)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'Exception.php';
