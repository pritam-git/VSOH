 ...
 * @version    $Id: RemoveConferenceTemplateParticipantResponse.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Service_DeveloperGarden_Response_ConferenceCall_ConferenceCallAbstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'DeveloperGarden' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'ConferenceCall' . DIRECTORY_SEPARATOR . 'ConferenceCallAbstract.php';
