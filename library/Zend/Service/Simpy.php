 ...
 * @version    $Id: Simpy.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Service_Simpy
{
    ...
    public function getTags($limit = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Simpy' . DIRECTORY_SEPARATOR . 'TagSet.php';
    ...
    public function getLinks(Zend_Service_Simpy_LinkQuery $q = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Simpy' . DIRECTORY_SEPARATOR . 'LinkSet.php';
    ...
    public function getWatchlists()
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Simpy' . DIRECTORY_SEPARATOR . 'WatchlistSet.php';
    ...
    public function getWatchlist($watchlistId)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Simpy' . DIRECTORY_SEPARATOR . 'Watchlist.php';
    ...
    public function getNotes($q = null, $limit = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Simpy' . DIRECTORY_SEPARATOR . 'NoteSet.php';
