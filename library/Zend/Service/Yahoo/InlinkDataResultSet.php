 ...
 * @version    $Id: InlinkDataResultSet.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Yahoo' . DIRECTORY_SEPARATOR . 'ResultSet.php';


/**
 * @see Zend_Service_Yahoo_WebResult
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Yahoo' . DIRECTORY_SEPARATOR . 'InlinkDataResult.php';
