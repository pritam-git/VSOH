...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'ReCaptcha' . DIRECTORY_SEPARATOR . 'Response.php';
 ...
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 * @version    $Id: ReCaptcha.php 435 2015-09-28 15:14:38Z nm $
 */
class Zend_Service_ReCaptcha extends Zend_Service_Abstract
{
    ...
    public function setParams($params)
    {
        ...
        if (is_array($params)) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'ReCaptcha' . DIRECTORY_SEPARATOR . 'Exception.php';
