 ...
 * @version    $Id: Technorati.php 509 2016-07-27 14:24:23Z nm $
 */
...
class Zend_Service_Technorati
{
    ...
    public function cosmos($url, $options = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'CosmosResultSet.php';
    ...
    public function search($query, $options = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'SearchResultSet.php';
    ...
    public function tag($tag, $options = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'TagResultSet.php';
    ...
    public function dailyCounts($query, $options = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'DailyCountsResultSet.php';
    ...
    public function topTags($options = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'TagsResultSet.php';
    ...
    public function blogInfo($url, $options = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'BlogInfoResult.php';
    ...
    public function getInfo($username, $options = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'GetInfoResult.php';
    ...
    public function keyInfo()
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'KeyInfoResult.php';
    ...
    public function getRestClient()
    {
        if ($this->_restClient === null) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Rest' . DIRECTORY_SEPARATOR . 'Client.php';
    ...
    protected function _validateDailyCounts(array $options)
    {
        ...
        if (isset($options['days'])) {
            ...
            if ($options['days'] < self::PARAM_DAYS_MIN_VALUE ||
                 ...
                 */
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Technorati' . DIRECTORY_SEPARATOR . 'Exception.php';
