 ...
 * @version    $Id: MailMerge.php 435 2015-09-28 15:14:38Z nm $
 */
...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'LiveDocx.php';
...
class Zend_Service_LiveDocx_MailMerge extends Zend_Service_LiveDocx
{
    ...
    public function setLocalTemplate($filename)
    {
        ...
        try {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'LiveDocx' . DIRECTORY_SEPARATOR . 'Exception.php';
            throw new Zend_Service_LiveDocx_Exception(
