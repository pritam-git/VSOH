 ...
 * @version    $Id: ServerIntrospection.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_XmlRpc_Client_ServerIntrospection
{
    ...
    public function getSignatureForEachMethodByMulticall($methods = null)
    {
        ...
        if (! is_array($serverSignatures)) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'IntrospectException.php';
