 ...
 * @version    $Id: Server.php 445 2015-09-29 11:32:47Z nm $
 */

/**
 * Extends Zend_Server_Abstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Abstract.php';

/**
 * XMLRPC Request
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Request.php';

/**
 * XMLRPC Response
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Response.php';

/**
 * XMLRPC HTTP Response
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'Http.php';

/**
 * XMLRPC server fault class
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Fault.php';

/**
 * XMLRPC server system methods class
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'System.php';

/**
 * Convert PHP to and from xmlrpc native types
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Value.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Reflection' . DIRECTORY_SEPARATOR . 'Function' . DIRECTORY_SEPARATOR . 'Abstract.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Reflection' . DIRECTORY_SEPARATOR . 'Method.php';
 ...
 * Example:
 * <code>
 * require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Server.php';
 * require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Cache.php';
 * require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Fault.php';
...
class Zend_XmlRpc_Server extends Zend_Server_Abstract
{
    ...
    public function __call($method, $params)
    {
        ...
        if (!method_exists($system, $method)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    public function handle($request = false)
    {
        ...
        if ((!$request || !$request instanceof Zend_XmlRpc_Request)
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Request' . DIRECTORY_SEPARATOR . 'Http.php';
