 ...
 * @version    $Id: Client.php 509 2016-07-27 14:24:23Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'ServerProxy.php';

/**
 * Introspects remote servers using the XML-RPC de facto system.* methods
 * @see Zend_XmlRpc_Client_ServerIntrospection
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'ServerIntrospection.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Fault.php';
   ...
   /**
    ...
    public function doRequest($request, $response = null)
    {
        ...
        if (! $httpResponse->isSuccessful()) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'HttpException.php';
    ...
    public function call($method, $params=array())
    {
        ...
        if ($this->_lastResponse->isFault()) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'XmlRpc' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'FaultException.php';
