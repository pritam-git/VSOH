 ...
 * @version    $Id: Mail.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Transport' . DIRECTORY_SEPARATOR . 'Abstract.php';

/**
 * @see Zend_Mime
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mime.php';

/**
 * @see Zend_Mime_Message
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mime' . DIRECTORY_SEPARATOR . 'Message.php';

/**
 * @see Zend_Mime_Part
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mime' . DIRECTORY_SEPARATOR . 'Part.php';
...
class Zend_Mail extends Zend_Mime_Message
{
    ...
    public function setType($type)
    {
        ...
        if (!in_array($type, $allowed)) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    public function send($transport = null)
    {
        if ($transport === null) {
            if (! self::$_defaultTransport instanceof Zend_Mail_Transport_Abstract) {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Transport' . DIRECTORY_SEPARATOR . 'Sendmail.php';
