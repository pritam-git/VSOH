 ...
 * @version    $Id: Http.php 435 2015-09-28 15:14:38Z nm $
 */
    ...
    public function __construct($uri = null)
    {
        if (null !== $uri) {
            ...
            if ($uri->valid()) {
                ...
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Request' . DIRECTORY_SEPARATOR . 'Exception.php';
