 ...
 * @version    $Id: ActionStack.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Controller_Action_Helper_ActionStack extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function __construct()
    {
        ...
        if (!$front->hasPlugin('Zend_Controller_Plugin_ActionStack')) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Plugin' . DIRECTORY_SEPARATOR . 'ActionStack.php';
    ...
    public function actionToStack($action, $controller = null, $module = null, array $params = array())
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Request' . DIRECTORY_SEPARATOR . 'Simple.php';
