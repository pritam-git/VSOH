 ...
 * @version    $Id: ViewRenderer.php 448 2015-09-30 08:16:17Z nm $
 */

/**
 * @see Zend_Controller_Action_Helper_Abstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Helper' . DIRECTORY_SEPARATOR . 'Abstract.php';

/**
 * @see Zend_View
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'View.php';
...
class Zend_Controller_Action_Helper_ViewRenderer extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function getModuleDirectory()
    {
        ...
        if ((null === $moduleDir) || is_array($moduleDir)) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    public function getInflector()
    {
        if (null === $this->_inflector) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Inflector.php';
            /**
             * @see Zend_Filter_PregReplace
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'PregReplace.php';
            /**
             * @see Zend_Filter_Word_UnderscoreToSeparator
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Word' . DIRECTORY_SEPARATOR . 'UnderscoreToSeparator.php';
    ...
    {
        return str_replace('/', DIRECTORY_SEPARATOR, $this->_viewBasePathSpec);
    }
    ...
    {
        return str_replace('/', DIRECTORY_SEPARATOR, $this->_viewScriptPathSpec);
    }
    ...
    {
        return str_replace('/', DIRECTORY_SEPARATOR, $this->_viewScriptPathNoControllerSpec);
    }
    ...
    {
        $scriptAction = $this->_scriptAction;
        if ($scriptAction) {
            $scriptAction = str_replace('/', DIRECTORY_SEPARATOR, $scriptAction);
        }
        return $scriptAction;
    }
    ...
    {
        $responseSegment = $this->_responseSegment;
        if ($responseSegment) {
            $responseSegment = str_replace('/', DIRECTORY_SEPARATOR, $responseSegment);
        }
