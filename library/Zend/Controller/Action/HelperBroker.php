 ...
 * @version    $Id: HelperBroker.php 440 2015-09-29 09:30:45Z nm $
 */

/**
 * @see Zend_Controller_Action_HelperBroker_PriorityStack
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'HelperBroker' . DIRECTORY_SEPARATOR . 'PriorityStack.php';
    ...
    public static function getPluginLoader()
    {
        if (null === self::$_pluginLoader) {
            ...
            self::$_pluginLoader = new Zend_Loader_PluginLoader(array(
                'Zend_Controller_Action_Helper' => 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Helper' . DIRECTORY_SEPARATOR,
            ));
        }
