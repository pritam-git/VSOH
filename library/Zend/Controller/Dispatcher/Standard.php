 ...
 * @version    $Id: Standard.php 435 2015-09-28 15:14:38Z nm $
 */
...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Dispatcher' . DIRECTORY_SEPARATOR . 'Abstract.php';
    ...
    public function dispatch(Zend_Controller_Request_Abstract $request, Zend_Controller_Response_Abstract $response)
    {
        ...
        if (!$this->isDispatchable($request)) {
            ...
            if (!$this->getParam('useDefaultControllerAlways') && !empty($controller)) {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Dispatcher' . DIRECTORY_SEPARATOR . 'Exception.php';
