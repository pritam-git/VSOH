 ...
 * @version    $Id: Action.php 435 2015-09-28 15:14:38Z nm $
 */
...
abstract class Zend_Pdf_Action extends Zend_Pdf_Target implements RecursiveIterator, Countable
{
    ...
    public static function load(Zend_Pdf_Element $dictionary, SplObjectStorage $processedActions = null)
    {
        ...
        switch ($dictionary->S->value) {
            case 'GoTo':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'GoTo.php';
                return new Zend_Pdf_Action_GoTo($dictionary, $processedActions);
                break;

            case 'GoToR':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'GoToR.php';
                return new Zend_Pdf_Action_GoToR($dictionary, $processedActions);
                break;

            case 'GoToE':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'GoToE.php';
                return new Zend_Pdf_Action_GoToE($dictionary, $processedActions);
                break;

            case 'Launch':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Launch.php';
                return new Zend_Pdf_Action_Launch($dictionary, $processedActions);
                break;

            case 'Thread':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Thread.php';
                return new Zend_Pdf_Action_Thread($dictionary, $processedActions);
                break;

            case 'URI':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'URI.php';
                return new Zend_Pdf_Action_URI($dictionary, $processedActions);
                break;

            case 'Sound':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Sound.php';
                return new Zend_Pdf_Action_Sound($dictionary, $processedActions);
                break;

            case 'Movie':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Movie.php';
                return new Zend_Pdf_Action_Movie($dictionary, $processedActions);
                break;

            case 'Hide':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Hide.php';
                return new Zend_Pdf_Action_Hide($dictionary, $processedActions);
                break;

            case 'Named':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Named.php';
                return new Zend_Pdf_Action_Named($dictionary, $processedActions);
                break;

            case 'SubmitForm':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'SubmitForm.php';
                return new Zend_Pdf_Action_SubmitForm($dictionary, $processedActions);
                break;

            case 'ResetForm':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'ResetForm.php';
                return new Zend_Pdf_Action_ResetForm($dictionary, $processedActions);
                break;

            case 'ImportData':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'ImportData.php';
                return new Zend_Pdf_Action_ImportData($dictionary, $processedActions);
                break;

            case 'JavaScript':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'JavaScript.php';
                return new Zend_Pdf_Action_JavaScript($dictionary, $processedActions);
                break;

            case 'SetOCGState':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'SetOCGState.php';
                return new Zend_Pdf_Action_SetOCGState($dictionary, $processedActions);
                break;

            case 'Rendition':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Rendition.php';
                return new Zend_Pdf_Action_Rendition($dictionary, $processedActions);
                break;

            case 'Trans':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Trans.php';
                return new Zend_Pdf_Action_Trans($dictionary, $processedActions);
                break;

            case 'GoTo3DView':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'GoTo3DView.php';
                return new Zend_Pdf_Action_GoTo3DView($dictionary, $processedActions);
                break;

            default:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Unknown.php';
