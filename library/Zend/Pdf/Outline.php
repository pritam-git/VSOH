 ...
 * @version    $Id: Outline.php 435 2015-09-28 15:14:38Z nm $
 */
...
abstract class Zend_Pdf_Outline implements RecursiveIterator, Countable
{
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Outline' . DIRECTORY_SEPARATOR . 'Created.php';
        if (is_string($param1)) {
