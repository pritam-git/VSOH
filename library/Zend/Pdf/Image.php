...
abstract class Zend_Pdf_Image
{
  ...
  /* Factory Methods */
    ...
    public static function imageWithPath($filePath)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'ImageFactory.php';
    ...
    protected static function _extractJpegImage($dataSource)
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'FileParser' . DIRECTORY_SEPARATOR . 'Image' . DIRECTORY_SEPARATOR . 'Jpeg.php';
        $imageParser = new Zend_Pdf_FileParser_Image_Jpeg($dataSource);
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Image' . DIRECTORY_SEPARATOR . 'Jpeg.php';
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'FileParser' . DIRECTORY_SEPARATOR . 'Image' . DIRECTORY_SEPARATOR . 'Png.php';
        $imageParser = new Zend_Pdf_FileParser_Image_Png($dataSource);
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Image' . DIRECTORY_SEPARATOR . 'Png.php';
    ...
    protected static function _extractTiffImage($dataSource)
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'FileParser' . DIRECTORY_SEPARATOR . 'Image' . DIRECTORY_SEPARATOR . 'Tiff.php';
        $imageParser = new Zend_Pdf_FileParser_Image_Tiff($dataSource);
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Image' . DIRECTORY_SEPARATOR . 'Tiff.php';
