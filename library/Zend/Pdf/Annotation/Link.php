 ...
 * @version    $Id: Link.php 435 2015-09-28 15:14:38Z nm $
 */
...
/** Zend_Pdf_Annotation */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Annotation.php';
...
class Zend_Pdf_Annotation_Link extends Zend_Pdf_Annotation
{
    ...
    public function getDestination()
    {
        ...
        if ($this->_annotationDictionary->Dest !== null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Destination.php';
            return Zend_Pdf_Destination::load($this->_annotationDictionary->Dest);
        } else {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Action.php';
