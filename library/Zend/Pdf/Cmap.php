 ...
 * @version    $Id: Cmap.php 435 2015-09-28 15:14:38Z nm $
 */
    ...
    public static function cmapWithTypeData($cmapType, $cmapData)
    {
        switch ($cmapType) {
            case Zend_Pdf_Cmap::TYPE_BYTE_ENCODING:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Cmap' . DIRECTORY_SEPARATOR . 'ByteEncoding.php';
                return new Zend_Pdf_Cmap_ByteEncoding($cmapData);

            case Zend_Pdf_Cmap::TYPE_BYTE_ENCODING_STATIC:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Cmap' . DIRECTORY_SEPARATOR . 'ByteEncoding' . DIRECTORY_SEPARATOR . 'Static.php';
            ...
            case Zend_Pdf_Cmap::TYPE_SEGMENT_TO_DELTA:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Cmap' . DIRECTORY_SEPARATOR . 'SegmentToDelta.php';
                return new Zend_Pdf_Cmap_SegmentToDelta($cmapData);

            case Zend_Pdf_Cmap::TYPE_TRIMMED_TABLE:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Cmap' . DIRECTORY_SEPARATOR . 'TrimmedTable.php';
