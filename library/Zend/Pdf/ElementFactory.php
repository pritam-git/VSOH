 ...
 * @version    $Id: ElementFactory.php 435 2015-09-28 15:14:38Z nm $
 */


/** Zend_Pdf_ElementFactory_Interface */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'ElementFactory' . DIRECTORY_SEPARATOR . 'Interface.php';
...
class Zend_Pdf_ElementFactory implements Zend_Pdf_ElementFactory_Interface
{
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'ElementFactory' . DIRECTORY_SEPARATOR . 'Proxy.php';
    ...
    public function listModifiedObjects($rootFactory = null)
    {
        ...
        $result = array();
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'UpdateInfoContainer.php';
