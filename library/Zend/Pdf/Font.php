 ...
 * @version    $Id: Font.php 435 2015-09-28 15:14:38Z nm $
 */
...
abstract class Zend_Pdf_Font
{
  ...
  /* Factory Methods */
    ...
    public static function fontWithName($name, $embeddingOptions = 0)
        ...
        switch ($name) {
            case Zend_Pdf_Font::FONT_COURIER:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'Courier.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_Courier();
                break;

            case Zend_Pdf_Font::FONT_COURIER_BOLD:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'CourierBold.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_CourierBold();
                break;

            case Zend_Pdf_Font::FONT_COURIER_OBLIQUE:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'CourierOblique.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_CourierOblique();
                break;

            case Zend_Pdf_Font::FONT_COURIER_BOLD_OBLIQUE:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'CourierBoldOblique.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_CourierBoldOblique();
                break;

            case Zend_Pdf_Font::FONT_HELVETICA:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'Helvetica.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_Helvetica();
                break;

            case Zend_Pdf_Font::FONT_HELVETICA_BOLD:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'HelveticaBold.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_HelveticaBold();
                break;

            case Zend_Pdf_Font::FONT_HELVETICA_OBLIQUE:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'HelveticaOblique.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_HelveticaOblique();
                break;

            case Zend_Pdf_Font::FONT_HELVETICA_BOLD_OBLIQUE:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'HelveticaBoldOblique.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_HelveticaBoldOblique();
                break;

            case Zend_Pdf_Font::FONT_SYMBOL:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'Symbol.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_Symbol();
                break;

            case Zend_Pdf_Font::FONT_TIMES_ROMAN:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'TimesRoman.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_TimesRoman();
                break;

            case Zend_Pdf_Font::FONT_TIMES_BOLD:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'TimesBold.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_TimesBold();
                break;

            case Zend_Pdf_Font::FONT_TIMES_ITALIC:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'TimesItalic.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_TimesItalic();
                break;

            case Zend_Pdf_Font::FONT_TIMES_BOLD_ITALIC:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'TimesBoldItalic.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_TimesBoldItalic();
                break;

            case Zend_Pdf_Font::FONT_ZAPFDINGBATS:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Standard' . DIRECTORY_SEPARATOR . 'ZapfDingbats.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Standard_ZapfDingbats();
                break;

            default:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    public static function fontWithPath($filePath, $embeddingOptions = 0)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'FileParserDataSource' . DIRECTORY_SEPARATOR . 'File.php';
  ...
  /* Font Extraction Methods */
    ...
    {
        try {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'FileParser' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'OpenType' . DIRECTORY_SEPARATOR . 'TrueType.php';
            $fontParser = new Zend_Pdf_FileParser_Font_OpenType_TrueType($dataSource);

            $fontParser->parse();
            if ($fontParser->isAdobeLatinSubset) {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Simple' . DIRECTORY_SEPARATOR . 'Parsed' . DIRECTORY_SEPARATOR . 'TrueType.php';
                $font = new Zend_Pdf_Resource_Font_Simple_Parsed_TrueType($fontParser, $embeddingOptions);
            } else {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'CidFont' . DIRECTORY_SEPARATOR . 'TrueType.php';
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Type0.php';
