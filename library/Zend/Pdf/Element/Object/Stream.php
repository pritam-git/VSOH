 ...
 * @version    $Id: Stream.php 435 2015-09-28 15:14:38Z nm $
 */


/** Internally used classes */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Element' . DIRECTORY_SEPARATOR . 'Stream.php';
...
class Zend_Pdf_Element_Object_Stream extends Zend_Pdf_Element_Object
{
    ...
    private function _decodeStream()
    {
        ...
        foreach ($this->_initialDictionaryData['Filter'] as $id => $filterName ) {
            ...
            switch ($filterName) {
                case 'ASCIIHexDecode':
                    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'AsciiHex.php';
                    $valueRef = Zend_Pdf_Filter_AsciiHex::decode($valueRef);
                    break;

                case 'ASCII85Decode':
                    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Ascii85.php';
                    $valueRef = Zend_Pdf_Filter_Ascii85::decode($valueRef);
                    break;

                case 'FlateDecode':
                    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Compression' . DIRECTORY_SEPARATOR . 'Flate.php';
                    $valueRef = Zend_Pdf_Filter_Compression_Flate::decode($valueRef,
                                                                          $this->_initialDictionaryData['DecodeParms'][$id]);
                    break;

                case 'LZWDecode':
                    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Compression' . DIRECTORY_SEPARATOR . 'Lzw.php';
                    $valueRef = Zend_Pdf_Filter_Compression_Lzw::decode($valueRef,
                                                                        $this->_initialDictionaryData['DecodeParms'][$id]);
                    break;

                case 'RunLengthDecode':
                    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'RunLength.php';
