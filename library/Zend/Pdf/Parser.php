 ...
 * @version    $Id: Parser.php 435 2015-09-28 15:14:38Z nm $
 */
...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'StringParser.php';
...
class Zend_Pdf_Parser
{
    ...
    private function _loadXRefTable($offset)
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Element' . DIRECTORY_SEPARATOR . 'Reference' . DIRECTORY_SEPARATOR . 'Table.php';
        $refTable = new Zend_Pdf_Element_Reference_Table();
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Element' . DIRECTORY_SEPARATOR . 'Reference' . DIRECTORY_SEPARATOR . 'Context.php';
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Trailer' . DIRECTORY_SEPARATOR . 'Keeper.php';
