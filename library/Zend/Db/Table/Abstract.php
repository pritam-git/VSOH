...
abstract class Zend_Db_Table_Abstract
{
    ...
    public function getReference($tableClassname, $ruleKey = null)
    {
        ...
        if ($ruleKey !== null) {
            if (!isset($refMap[$ruleKey])) {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Table' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Table' . DIRECTORY_SEPARATOR . 'Select.php';
