 ...
 * @version    $Id: Profiler.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Db_Profiler
{
    ...
    public function queryStart($queryText, $queryType = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Profiler' . DIRECTORY_SEPARATOR . 'Query.php';
    ...
    public function queryEnd($queryId)
    {
        ...
        if (!isset($this->_queryProfiles[$queryId])) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Profiler' . DIRECTORY_SEPARATOR . 'Exception.php';
