 ...
 * @version    $Id: Oracle.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Statement' . DIRECTORY_SEPARATOR . 'Oracle.php';
...
class Zend_Db_Adapter_Oracle extends Zend_Db_Adapter_Abstract
{
    ...
    protected function _connect()
    {
        ...
        if (!extension_loaded('oci8')) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Oracle' . DIRECTORY_SEPARATOR . 'Exception.php';
