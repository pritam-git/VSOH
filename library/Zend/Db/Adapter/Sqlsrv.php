 ...
 * @version    $Id: Sqlsrv.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Statement' . DIRECTORY_SEPARATOR . 'Sqlsrv.php';
...
class Zend_Db_Adapter_Sqlsrv extends Zend_Db_Adapter_Abstract
{
    ...
    protected function _connect()
    {
        ...
        if (!extension_loaded('sqlsrv')) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Sqlsrv' . DIRECTORY_SEPARATOR . 'Exception.php';
