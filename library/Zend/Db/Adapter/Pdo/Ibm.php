 ...
 * @version    $Id: Ibm.php 435 2015-09-28 15:14:38Z nm $
 */


/** @see Zend_Db_Adapter_Pdo_Abstract */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Pdo' . DIRECTORY_SEPARATOR . 'Abstract.php';

/** @see Zend_Db_Abstract_Pdo_Ibm_Db2 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Pdo' . DIRECTORY_SEPARATOR . 'Ibm' . DIRECTORY_SEPARATOR . 'Db2.php';

/** @see Zend_Db_Abstract_Pdo_Ibm_Ids */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Pdo' . DIRECTORY_SEPARATOR . 'Ibm' . DIRECTORY_SEPARATOR . 'Ids.php';

/** @see Zend_Db_Statement_Pdo_Ibm */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Statement' . DIRECTORY_SEPARATOR . 'Pdo' . DIRECTORY_SEPARATOR . 'Ibm.php';
