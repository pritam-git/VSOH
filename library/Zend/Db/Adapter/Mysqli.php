 ...
 * @version    $Id: Mysqli.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Abstract.php';

/**
 * @see Zend_Db_Profiler
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Profiler.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Statement' . DIRECTORY_SEPARATOR . 'Mysqli.php';
...
class Zend_Db_Adapter_Mysqli extends Zend_Db_Adapter_Abstract
{
    ...
    public function listTables()
    {
        ...
        if ($queryResult = $this->getConnection()->query($sql)) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Mysqli' . DIRECTORY_SEPARATOR . 'Exception.php';
