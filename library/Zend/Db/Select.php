 ...
 * @version    $Id: Select.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 * @see Zend_Db_Expr
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Expr.php';
...
class Zend_Db_Select
{
    ...
    public function columns($cols = '*', $correlationName = null)
    {
        ...
        if (!array_key_exists($correlationName, $this->_parts[self::FROM])) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Select' . DIRECTORY_SEPARATOR . 'Exception.php';
