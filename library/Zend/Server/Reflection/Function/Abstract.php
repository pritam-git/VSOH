 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Reflection' . DIRECTORY_SEPARATOR . 'Node.php';

/**
 * Zend_Server_Reflection_Parameter
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Reflection' . DIRECTORY_SEPARATOR . 'Parameter.php';

/**
 * Zend_Server_Reflection_Prototype
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Reflection' . DIRECTORY_SEPARATOR . 'Prototype.php';
...
abstract class Zend_Server_Reflection_Function_Abstract
{
    ...
    public function __construct(Reflector $r, $namespace = null, $argv = array())
    {
        ...
        if ((!$r instanceof ReflectionFunction)
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Reflection' . DIRECTORY_SEPARATOR . 'Exception.php';
