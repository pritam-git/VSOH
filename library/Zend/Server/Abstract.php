 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Definition.php';

/**
 * Zend_Server_Method_Definition
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Method' . DIRECTORY_SEPARATOR . 'Definition.php';

/**
 * Zend_Server_Method_Callback
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Method' . DIRECTORY_SEPARATOR . 'Callback.php';

/**
 * Zend_Server_Method_Prototype
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Method' . DIRECTORY_SEPARATOR . 'Prototype.php';

/**
 * Zend_Server_Method_Parameter
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Method' . DIRECTORY_SEPARATOR . 'Parameter.php';
...
abstract class Zend_Server_Abstract implements Zend_Server_Interface
{
    ...
    protected function _buildSignature(Zend_Server_Reflection_Function_Abstract $reflection, $class = null)
    {
        ...
        if (!$this->_overwriteExistingMethods && $this->_table->hasMethod($method)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Exception.php';
