...
class Zend_Http_UserAgent implements Serializable
{
    ...
    public function setOptions($options)
    {
        ...
        if (!is_array($options)
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'UserAgent' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    public function setPluginLoader($type, $loader)
    {
        ...
        $basePath   = 'Zend' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'UserAgent' . DIRECTORY_SEPARATOR;
        switch ($type) {
            case 'storage':
