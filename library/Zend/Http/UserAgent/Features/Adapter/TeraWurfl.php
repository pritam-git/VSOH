 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'UserAgent' . DIRECTORY_SEPARATOR . 'Features' . DIRECTORY_SEPARATOR . 'Adapter.php';
    ...
    public static function getFromRequest($request, array $config)
    {
        if (!class_exists('TeraWurfl')) {
            ...
            if (!isset($config['terawurfl'])) {
                // No configuration
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'UserAgent' . DIRECTORY_SEPARATOR . 'Features' . DIRECTORY_SEPARATOR . 'Exception.php';
