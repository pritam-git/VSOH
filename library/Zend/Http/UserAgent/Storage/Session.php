 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'UserAgent' . DIRECTORY_SEPARATOR . 'Storage.php';
...
class Zend_Http_UserAgent_Storage_Session implements Zend_Http_UserAgent_Storage
{
    ...
    public function __construct($options = null)
    {
        ...
        if (null !== $options && !is_array($options)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'UserAgent' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'Exception.php';
