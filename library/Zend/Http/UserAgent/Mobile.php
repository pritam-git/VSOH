...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'UserAgent' . DIRECTORY_SEPARATOR . 'AbstractDevice.php';
...
class Zend_Http_UserAgent_Mobile extends Zend_Http_UserAgent_AbstractDevice
{
    ...
    public function __construct($userAgent = null, array $server = array(), array $config = array())
    {
        ...
        if (empty($config['mobile']['features'])) {
            $config['mobile']['features']['path']      = str_replace('/', DIRECTORY_SEPARATOR, self::DEFAULT_FEATURES_ADAPTER_PATH);
