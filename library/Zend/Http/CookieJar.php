 ...
 * @version    $Id: CookieJar.php 435 2015-09-28 15:14:38Z nm $
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'Cookie.php';
/**
...
class Zend_Http_CookieJar implements Countable, IteratorAggregate
{
    ...
    public function addCookie($cookie, $ref_uri = null, $encodeValue = true)
    {
        ...
        if ($cookie instanceof Zend_Http_Cookie) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'Exception.php';
