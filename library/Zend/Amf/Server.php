 ...
 * @version    $Id: Server.php 439 2015-09-29 09:27:15Z nm $
 */

/** @see Zend_Server_Interface */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Interface.php';

/** @see Zend_Server_Reflection */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Reflection.php';

/** @see Zend_Amf_Constants */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Amf' . DIRECTORY_SEPARATOR . 'Constants.php';

/** @see Zend_Amf_Value_MessageBody */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Amf' . DIRECTORY_SEPARATOR . 'Value' . DIRECTORY_SEPARATOR . 'MessageBody.php';

/** @see Zend_Amf_Value_MessageHeader */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Amf' . DIRECTORY_SEPARATOR . 'Value' . DIRECTORY_SEPARATOR . 'MessageHeader.php';

/** @see Zend_Amf_Value_Messaging_CommandMessage */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Amf' . DIRECTORY_SEPARATOR . 'Value' . DIRECTORY_SEPARATOR . 'Messaging' . DIRECTORY_SEPARATOR . 'CommandMessage.php';

/** @see Zend_Loader_PluginLoader */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Loader' . DIRECTORY_SEPARATOR . 'PluginLoader.php';

/** @see Zend_Amf_Parse_TypeLoader */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Amf' . DIRECTORY_SEPARATOR . 'Parse' . DIRECTORY_SEPARATOR . 'TypeLoader.php';
...
class Zend_Amf_Server implements Zend_Server_Interface
{
    ...
    {
        Zend_Amf_Parse_TypeLoader::setResourceLoader(new Zend_Loader_PluginLoader(array("Zend_Amf_Parse_Resource" => "Zend" . DIRECTORY_SEPARATOR . "Amf" . DIRECTORY_SEPARATOR . "Parse" . DIRECTORY_SEPARATOR . "Resource")));
    }
   ...
   /**
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Session.php';
        $this->_session = true;
    ...
    protected function _checkAcl($object, $function)
    {
        ...
        if($object) {
            ...
            if(!$this->_acl->has($class)) {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Acl' . DIRECTORY_SEPARATOR . 'Resource.php';
        ...
        if($auth->hasIdentity()) {
            ...
            if($this->_acl->hasRole(Zend_Amf_Constants::GUEST_ROLE)) {
                ...
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Amf' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Amf' . DIRECTORY_SEPARATOR . 'Value' . DIRECTORY_SEPARATOR . 'Messaging' . DIRECTORY_SEPARATOR . 'AcknowledgeMessage.php';
    ...
    protected function _errorMessage($objectEncoding, $message, $description, $detail, $code, $line)
    {
        ...
        switch ($objectEncoding) {
            ...
            case Zend_Amf_Constants::AMF3_OBJECT_ENCODING :
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Amf' . DIRECTORY_SEPARATOR . 'Value' . DIRECTORY_SEPARATOR . 'Messaging' . DIRECTORY_SEPARATOR . 'ErrorMessage.php';
    ...
    public function getRequest()
    {
        if (null === $this->_request) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Amf' . DIRECTORY_SEPARATOR . 'Request' . DIRECTORY_SEPARATOR . 'Http.php';
    ...
    public function getResponse()
    {
        if (null === ($response = $this->_response)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Amf' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'Http.php';
