 ...
 * @version    $Id: TypeLoader.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Amf' . DIRECTORY_SEPARATOR . 'Value' . DIRECTORY_SEPARATOR . 'Messaging' . DIRECTORY_SEPARATOR . 'AsyncMessage.php';
/**
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Amf' . DIRECTORY_SEPARATOR . 'Value' . DIRECTORY_SEPARATOR . 'Messaging' . DIRECTORY_SEPARATOR . 'RemotingMessage.php';
...
final class Zend_Amf_Parse_TypeLoader
{
    ...
    {
        if(!self::$_resourceLoader) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Amf' . DIRECTORY_SEPARATOR . 'Exception.php';
