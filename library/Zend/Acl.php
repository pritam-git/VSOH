 ...
 * @version    $Id: Acl.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Acl' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Interface.php';


/**
 * @see Zend_Acl_Role_Registry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Acl' . DIRECTORY_SEPARATOR . 'Role' . DIRECTORY_SEPARATOR . 'Registry.php';


/**
 * @see Zend_Acl_Assert_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Acl' . DIRECTORY_SEPARATOR . 'Assert' . DIRECTORY_SEPARATOR . 'Interface.php';


/**
 * @see Zend_Acl_Role
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Acl' . DIRECTORY_SEPARATOR . 'Role.php';
...
class Zend_Acl
{
    ...
    public function addRole($role, $parents = null)
    {
        ...
        if (!$role instanceof Zend_Acl_Role_Interface) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Acl' . DIRECTORY_SEPARATOR . 'Exception.php';
