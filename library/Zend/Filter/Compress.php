 ...
 * @version    $Id: Compress.php 442 2015-09-29 11:02:02Z nm $
 */

/**
 * @see Zend_Filter_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Interface.php';
...
class Zend_Filter_Compress implements Zend_Filter_Interface
{
    ...
    public function getAdapter()
    {
        ...
        if (!class_exists($adapter)) {
            ...
            if (Zend_Loader::isReadable('Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Compress' . DIRECTORY_SEPARATOR . ucfirst($adapter) . '.php')) {
