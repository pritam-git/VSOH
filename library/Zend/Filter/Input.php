 ...
 * @version    $Id: Input.php 442 2015-09-29 11:02:02Z nm $
 */
 ...
 * @see Zend_Validate
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Validate.php';
    ...
    public function setPluginLoader(Zend_Loader_PluginLoader_Interface $loader, $type)
    {
        ...
        switch ($type) {
            ...
            case self::VALIDATE:
                ...
                return $this;
            default:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Exception.php';
        ...
        if (!isset($this->_loaders[$type])) {
            switch ($type) {
                case self::FILTER:
                    ...
                    $pathSegment   = 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR;
                    break;
                case self::VALIDATE:
                    $prefixSegment = 'Zend_Validate_';
                    $pathSegment   = 'Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR;
                    break;
                default:
                    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Exception.php';
