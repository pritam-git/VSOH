 ...
 * @version    $Id: Encrypt.php 442 2015-09-29 11:02:02Z nm $
 */
...
class Zend_Filter_Encrypt implements Zend_Filter_Interface
{
    ...
    public function setAdapter($options = null)
    {
        ...
        if (Zend_Loader::isReadable('Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Encrypt' . DIRECTORY_SEPARATOR . ucfirst($adapter). '.php')) {
