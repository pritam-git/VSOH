 ...
 * @version    $Id: Inflector.php 442 2015-09-29 11:02:02Z nm $
 */
...
class Zend_Filter_Inflector implements Zend_Filter_Interface
{
    ...
    public function getPluginLoader()
    {
        if (!$this->_pluginLoader instanceof Zend_Loader_PluginLoader_Interface) {
            $this->_pluginLoader = new Zend_Loader_PluginLoader(array('Zend_Filter_' => 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR), __CLASS__);
        }
