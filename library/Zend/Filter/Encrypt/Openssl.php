 ...
 * @version    $Id: Openssl.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Filter_Encrypt_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Encrypt' . DIRECTORY_SEPARATOR . 'Interface.php';
...
class Zend_Filter_Encrypt_Openssl implements Zend_Filter_Encrypt_Interface
{
    ...
    public function encrypt($value)
    {
        ...
        if (!empty($this->_compression)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Compress.php';
    ...
    public function decrypt($value)
    {
        ...
        if (!empty($this->_compression)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Decompress.php';
