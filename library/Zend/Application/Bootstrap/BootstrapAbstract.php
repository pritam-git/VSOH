 ...
 * @version    $Id: BootstrapAbstract.php 439 2015-09-29 09:27:15Z nm $
 */
               ...
               Zend_Application_Bootstrap_ResourceBootstrapper
{
    ...
    public function getPluginLoader()
    {
        if ($this->_pluginLoader === null) {
            $options = array(
                'Zend_Application_Resource'  => 'Zend' . DIRECTORY_SEPARATOR . 'Application' . DIRECTORY_SEPARATOR . 'Resource',
                'ZendX_Application_Resource' => 'ZendX' . DIRECTORY_SEPARATOR . 'Application' . DIRECTORY_SEPARATOR . 'Resource'
            );
