 ...
 * @version    $Id: Translate.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Application_Resource_ResourceAbstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Application' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'ResourceAbstract.php';
    ...
    public function getTranslate()
    {
        if (null === $this->_translate) {
            ...
            if (!isset($options['content']) && !isset($options['data'])) {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Application' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Exception.php';
