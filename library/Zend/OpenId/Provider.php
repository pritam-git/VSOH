 ...
 * @version    $Id: Provider.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_OpenId_Provider
{
                                ...
                                $sessionTtl = 3600)
    {
        ...
        if ($user === null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'OpenId' . DIRECTORY_SEPARATOR . 'Provider' . DIRECTORY_SEPARATOR . 'User' . DIRECTORY_SEPARATOR . 'Session.php';
            $this->_user = new Zend_OpenId_Provider_User_Session();
        } else {
            $this->_user = $user;
        }
        if ($storage === null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'OpenId' . DIRECTORY_SEPARATOR . 'Provider' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'File.php';
