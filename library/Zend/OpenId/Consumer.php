 ...
 * @see Zend_OpenId
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'OpenId.php';

/**
 * @see Zend_OpenId_Extension
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'OpenId' . DIRECTORY_SEPARATOR . 'Extension.php';

/**
 * @see Zend_OpenId_Consumer_Storage
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'OpenId' . DIRECTORY_SEPARATOR . 'Consumer' . DIRECTORY_SEPARATOR . 'Storage.php';
...
class Zend_OpenId_Consumer
{
    ...
    {
        if ($storage === null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'OpenId' . DIRECTORY_SEPARATOR . 'Consumer' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'File.php';
    ...
    public function verify($params, &$identity = "", $extensions = null)
    {
        ...
        if ($version < 2.0 && !isset($params["openid_claimed_id"])) {
            if ($this->_session !== null) {
                ...
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Session' . DIRECTORY_SEPARATOR . 'Namespace.php';
