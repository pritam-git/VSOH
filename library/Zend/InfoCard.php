 ...
 * @version    $Id: InfoCard.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * Zend_InfoCard_Xml_EncryptedData
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'EncryptedData.php';

/**
 * Zend_InfoCard_Xml_Assertion
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'Assertion.php';

/**
 * Zend_InfoCard_Cipher
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Cipher.php';

/**
 * Zend_InfoCard_Xml_Security
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'Security.php';

/**
 * Zend_InfoCard_Adapter_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Interface.php';

/**
 * Zend_InfoCard_Claims
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Claims.php';
...
class Zend_InfoCard
{
    ...
    public function __construct()
    {
        ...
        if(!extension_loaded('mcrypt')) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    public function getAdapter()
    {
        if($this->_adapter === null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Default.php';
