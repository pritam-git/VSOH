...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'Sqs.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'QueueService' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'AbstractAdapter.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'QueueService' . DIRECTORY_SEPARATOR . 'Exception.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'QueueService' . DIRECTORY_SEPARATOR . 'Message.php';
    ...
    public function deleteQueue($queueId, $options = null)
{
    ...
    public function storeQueueMetadata($queueId, $metadata, $options = null)
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'OperationNotAvailableException.php';
