...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'DocumentService' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'SimpleDb' . DIRECTORY_SEPARATOR . 'Query.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'DocumentService' . DIRECTORY_SEPARATOR . 'Exception.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'Amazon' . DIRECTORY_SEPARATOR . 'SimpleDb.php';
