...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'DocumentService' . DIRECTORY_SEPARATOR . 'Adapter.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'DocumentService' . DIRECTORY_SEPARATOR . 'Document.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'DocumentService' . DIRECTORY_SEPARATOR . 'DocumentSet.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'DocumentService' . DIRECTORY_SEPARATOR . 'Query.php';
