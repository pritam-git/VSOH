...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'DocumentService' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'AbstractAdapter.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'DocumentService' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Query.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'DocumentService' . DIRECTORY_SEPARATOR . 'Exception.php';
...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Service' . DIRECTORY_SEPARATOR . 'WindowsAzure' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'Table.php';
