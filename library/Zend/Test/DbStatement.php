 ...
 * @version    $Id: DbStatement.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Db_Statement_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Statement' . DIRECTORY_SEPARATOR . 'Interface.php';
