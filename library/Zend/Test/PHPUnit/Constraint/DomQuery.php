 ...
 * @version    $Id: DomQuery.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Test_PHPUnit_Constraint_DomQuery extends PHPUnit_Framework_Constraint
{
    ...
    public function evaluate($other, $assertType = null)
    {
        ...
        if (!in_array($assertType, $this->_assertTypes)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Test' . DIRECTORY_SEPARATOR . 'PHPUnit' . DIRECTORY_SEPARATOR . 'Constraint' . DIRECTORY_SEPARATOR . 'Exception.php';
