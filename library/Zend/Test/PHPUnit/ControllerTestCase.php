 ...
 * @version    $Id: ControllerTestCase.php 435 2015-09-28 15:14:38Z nm $
 */
...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Front.php';

/** @see Zend_Controller_Action_HelperBroker */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'HelperBroker.php';

/** @see Zend_Layout */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Layout.php';
...
abstract class Zend_Test_PHPUnit_ControllerTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function assertQuery($path, $message = '')
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Test' . DIRECTORY_SEPARATOR . 'PHPUnit' . DIRECTORY_SEPARATOR . 'Constraint' . DIRECTORY_SEPARATOR . 'DomQuery.php';
    ...
    {
        $this->_incrementAssertionCount();
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Test' . DIRECTORY_SEPARATOR . 'PHPUnit' . DIRECTORY_SEPARATOR . 'Constraint' . DIRECTORY_SEPARATOR . 'Redirect.php';
    ...
    {
        $this->_incrementAssertionCount();
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Test' . DIRECTORY_SEPARATOR . 'PHPUnit' . DIRECTORY_SEPARATOR . 'Constraint' . DIRECTORY_SEPARATOR . 'ResponseHeader.php';
    ...
    public function getRequest()
    {
        if (null === $this->_request) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Request' . DIRECTORY_SEPARATOR . 'HttpTestCase.php';
    ...
    public function getResponse()
    {
        if (null === $this->_response) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'HttpTestCase.php';
    ...
    {
        if (null === $this->_query) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Dom' . DIRECTORY_SEPARATOR . 'Query.php';
