 ...
 * @version    $Id: DatabaseTestCase.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Test' . DIRECTORY_SEPARATOR . 'PHPUnit' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Operation' . DIRECTORY_SEPARATOR . 'Truncate.php';

/**
 * @see Zend_Test_PHPUnit_Db_Operation_Insert
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Test' . DIRECTORY_SEPARATOR . 'PHPUnit' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Operation' . DIRECTORY_SEPARATOR . 'Insert.php';

/**
 * @see Zend_Test_PHPUnit_Db_DataSet_DbTableDataSet
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Test' . DIRECTORY_SEPARATOR . 'PHPUnit' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'DataSet' . DIRECTORY_SEPARATOR . 'DbTableDataSet.php';

/**
 * @see Zend_Test_PHPUnit_Db_DataSet_DbTable
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Test' . DIRECTORY_SEPARATOR . 'PHPUnit' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'DataSet' . DIRECTORY_SEPARATOR . 'DbTable.php';

/**
 * @see Zend_Test_PHPUnit_Db_DataSet_DbRowset
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Test' . DIRECTORY_SEPARATOR . 'PHPUnit' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'DataSet' . DIRECTORY_SEPARATOR . 'DbRowset.php';
