 ...
 * @version   $Id: Table.php 444 2015-09-29 11:21:03Z nm $
 */
...
class Zend_Text_Table
{
    ...
    public function __construct($options = null)
    {
        ...
        if ($this->_columnWidths === null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Text' . DIRECTORY_SEPARATOR . 'Table' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    public function getPluginLoader()
    {
        if ($this->_pluginLoader === null) {
            ...
            $pathPrefix = 'Zend' . DIRECTORY_SEPARATOR . 'Text' . DIRECTORY_SEPARATOR . 'Table' . DIRECTORY_SEPARATOR . 'Decorator' . DIRECTORY_SEPARATOR;
    ...
    public function appendRow($row)
    {
        ...
        if (is_array($row)) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Text' . DIRECTORY_SEPARATOR . 'Table' . DIRECTORY_SEPARATOR . 'Row.php';
