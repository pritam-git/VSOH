 ...
 * @version    $Id: ShMem.php 435 2015-09-28 15:14:38Z nm $
 */


/** @see Zend_Cache_Backend_Interface */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cache' . DIRECTORY_SEPARATOR . 'Backend' . DIRECTORY_SEPARATOR . 'Interface.php';

/** @see Zend_Cache_Backend_ZendServer */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Cache' . DIRECTORY_SEPARATOR . 'Backend' . DIRECTORY_SEPARATOR . 'ZendServer.php';
