 ...
 * @version    $Id: Db.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Queue_Adapter_AdapterAbstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Queue' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'AdapterAbstract.php';

/**
 * @see Zend_Db_Select
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Select.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Queue' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Queue.php';

/**
 * @see Zend_Queue_Adapter_Db_Message
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Queue' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Message.php';
...
class Zend_Queue_Adapter_Db extends Zend_Queue_Adapter_AdapterAbstract
{
    ...
    public function __construct($options, Zend_Queue $queue = null)
    {
        ...
        if (!is_bool($this->_options['options'][Zend_Db_Select::FOR_UPDATE])) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Queue' . DIRECTORY_SEPARATOR . 'Exception.php';
