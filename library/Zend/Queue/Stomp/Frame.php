 ...
 * @version    $Id: Frame.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Queue_Stomp_FrameInterface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Queue' . DIRECTORY_SEPARATOR . 'Stomp' . DIRECTORY_SEPARATOR . 'FrameInterface.php';
