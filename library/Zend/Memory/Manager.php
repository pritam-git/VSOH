...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Memory' . DIRECTORY_SEPARATOR . 'Container' . DIRECTORY_SEPARATOR . 'Movable.php';

/** Zend_Memory_Container_Locked */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Memory' . DIRECTORY_SEPARATOR . 'Container' . DIRECTORY_SEPARATOR . 'Locked.php';

/** Zend_Memory_AccessController */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Memory' . DIRECTORY_SEPARATOR . 'AccessController.php';
...
class Zend_Memory_Manager
{
    ...
    private function _swapCheck()
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Memory' . DIRECTORY_SEPARATOR . 'Exception.php';
