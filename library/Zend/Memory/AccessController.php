 ...
 * @version    $Id: AccessController.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * Zend_Memory_Container_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Memory' . DIRECTORY_SEPARATOR . 'Container' . DIRECTORY_SEPARATOR . 'Interface.php';
