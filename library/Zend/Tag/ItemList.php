 ...
 * @version    $Id: ItemList.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Tag_Taggable
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tag' . DIRECTORY_SEPARATOR . 'Taggable.php';
...
class Zend_Tag_ItemList implements Countable, SeekableIterator, ArrayAccess
{
    ...
    public function spreadWeightValues(array $values)
    {
        ...
        if (count($values) === 0) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tag' . DIRECTORY_SEPARATOR . 'Exception.php';
