 ...
 * @version    $Id: Cloud.php 444 2015-09-29 11:21:03Z nm $
 */

/**
 * @see Zend_Tag_Item
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tag' . DIRECTORY_SEPARATOR . 'Item.php';
...
class Zend_Tag_Cloud
{
    ...
    public function setTags(array $tags)
    {
        ...
        foreach ($tags as $tag) {
            if ($tag instanceof Zend_Tag_Taggable) {
                ...
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tag' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    {
        if (null === $this->_tags) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tag' . DIRECTORY_SEPARATOR . 'ItemList.php';
    ...
    public function getPluginLoader()
    {
        if ($this->_pluginLoader === null) {
            ...
            $pathPrefix = 'Zend' . DIRECTORY_SEPARATOR . 'Tag' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'Decorator' . DIRECTORY_SEPARATOR;
