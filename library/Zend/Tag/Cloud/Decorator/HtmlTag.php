 ...
 * @version    $Id: HtmlTag.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Tag_Cloud_Decorator_Tag
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tag' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'Decorator' . DIRECTORY_SEPARATOR . 'Tag.php';
    ...
    public function setClassList(array $classList = null)
    {
        if (is_array($classList)) {
            if (count($classList) === 0) {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tag' . DIRECTORY_SEPARATOR . 'Cloud' . DIRECTORY_SEPARATOR . 'Decorator' . DIRECTORY_SEPARATOR . 'Exception.php';
