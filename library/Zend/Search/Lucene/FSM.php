 ...
 * @version    $Id: FSM.php 435 2015-09-28 15:14:38Z nm $
 */

/** Zend_Search_Lucene_FSMAction */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'FSMAction.php';
...
abstract class Zend_Search_Lucene_FSM
{
    ...
    public function setState($state)
    {
        if (!isset($this->_states[$state])) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Exception.php';
