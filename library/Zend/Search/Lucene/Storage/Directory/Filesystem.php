 ...
 * @version    $Id: Filesystem.php 435 2015-09-28 15:14:38Z nm $
 */


/** Zend_Search_Lucene_Storage_Directory */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'Directory.php';
...
class Zend_Search_Lucene_Storage_Directory_Filesystem extends Zend_Search_Lucene_Storage_Directory
{
    ...
    public function createFile($filename)
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'File' . DIRECTORY_SEPARATOR . 'Filesystem.php';
