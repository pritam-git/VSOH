 ...
 * @version    $Id: Analyzer.php 435 2015-09-28 15:14:38Z nm $
 */
...
if (!defined('ZEND_SEARCH_LUCENE_COMMON_ANALYZER_PROCESSED')) {
    ...
    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Analysis' . DIRECTORY_SEPARATOR . 'Analyzer' . DIRECTORY_SEPARATOR . 'Common' . DIRECTORY_SEPARATOR . 'Utf8' . DIRECTORY_SEPARATOR . 'CaseInsensitive.php';

    /** Zend_Search_Lucene_Analysis_Analyzer_Common_Utf8Num */
    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Analysis' . DIRECTORY_SEPARATOR . 'Analyzer' . DIRECTORY_SEPARATOR . 'Common' . DIRECTORY_SEPARATOR . 'Utf8Num.php';

    /** Zend_Search_Lucene_Analysis_Analyzer_Common_Utf8Num_CaseInsensitive */
    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Analysis' . DIRECTORY_SEPARATOR . 'Analyzer' . DIRECTORY_SEPARATOR . 'Common' . DIRECTORY_SEPARATOR . 'Utf8Num' . DIRECTORY_SEPARATOR . 'CaseInsensitive.php';

    /** Zend_Search_Lucene_Analysis_Analyzer_Common_Text */
    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Analysis' . DIRECTORY_SEPARATOR . 'Analyzer' . DIRECTORY_SEPARATOR . 'Common' . DIRECTORY_SEPARATOR . 'Text.php';

    /** Zend_Search_Lucene_Analysis_Analyzer_Common_Text_CaseInsensitive */
    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Analysis' . DIRECTORY_SEPARATOR . 'Analyzer' . DIRECTORY_SEPARATOR . 'Common' . DIRECTORY_SEPARATOR . 'Text' . DIRECTORY_SEPARATOR . 'CaseInsensitive.php';
    ...
    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Analysis' . DIRECTORY_SEPARATOR . 'Analyzer' . DIRECTORY_SEPARATOR . 'Common' . DIRECTORY_SEPARATOR . 'TextNum' . DIRECTORY_SEPARATOR . 'CaseInsensitive.php';
}
