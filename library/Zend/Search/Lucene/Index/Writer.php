 ...
 * @version    $Id: Writer.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Search_Lucene_Index_Writer
{
    ...
    public function addDocument(Zend_Search_Lucene_Document $document)
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Index' . DIRECTORY_SEPARATOR . 'SegmentWriter' . DIRECTORY_SEPARATOR . 'DocumentWriter.php';
    ...
    private function _mergeSegments($segments)
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Index' . DIRECTORY_SEPARATOR . 'SegmentMerger.php';
