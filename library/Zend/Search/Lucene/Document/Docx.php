 ...
 * @version    $Id: Docx.php 435 2015-09-28 15:14:38Z nm $
 */

/** Zend_Search_Lucene_Document_OpenXml */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Document' . DIRECTORY_SEPARATOR . 'OpenXml.php';
...
class Zend_Search_Lucene_Document_Docx extends Zend_Search_Lucene_Document_OpenXml {
    ...
    public static function loadDocxFile($fileName, $storeContent = false) {
        if (!is_readable($fileName)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Document' . DIRECTORY_SEPARATOR . 'Exception.php';
