 ...
 * @version    $Id: QueryParser.php 435 2015-09-28 15:14:38Z nm $
 */
...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'QueryToken.php';



/** Zend_Search_Lucene_FSM */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'FSM.php';
...
class Zend_Search_Lucene_Search_QueryParser extends Zend_Search_Lucene_FSM
{
    ...
    public function __construct()
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'QueryLexer.php';
    ...
    public static function parse($strQuery, $encoding = null)
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'QueryParserException.php';
        try {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'QueryParserContext.php';
            ...
            if (self::$_instance->_suppressQueryParsingExceptions) {
                ...
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Index' . DIRECTORY_SEPARATOR . 'Term.php';
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'QueryEntry' . DIRECTORY_SEPARATOR . 'Term.php';
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'QueryEntry' . DIRECTORY_SEPARATOR . 'Phrase.php';
    ...
    public function subqueryEnd()
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'QueryEntry' . DIRECTORY_SEPARATOR . 'Subquery.php';
