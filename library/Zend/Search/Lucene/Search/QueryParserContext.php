 ...
 * @version    $Id: QueryParserContext.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Search_Lucene_Search_QueryParserContext
{
    ...
    private function _booleanExpressionQuery()
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'BooleanExpressionRecognizer.php';
