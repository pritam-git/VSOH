 ...
 * @version    $Id: Similarity.php 435 2015-09-28 15:14:38Z nm $
 */
...
abstract class Zend_Search_Lucene_Search_Similarity
{
    ...
    public static function getDefault()
    {
        if (!self::$_defaultImpl instanceof Zend_Search_Lucene_Search_Similarity) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Similarity' . DIRECTORY_SEPARATOR . 'Default.php';
