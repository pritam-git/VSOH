...
class Zend_Search_Lucene_Search_QueryEntry_Phrase extends Zend_Search_Lucene_Search_QueryEntry
{
    ...
    public function getQuery($encoding)
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Query' . DIRECTORY_SEPARATOR . 'Preprocessing' . DIRECTORY_SEPARATOR . 'Phrase.php';
