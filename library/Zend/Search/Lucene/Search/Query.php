 ...
 * @version    $Id: Query.php 435 2015-09-28 15:14:38Z nm $
 */
...
abstract class Zend_Search_Lucene_Search_Query
{
    ...
    {
        if ($highlighter === null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Highlighter' . DIRECTORY_SEPARATOR . 'Default.php';
