 ...
 * @version    $Id: MultiTerm.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Search_Lucene_Search_Query_MultiTerm extends Zend_Search_Lucene_Search_Query
{
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Weight' . DIRECTORY_SEPARATOR . 'MultiTerm.php';
