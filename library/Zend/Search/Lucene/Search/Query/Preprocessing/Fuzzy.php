 ...
 * @version    $Id: Fuzzy.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Search_Lucene_Search_Query_Preprocessing_Fuzzy extends Zend_Search_Lucene_Search_Query_Preprocessing
{
    ...
    public function rewrite(Zend_Search_Lucene_Interface $index)
    {
        if ($this->_field === null) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Lucene' . DIRECTORY_SEPARATOR . 'Search' . DIRECTORY_SEPARATOR . 'Query' . DIRECTORY_SEPARATOR . 'Preprocessing' . DIRECTORY_SEPARATOR . 'Fuzzy.php';
