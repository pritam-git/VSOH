 ...
 * @version    $Id: Session.php 435 2015-09-28 15:14:38Z nm $
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Session' . DIRECTORY_SEPARATOR . 'Abstract.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Session' . DIRECTORY_SEPARATOR . 'SaveHandler' . DIRECTORY_SEPARATOR . 'Interface.php';
    ...
    public static function setOptions(array $userOptions = array())
    {
        ...
        foreach ($userOptions as $userOptionName => $userOptionValue) {
            ...
            elseif (isset(self::$_localOptions[$userOptionName])) {
                ...
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Session' . DIRECTORY_SEPARATOR . 'Exception.php';
