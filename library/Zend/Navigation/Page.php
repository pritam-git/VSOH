 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Navigation' . DIRECTORY_SEPARATOR . 'Container.php';
...
abstract class Zend_Navigation_Page extends Zend_Navigation_Container
{
    ...
    public static function factory($options)
    {
        ...
        if ($hasMvc) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Navigation' . DIRECTORY_SEPARATOR . 'Page' . DIRECTORY_SEPARATOR . 'Mvc.php';
            return new Zend_Navigation_Page_Mvc($options);
        } elseif ($hasUri) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Navigation' . DIRECTORY_SEPARATOR . 'Page' . DIRECTORY_SEPARATOR . 'Uri.php';
