 ...
 * @version    $Id: BigInteger.php 441 2015-09-29 09:41:22Z nm $
 */
...
class Zend_Crypt_Math_BigInteger
{
    ...
    public function __construct($extension = null)
    {
        if ($extension !== null && !in_array($extension, array('bcmath', 'gmp', 'bigint'))) {
            require_once('Zend' . DIRECTORY_SEPARATOR . 'Crypt' . DIRECTORY_SEPARATOR . 'Math' . DIRECTORY_SEPARATOR . 'BigInteger' . DIRECTORY_SEPARATOR . 'Exception.php');
    ...
    protected function _loadAdapter($extension = null)
    {
        ...
        if($extension == 'gmp' && extension_loaded('gmp')) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Crypt' . DIRECTORY_SEPARATOR . 'Math' . DIRECTORY_SEPARATOR . 'BigInteger' . DIRECTORY_SEPARATOR . 'Gmp.php';
            $this->_math = new Zend_Crypt_Math_BigInteger_Gmp();
        //} elseif($extension == 'bigint' && extension_loaded('big_int')) {
        //    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Crypt_Math' . DIRECTORY_SEPARATOR . 'BigInteger' . DIRECTORY_SEPARATOR . 'Bigint.php';
        //    $this->_math = new Zend_Crypt_Math_BigInteger_Bigint();
        } elseif ($extension == 'bcmath' && extension_loaded('bcmath')) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Crypt' . DIRECTORY_SEPARATOR . 'Math' . DIRECTORY_SEPARATOR . 'BigInteger' . DIRECTORY_SEPARATOR . 'Bcmath.php';
