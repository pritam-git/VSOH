 ...
 * @version    $Id: DiffieHellman.php 434 2015-09-28 13:52:37Z nm $
 */
...
class Zend_Crypt_DiffieHellman
{
    ...
    public function setPublicKey($number, $type = self::NUMBER)
    {
        ...
        if (!preg_match("/^\d+$/", $number)) {
            require_once('Zend' . DIRECTORY_SEPARATOR . 'Crypt' . DIRECTORY_SEPARATOR . 'DiffieHellman' . DIRECTORY_SEPARATOR . 'Exception.php');
    ...
    public function setBigIntegerMath($extension = null)
    {
         ...
         * @see Zend_Crypt_Math
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Crypt' . DIRECTORY_SEPARATOR . 'Math.php';
