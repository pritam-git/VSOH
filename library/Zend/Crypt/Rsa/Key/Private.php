 ...
 * @version    $Id: Private.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Crypt_Rsa_Key
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Crypt' . DIRECTORY_SEPARATOR . 'Rsa' . DIRECTORY_SEPARATOR . 'Key.php';
...
class Zend_Crypt_Rsa_Key_Private extends Zend_Crypt_Rsa_Key
{
    ...
    protected function _parse($passPhrase)
    {
        ...
        if (!$result) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Crypt' . DIRECTORY_SEPARATOR . 'Exception.php';
