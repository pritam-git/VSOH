 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Crypt' . DIRECTORY_SEPARATOR . 'Rsa' . DIRECTORY_SEPARATOR . 'Key' . DIRECTORY_SEPARATOR . 'Private.php';

/**
 * @see Zend_Crypt_Rsa_Key_Public
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Crypt' . DIRECTORY_SEPARATOR . 'Rsa' . DIRECTORY_SEPARATOR . 'Key' . DIRECTORY_SEPARATOR . 'Public.php';
...
class Zend_Crypt_Rsa
{
    ...
    public function __construct(array $options = null)
    {
        if (!extension_loaded('openssl')) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Crypt' . DIRECTORY_SEPARATOR . 'Rsa' . DIRECTORY_SEPARATOR . 'Exception.php';
