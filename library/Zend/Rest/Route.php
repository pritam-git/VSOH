 ...
 * @version    $Id: Route.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Controller_Router_Route_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Router' . DIRECTORY_SEPARATOR . 'Route' . DIRECTORY_SEPARATOR . 'Interface.php';

/**
 * @see Zend_Controller_Router_Route_Module
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Router' . DIRECTORY_SEPARATOR . 'Route' . DIRECTORY_SEPARATOR . 'Module.php';

/**
 * @see Zend_Controller_Dispatcher_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Dispatcher' . DIRECTORY_SEPARATOR . 'Interface.php';
