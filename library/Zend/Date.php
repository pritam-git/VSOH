 ...
 * @version   $Id: Date.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * Include needed Date classes
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Date' . DIRECTORY_SEPARATOR . 'DateObject.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Locale.php';
                ...
                switch($name) {
                    case 'format_type' :
                        if ((strtolower($value) != 'php') && (strtolower($value) != 'iso')) {
                            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Date' . DIRECTORY_SEPARATOR . 'Exception.php';
