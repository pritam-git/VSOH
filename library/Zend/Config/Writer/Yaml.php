 ...
 * @version    $Id: Yaml.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Config_Writer
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Config' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'FileAbstract.php';

/**
 * @see Zend_Config_Yaml
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Config' . DIRECTORY_SEPARATOR . 'Yaml.php';
...
class Zend_Config_Writer_Yaml extends Zend_Config_Writer_FileAbstract
{
    ...
    public function setYamlEncoder($yamlEncoder)
    {
        if (!is_callable($yamlEncoder)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Config' . DIRECTORY_SEPARATOR . 'Exception.php';
