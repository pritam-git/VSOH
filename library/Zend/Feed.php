...
class Zend_Feed
{
    ...
    public static function importString($string)
    {
        ...
        if ($doc->getElementsByTagName('feed')->item(0) ||
             ...
             * @see Zend_Feed_Atom
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Atom.php';
        ...
        if ($doc->getElementsByTagName('channel')->item(0)) {
             ...
             * @see Zend_Feed_Rss
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Rss.php';
    ...
    public static function importArray(array $data, $format = 'atom')
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Builder.php';
