 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Db' . DIRECTORY_SEPARATOR . 'Table' . DIRECTORY_SEPARATOR . 'Row' . DIRECTORY_SEPARATOR . 'Abstract.php';
    ...
    implements Zend_Session_SaveHandler_Interface
{
    ...
    public function __construct($config)
    {
        if ($config instanceof Zend_Config) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Session' . DIRECTORY_SEPARATOR . 'SaveHandler' . DIRECTORY_SEPARATOR . 'Exception.php';
