 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Dom' . DIRECTORY_SEPARATOR . 'Query' . DIRECTORY_SEPARATOR . 'Css2Xpath.php';

/**
 * @see Zend_Dom_Query_Result
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Dom' . DIRECTORY_SEPARATOR . 'Query' . DIRECTORY_SEPARATOR . 'Result.php';
...
class Zend_Dom_Query
{
    ...
    public function queryXpath($xpathQuery, $query = null)
    {
        if (null === ($document = $this->getDocument())) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Dom' . DIRECTORY_SEPARATOR . 'Exception.php';
