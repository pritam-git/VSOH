 ...
 * @version    $Id: Translate.php 446 2015-09-29 11:45:22Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Translate' . DIRECTORY_SEPARATOR . 'Adapter.php';
...
class Zend_Translate {
    ...
    public function setAdapter($options = array())
    {
        ...
        if (Zend_Loader::isReadable('Zend' . DIRECTORY_SEPARATOR . 'Translate' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . ucfirst($options['adapter']). '.php')) {
        ...
        if (!$this->_adapter instanceof Zend_Translate_Adapter) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Translate' . DIRECTORY_SEPARATOR . 'Exception.php';
