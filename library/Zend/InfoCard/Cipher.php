 ...
 * @version    $Id: Cipher.php 435 2015-09-28 15:14:38Z nm $
 */
    ...
    static public function getInstanceByURI($uri)
    {
        switch($uri) {
            case self::ENC_AES256CBC:
                include_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Cipher' . DIRECTORY_SEPARATOR . 'Symmetric' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Aes256cbc.php';
                return new Zend_InfoCard_Cipher_Symmetric_Adapter_Aes256cbc();

            case self::ENC_AES128CBC:
                include_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Cipher' . DIRECTORY_SEPARATOR . 'Symmetric' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Aes128cbc.php';
                return new Zend_InfoCard_Cipher_Symmetric_Adapter_Aes128cbc();

            case self::ENC_RSA_OAEP_MGF1P:
                include_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Cipher' . DIRECTORY_SEPARATOR . 'Pki' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Rsa.php';
            ...
            default:
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Cipher' . DIRECTORY_SEPARATOR . 'Exception.php';
