 ...
 * @version    $Id: EncryptedData.php 435 2015-09-28 15:14:38Z nm $
 */
    ...
    static public function getInstance($xmlData)
    {
        ...
        switch($sxe['Type']) {
            case 'http://www.w3.org/2001/04/xmlenc#Element':
                include_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'EncryptedData' . DIRECTORY_SEPARATOR . 'XmlEnc.php';
