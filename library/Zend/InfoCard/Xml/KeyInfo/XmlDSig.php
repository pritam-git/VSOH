 ...
 * @version    $Id: XmlDSig.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * Zend_InfoCard_Xml_KeyInfo_Abstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'KeyInfo' . DIRECTORY_SEPARATOR . 'Abstract.php';

/**
 * Zend_InfoCard_Xml_EncryptedKey
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'EncryptedKey.php';

/**
 * Zend_InfoCard_Xml_KeyInfo_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'KeyInfo' . DIRECTORY_SEPARATOR . 'Interface.php';
