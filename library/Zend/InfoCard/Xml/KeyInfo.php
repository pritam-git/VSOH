 ...
 * @version    $Id: KeyInfo.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * Zend_InfoCard_Xml_Element
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'Element.php';
...
class Zend_InfoCard_Xml_KeyInfo
{
    ...
    static public function getInstance($xmlData)
    {
            ...
            foreach($sxe->getDocNameSpaces() as $namespace) {
                switch($namespace) {
                    case 'http://www.w3.org/2000/09/xmldsig#':
                        include_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'KeyInfo' . DIRECTORY_SEPARATOR . 'XmlDSig.php';
        ...
        include_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'KeyInfo' . DIRECTORY_SEPARATOR . 'Default.php';
