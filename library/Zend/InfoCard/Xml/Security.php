 ...
 * @version    $Id: Security.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * Zend_InfoCard_Xml_Security_Transform
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'Security' . DIRECTORY_SEPARATOR . 'Transform.php';
...
class Zend_InfoCard_Xml_Security
{
    ...
    static public function validateXMLSignature($strXMLInput)
    {
        if(!extension_loaded('openssl')) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'Security' . DIRECTORY_SEPARATOR . 'Exception.php';
