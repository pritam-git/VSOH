 ...
 * @version    $Id: Assertion.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * Zend_InfoCard_Xml_Assertion_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'Assertion' . DIRECTORY_SEPARATOR . 'Interface.php';
...
final class Zend_InfoCard_Xml_Assertion
{
    ...
    static public function getInstance($xmlData)
    {
        ...
        if($xmlData instanceof Zend_InfoCard_Xml_Element) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'Exception.php';
        ...
        foreach($namespaces as $namespace) {
            switch($namespace) {
                case self::TYPE_SAML:
                    include_once 'Zend' . DIRECTORY_SEPARATOR . 'InfoCard' . DIRECTORY_SEPARATOR . 'Xml' . DIRECTORY_SEPARATOR . 'Assertion' . DIRECTORY_SEPARATOR . 'Saml.php';
