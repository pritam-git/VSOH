 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'ProgressBar' . DIRECTORY_SEPARATOR . 'Adapter.php';

/**
 * @see Zend_Text_MultiByte
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Text' . DIRECTORY_SEPARATOR . 'MultiByte.php';
...
class Zend_ProgressBar_Adapter_Console extends Zend_ProgressBar_Adapter
{
    ...
    public function setOutputStream($resource)
    {
       ...
       if ($stream === false) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'ProgressBar' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Exception.php';
