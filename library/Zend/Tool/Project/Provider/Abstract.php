 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Profile.php';

/**
 * @see Zend_Tool_Framework_Provider_Abstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Provider' . DIRECTORY_SEPARATOR . 'Abstract.php';

/**
 * @see Zend_Tool_Project_Context_Repository
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Context' . DIRECTORY_SEPARATOR . 'Repository.php';

/**
 * @see Zend_Tool_Project_Profile_FileParser_Xml
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Profile' . DIRECTORY_SEPARATOR . 'FileParser' . DIRECTORY_SEPARATOR . 'Xml.php';

/**
 * @see Zend_Tool_Framework_Registry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Registry.php';

require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Provider' . DIRECTORY_SEPARATOR . 'Initializable.php';
    ...
    implements Zend_Tool_Framework_Provider_Initializable
{
    ...
    protected function _loadProfileRequired()
    {
        $profile = $this->_loadProfile();
        if ($profile === false) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Provider' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    protected function _getContentForContext(Zend_Tool_Project_Context_Interface $context, $methodName, $parameters)
    {
        ...
        if (!class_exists('Zend_Tool_Project_Context_Content_Engine')) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Context' . DIRECTORY_SEPARATOR . 'Content' . DIRECTORY_SEPARATOR . 'Engine.php';
        }
