 ...
 * @version    $Id: Module.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Tool_Project_Provider_Abstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Provider' . DIRECTORY_SEPARATOR . 'Abstract.php';

/**
 * @see Zend_Tool_Framework_Provider_Pretendable
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Provider' . DIRECTORY_SEPARATOR . 'Pretendable.php';

/**
 * @see Zend_Tool_Project_Profile_Iterator_ContextFilter
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Profile' . DIRECTORY_SEPARATOR . 'Iterator' . DIRECTORY_SEPARATOR . 'ContextFilter.php';

/**
 * @see Zend_Tool_Project_Profile_Iterator_EnabledResourceFilter
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Profile' . DIRECTORY_SEPARATOR . 'Iterator' . DIRECTORY_SEPARATOR . 'EnabledResourceFilter.php';
    ...
    implements Zend_Tool_Framework_Provider_Pretendable
{
    ...
    public function create($name) //, $moduleProfile = null)
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Provider' . DIRECTORY_SEPARATOR . 'Test.php';
