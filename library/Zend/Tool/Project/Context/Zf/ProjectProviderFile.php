 ...
 * @version    $Id: ProjectProviderFile.php 444 2015-09-29 11:21:03Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'CodeGenerator' . DIRECTORY_SEPARATOR . 'Php' . DIRECTORY_SEPARATOR . 'File.php';
...
class Zend_Tool_Project_Context_Zf_ProjectProviderFile extends Zend_Tool_Project_Context_Filesystem_File
{
    ...
    public function getContents()
    {
        ...
        $codeGenFile = new Zend_CodeGenerator_Php_File(array(
            'requiredFiles' => array(
                'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Provider' . DIRECTORY_SEPARATOR . 'Abstract.php',
                'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Provider' . DIRECTORY_SEPARATOR . 'Exception.php'
                ),
            'classes' => array($class)
            ));
