 ...
 * @version    $Id: TestApplicationActionMethod.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Tool_Project_Context_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Context' . DIRECTORY_SEPARATOR . 'Interface.php';

/**
 * @see Zend_Reflection_File
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Reflection' . DIRECTORY_SEPARATOR . 'File.php';
