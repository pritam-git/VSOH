 ...
 * @version    $Id: ProjectDirectory.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Tool_Project_Context_Filesystem_Directory
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Context' . DIRECTORY_SEPARATOR . 'Filesystem' . DIRECTORY_SEPARATOR . 'Directory.php';

/**
 * @see Zend_Tool_Project_Context_System_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Context' . DIRECTORY_SEPARATOR . 'System' . DIRECTORY_SEPARATOR . 'Interface.php';

/**
 * @see Zend_Tool_Project_Context_System_TopLevelRestrictable
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Context' . DIRECTORY_SEPARATOR . 'System' . DIRECTORY_SEPARATOR . 'TopLevelRestrictable.php';

/**
 * @see Zend_Tool_Project_Context_System_NotOverwritable
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Context' . DIRECTORY_SEPARATOR . 'System' . DIRECTORY_SEPARATOR . 'NotOverwritable.php';
               ...
               Zend_Tool_Project_Context_System_TopLevelRestrictable
{
    ...
    public function init()
    {
        ...
        // if not, exception.
        if ($projectDirectory == null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Exception.php';
            ...
            foreach (new DirectoryIterator($this->getPath()) as $item) {
                if (!$item->isDot()) {
                    if ($registry->getClient()->isInteractive()) {
                        ...
                        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Context' . DIRECTORY_SEPARATOR . 'Exception.php';
