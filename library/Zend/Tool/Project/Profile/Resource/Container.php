 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Profile' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'SearchConstraints.php';
            ...
            if (strtolower($currentResource->getName()) == strtolower($currentConstraint->name)) {
                ...
                if (count($currentConstraint->params) > 0) {
                    ...
                    if (!is_array($currentConstraint->params)) {
                        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Project' . DIRECTORY_SEPARATOR . 'Profile' . DIRECTORY_SEPARATOR . 'Exception.php';
