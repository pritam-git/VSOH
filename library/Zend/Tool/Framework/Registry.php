 ...
 * @version    $Id: Registry.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Tool_Framework_Registry_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Registry' . DIRECTORY_SEPARATOR . 'Interface.php';
...
//    }
    ...
    public function getConfig()
    {
        if ($this->_config === null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Config.php';
    ...
    public function getStorage()
    {
        if ($this->_storage === null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Storage.php';
    ...
    public function getLoader()
    {
        if ($this->_loader === null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Loader' . DIRECTORY_SEPARATOR . 'IncludePathLoader.php';
    ...
    public function getActionRepository()
    {
        if ($this->_actionRepository == null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Repository.php';
    ...
    public function getProviderRepository()
    {
        if ($this->_providerRepository == null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Provider' . DIRECTORY_SEPARATOR . 'Repository.php';
    ...
    public function getManifestRepository()
    {
        if ($this->_manifestRepository == null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Manifest' . DIRECTORY_SEPARATOR . 'Repository.php';
    ...
    public function getRequest()
    {
        if ($this->_request == null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Request.php';
    ...
    public function getResponse()
    {
        if ($this->_response == null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Response.php';
    ...
    public function __get($name)
    {
        if (method_exists($this, 'get' . $name)) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Registry' . DIRECTORY_SEPARATOR . 'Exception.php';
