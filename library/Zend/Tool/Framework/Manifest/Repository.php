        ...
        if ($manifest instanceof Zend_Tool_Framework_Manifest_ProviderManifestable) {
            ...
            foreach ($providers as $provider) {
                ...
                if (!$provider instanceof Zend_Tool_Framework_Provider_Interface) {
                    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Manifest' . DIRECTORY_SEPARATOR . 'Exception.php';
                ...
                foreach ($metadatas as $metadata) {
                    if (is_array($metadata)) {
                        if (!class_exists('Zend_Tool_Framework_Metadata_Dynamic')) {
                            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Metadata' . DIRECTORY_SEPARATOR . 'Dynamic.php';
                        }
