 ...
 * @version    $Id: BasicLoader.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Tool_Framework_Loader_Abstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Loader' . DIRECTORY_SEPARATOR . 'Interface.php';
...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Manifest' . DIRECTORY_SEPARATOR . 'Interface.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Provider' . DIRECTORY_SEPARATOR . 'Interface.php';
