 ...
 * @version    $Id: IncludePathLoader.php 444 2015-09-29 11:21:03Z nm $
 */

/**
 * @see Zend_Tool_Framework_Loader_Abstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Loader' . DIRECTORY_SEPARATOR . 'Abstract.php';

/**
 * @see Zend_Tool_Framework_Loader_IncludePathLoader_RecursiveFilterIterator
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Loader' . DIRECTORY_SEPARATOR . 'IncludePathLoader' . DIRECTORY_SEPARATOR . 'RecursiveFilterIterator.php';
...
class Zend_Tool_Framework_Loader_IncludePathLoader extends Zend_Tool_Framework_Loader_Abstract
{
    ...
    protected function _getFiles()
    {
        ...
        foreach ($paths as $path) {
            ...
            if (file_exists($realIncludePath . DIRECTORY_SEPARATOR . 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Loader' . DIRECTORY_SEPARATOR . 'IncludePathLoader.php')) {
