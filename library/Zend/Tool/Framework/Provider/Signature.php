 ...
 * @version    $Id: Signature.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Reflection_Class
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Reflection' . DIRECTORY_SEPARATOR . 'Class.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Action' . DIRECTORY_SEPARATOR . 'Base.php';
    ...
    protected function _processSpecialties()
    {
        ...
        if ($this->_providerReflection->hasMethod('getSpecialties')) {
            ...
            if (!is_array($specialties)) {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Provider' . DIRECTORY_SEPARATOR . 'Exception.php';
