 ...
 * @version    $Id: InputHandler.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Tool_Framework_Client_Interactive_InputHandler
{
    ...
    public function setInputRequest($inputRequest)
    {
        if (is_string($inputRequest)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Interactive' . DIRECTORY_SEPARATOR . 'InputRequest.php';
    ...
    public function handle()
    {
        ...
        if (is_string($inputResponse)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Interactive' . DIRECTORY_SEPARATOR . 'InputResponse.php';
