 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Manifest' . DIRECTORY_SEPARATOR . 'MetadataManifestable.php';

/**
 * @see Zend_Filter
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter.php';

/**
 * @see Zend_Filter_Word_CamelCaseToDash
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Word' . DIRECTORY_SEPARATOR . 'CamelCaseToDash.php';

/**
 * @see Zend_Filter_StringToLower
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'StringToLower.php';

/**
 * @see Zend_Tool_Framework_Metadata_Tool
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Metadata' . DIRECTORY_SEPARATOR . 'Tool.php';

/**
 * @see Zend_Tool_Framework_Registry_EnabledInterface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Registry' . DIRECTORY_SEPARATOR . 'EnabledInterface.php';
