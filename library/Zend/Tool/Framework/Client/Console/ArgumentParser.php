 ...
 * @version    $Id: ArgumentParser.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Tool_Framework_Client_Console_ArgumentParser implements Zend_Tool_Framework_Registry_EnabledInterface
{
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Console' . DIRECTORY_SEPARATOR . 'HelpSystem.php';
