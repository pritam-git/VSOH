 ...
 * @version    $Id: Config.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Tool_Framework_Client_Config
{
    ...
    protected function loadConfig($configFilepath)
    {
        ...
        switch ($suffix) {
            case '.ini':
                ...
                break;
            case '.xml':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Config' . DIRECTORY_SEPARATOR . 'Xml.php';
    ...
    protected function getConfigWriter()
    {
        ...
        switch($suffix) {
            case '.ini':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Config' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Ini.php';
                $writer = new Zend_Config_Writer_Ini();
                $writer->setRenderWithoutSections();
                break;
            case '.xml':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Config' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Xml.php';
                $writer = new Zend_Config_Writer_Xml();
                break;
            case '.php':
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Config' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Array.php';
