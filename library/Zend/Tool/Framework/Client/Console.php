 ...
 * @version    $Id: Console.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Tool_Framework_Client_Abstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Abstract.php';

/**
 * @see Zend_Tool_Framework_Client_Interactive_InputInterface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Interactive' . DIRECTORY_SEPARATOR . 'InputInterface.php';

/**
 * @see Zend_Tool_Framework_Client_Interactive_OutputInterface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Interactive' . DIRECTORY_SEPARATOR . 'OutputInterface.php';
