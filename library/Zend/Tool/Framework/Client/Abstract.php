...
abstract class Zend_Tool_Framework_Client_Abstract implements Zend_Tool_Framework_Registry_EnabledInterface
{
    ...
    public function initialize()
    {
        ...
        if (!$this->_debugLogger instanceof Zend_Log) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Log.php';
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Log' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Null.php';
        ...
        if ($this instanceof Zend_Tool_Framework_Client_Interactive_InputInterface) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Interactive' . DIRECTORY_SEPARATOR . 'InputHandler.php';
        }
    ...
    public function promptInteractiveInput($inputRequest)
    {
        if (!$this->hasInteractiveInput()) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Exception.php';
