 ...
 * @version    $Id: Dynamic.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Tool_Framework_Metadata_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Metadata' . DIRECTORY_SEPARATOR . 'Interface.php';

/**
 * @see Zend_Tool_Framework_Metadata_Attributable
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Tool' . DIRECTORY_SEPARATOR . 'Framework' . DIRECTORY_SEPARATOR . 'Metadata' . DIRECTORY_SEPARATOR . 'Attributable.php';
