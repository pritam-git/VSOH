 ...
 * @version    $Id: Partial.php 445 2015-09-29 11:32:47Z nm $
...
class Zend_View_Helper_Partial extends Zend_View_Helper_Abstract
{
    ...
    public function partial($name = null, $module = null, $model = null)
    {
        ...
        if ((null !== $module) && is_string($module)) {
            ...
            if (null === $moduleDir) {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR . 'Helper' . DIRECTORY_SEPARATOR . 'Partial' . DIRECTORY_SEPARATOR . 'Exception.php';
                $e = new Zend_View_Helper_Partial_Exception('Cannot render partial; module does not exist');
                $e->setView($this->view);
                throw $e;
            }
            $viewsDir = dirname($moduleDir) . DIRECTORY_SEPARATOR . 'views';
