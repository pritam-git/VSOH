 ...
 * @version    $Id: HtmlQuicktime.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_View_Helper_HtmlObject
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR . 'Helper' . DIRECTORY_SEPARATOR . 'HtmlObject.php';
