...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR . 'Helper' . DIRECTORY_SEPARATOR . 'Placeholder' . DIRECTORY_SEPARATOR . 'Container' . DIRECTORY_SEPARATOR . 'Abstract.php';

/** Zend_View_Helper_Placeholder_Container */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR . 'Helper' . DIRECTORY_SEPARATOR . 'Placeholder' . DIRECTORY_SEPARATOR . 'Container.php';
...
class Zend_View_Helper_Placeholder_Registry
{
    ...
    public function setContainerClass($name)
    {
        ...
        if (!$reflection->isSubclassOf(new ReflectionClass('Zend_View_Helper_Placeholder_Container_Abstract'))) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR . 'Helper' . DIRECTORY_SEPARATOR . 'Placeholder' . DIRECTORY_SEPARATOR . 'Registry' . DIRECTORY_SEPARATOR . 'Exception.php';
