 ...
 * @version    $Id: HelperAbstract.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_View_Helper_Navigation_Helper
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR . 'Helper' . DIRECTORY_SEPARATOR . 'Navigation' . DIRECTORY_SEPARATOR . 'Helper.php';

/**
 * @see Zend_View_Helper_HtmlElement
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR . 'Helper' . DIRECTORY_SEPARATOR . 'HtmlElement.php';
    ...
    implements Zend_View_Helper_Navigation_Helper
{
    ...
    public function getContainer()
    {
        if (null === $this->_container) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Navigation.php';
