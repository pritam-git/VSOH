 ...
 * @version    $Id: Sitemap.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_View_Helper_Navigation_HelperAbstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR . 'Helper' . DIRECTORY_SEPARATOR . 'Navigation' . DIRECTORY_SEPARATOR . 'HelperAbstract.php';
    ...
    extends Zend_View_Helper_Navigation_HelperAbstract
{
    ...
    public function setServerUrl($serverUrl)
    {
        ...
        if ($uri->valid()) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Uri' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    public function getDomSitemap(Zend_Navigation_Container $container = null)
    {
        ...
        if ($this->getUseSitemapValidators()) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR . 'Sitemap' . DIRECTORY_SEPARATOR . 'Changefreq.php';
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR . 'Sitemap' . DIRECTORY_SEPARATOR . 'Lastmod.php';
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR . 'Sitemap' . DIRECTORY_SEPARATOR . 'Loc.php';
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR . 'Sitemap' . DIRECTORY_SEPARATOR . 'Priority.php';
