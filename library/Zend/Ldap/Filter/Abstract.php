...
abstract class Zend_Ldap_Filter_Abstract
{
    ...
    public function negate()
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Not.php';
    ...
    public static function escapeValue($values = array())
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Converter.php';
