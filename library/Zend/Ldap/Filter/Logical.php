 ...
 * @version    $Id: Logical.php 435 2015-09-28 15:14:38Z nm $
 */
    ...
    protected function __construct(array $subfilters, $symbol)
    {
        foreach ($subfilters as $key => $s) {
            if (is_string($s)) $subfilters[$key] = new Zend_Ldap_Filter_String($s);
                 ...
                 */
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Exception.php';
