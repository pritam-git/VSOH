 ...
 * @version    $Id: Node.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Ldap
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap.php';
/**
...
class Zend_Ldap_Node extends Zend_Ldap_Node_Abstract implements Iterator, RecursiveIterator
{
    ...
    */
    ...
    public function toLdif(array $options = array())
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Ldif' . DIRECTORY_SEPARATOR . 'Encoder.php';
    ...
    public function searchSubtree($filter, $scope = Zend_Ldap::SEARCH_SCOPE_SUB, $sort = null)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'Collection.php';
    ...
    public function getChildren()
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'ChildrenIterator.php';
