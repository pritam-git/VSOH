 ...
 * @version    $Id: Schema.php 435 2015-09-28 15:14:38Z nm $
 */
    ...
    public static function create(Zend_Ldap $ldap)
    {
        ...
        switch ($ldap->getRootDse()->getServerType()) {
            case Zend_Ldap_Node_RootDse::SERVER_TYPE_ACTIVEDIRECTORY:
                 ...
                 */
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'Schema' . DIRECTORY_SEPARATOR . 'ActiveDirectory.php';
            ...
            case Zend_Ldap_Node_RootDse::SERVER_TYPE_OPENLDAP:
                 ...
                 */
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'Schema' . DIRECTORY_SEPARATOR . 'OpenLdap.php';
