 ...
 * @version    $Id: OpenLdap.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'Schema' . DIRECTORY_SEPARATOR . 'AttributeType' . DIRECTORY_SEPARATOR . 'OpenLdap.php';
/**
 * @see Zend_Ldap_Node_Schema_ObjectClass_OpenLdap
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'Schema' . DIRECTORY_SEPARATOR . 'ObjectClass' . DIRECTORY_SEPARATOR . 'OpenLdap.php';
