 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'Schema' . DIRECTORY_SEPARATOR . 'Item.php';
/**
 * @see Zend_Ldap_Node_Schema_AttributeType_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'Schema' . DIRECTORY_SEPARATOR . 'AttributeType' . DIRECTORY_SEPARATOR . 'Interface.php';
