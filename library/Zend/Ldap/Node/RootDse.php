 ...
 * @version    $Id: RootDse.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Ldap_Node_Abstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'Abstract.php';
...
class Zend_Ldap_Node_RootDse extends Zend_Ldap_Node_Abstract
{
    ...
    public static function create(Zend_Ldap $ldap)
    {
        ...
        if (isset($data['domainfunctionality'])) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'RootDse' . DIRECTORY_SEPARATOR . 'ActiveDirectory.php';
            return new Zend_Ldap_Node_RootDse_ActiveDirectory($dn, $data);
        } else if (isset($data['dsaname'])) {
            /**
             * @see Zend_Ldap_Node_RootDse_ActiveDirectory
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'RootDse' . DIRECTORY_SEPARATOR . 'eDirectory.php';
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'RootDse' . DIRECTORY_SEPARATOR . 'OpenLdap.php';
