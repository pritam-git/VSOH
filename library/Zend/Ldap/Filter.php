 ...
 * @version    $Id: Filter.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Ldap_Filter_String
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'String.php';
...
class Zend_Ldap_Filter extends Zend_Ldap_Filter_String
{
    ...
    public static function mask($mask, $value)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Mask.php';
    ...
    public static function andFilter($filter)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'And.php';
    ...
    public static function orFilter($filter)
    {
         ...
         * Zend_Ldap_Filter_Or
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Or.php';
