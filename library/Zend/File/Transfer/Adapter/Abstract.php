 ...
 * @version   $Id: Abstract.php 442 2015-09-29 11:02:02Z nm $
 */
...
abstract class Zend_File_Transfer_Adapter_Abstract
{
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'File' . DIRECTORY_SEPARATOR . 'Transfer' . DIRECTORY_SEPARATOR . 'Exception.php';
        ...
        switch ($type) {
            ...
            case self::VALIDATE:
                ...
                if (!isset($this->_loaders[$type])) {
                    $paths         = array(
                        'Zend_' . $prefixSegment . '_'     => 'Zend' . DIRECTORY_SEPARATOR . $pathSegment . DIRECTORY_SEPARATOR,
                        'Zend_' . $prefixSegment . '_File' => 'Zend' . DIRECTORY_SEPARATOR . $pathSegment . DIRECTORY_SEPARATOR . 'File',
                    );
