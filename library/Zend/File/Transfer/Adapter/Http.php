 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'File' . DIRECTORY_SEPARATOR . 'Transfer' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Abstract.php';
    ...
    public static function getProgress($id = null)
    {
        ...
        if (isset($adapter) && isset($status['id'])) {
            if ($adapter instanceof Zend_ProgressBar_Adapter) {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'ProgressBar.php';
