 ...
 * @version   $Id: Transfer.php 442 2015-09-29 11:02:02Z nm $
 */
...
class Zend_File_Transfer
{
    ...
    {
        if (Zend_Loader::isReadable('Zend' . DIRECTORY_SEPARATOR . 'File' . DIRECTORY_SEPARATOR . 'Transfer' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . ucfirst($adapter). '.php')) {
