 ...
 * @version	$Id: PluginLoader.php 557 2018-01-20 10:10:32Z nm $
 */

/** Zend_Loader_PluginLoader_Interface */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Loader' . DIRECTORY_SEPARATOR . 'PluginLoader' . DIRECTORY_SEPARATOR . 'Interface.php';
...
class Zend_Loader_PluginLoader implements Zend_Loader_PluginLoader_Interface
{
	...
	public function addPrefixPath($prefix, $path)
	{
		if (!is_string($prefix) || !is_string($path)) {
			require_once 'Zend' . DIRECTORY_SEPARATOR . 'Loader' . DIRECTORY_SEPARATOR . 'PluginLoader' . DIRECTORY_SEPARATOR . 'Exception.php';
