 ...
 * @version    $Id: HttpHeaders.php 435 2015-09-28 15:14:38Z nm $
 */

/** Zend_Wildfire_Channel_Interface */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Wildfire' . DIRECTORY_SEPARATOR . 'Channel' . DIRECTORY_SEPARATOR . 'Interface.php';

/** Zend_Controller_Request_Abstract */
require_once('Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Request' . DIRECTORY_SEPARATOR . 'Abstract.php');

/** Zend_Controller_Response_Abstract */
require_once('Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'Abstract.php');

/** Zend_Controller_Plugin_Abstract */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Controller' . DIRECTORY_SEPARATOR . 'Plugin' . DIRECTORY_SEPARATOR . 'Abstract.php';

/** Zend_Wildfire_Protocol_JsonStream */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Wildfire' . DIRECTORY_SEPARATOR . 'Protocol' . DIRECTORY_SEPARATOR . 'JsonStream.php';
