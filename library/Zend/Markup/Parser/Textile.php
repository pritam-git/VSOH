 ...
 * @version    $Id: Textile.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Markup_TokenList
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Markup' . DIRECTORY_SEPARATOR . 'TokenList.php';

/**
 * @see Zend_Markup_Parser_ParserInterface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Markup' . DIRECTORY_SEPARATOR . 'Parser' . DIRECTORY_SEPARATOR . 'ParserInterface.php';
...
class Zend_Markup_Parser_Textile implements Zend_Markup_Parser_ParserInterface
{
    ...
    public function parse($value)
    {
        if (!is_string($value)) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Markup' . DIRECTORY_SEPARATOR . 'Parser' . DIRECTORY_SEPARATOR . 'Exception.php';
