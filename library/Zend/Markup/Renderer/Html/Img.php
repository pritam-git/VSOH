 ...
 * @version    $Id: Img.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Markup_Renderer_Html
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Markup' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'Html.php';
/**
 * @see Zend_Markup_Renderer_Html_HtmlAbstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Markup' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'Html' . DIRECTORY_SEPARATOR . 'HtmlAbstract.php';
