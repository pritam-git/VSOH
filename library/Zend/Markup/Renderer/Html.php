 ...
 * @version    $Id: Html.php 443 2015-09-29 11:12:31Z nm $
 */

/**
 * @see Zend_Filter_HtmlEntities
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'HtmlEntities.php';
/**
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Callback.php';
/**
 * @see Zend_Markup_Renderer_RendererAbstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Markup' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'RendererAbstract.php';
...
class Zend_Markup_Renderer_Html extends Zend_Markup_Renderer_RendererAbstract
{
    ...
    public function __construct($options = array())
    {
        ...
        $this->_pluginLoader = new Zend_Loader_PluginLoader(array(
            'Zend_Markup_Renderer_Html' => 'Zend' . DIRECTORY_SEPARATOR . 'Markup' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'Html' . DIRECTORY_SEPARATOR
        ));
