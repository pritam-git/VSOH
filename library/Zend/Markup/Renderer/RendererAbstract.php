 ...
 * @version    $Id: RendererAbstract.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Markup' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'TokenConverterInterface.php';
...
abstract class Zend_Markup_Renderer_RendererAbstract
{
    ...
    public function addMarkup($name, $type, array $options)
    {
        if (!isset($options['group']) && ($type ^ self::TYPE_ALIAS)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Markup' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'Exception.php';
