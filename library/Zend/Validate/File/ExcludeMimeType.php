 ...
 * @version   $Id: ExcludeMimeType.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Validate_File_MimeType
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR . 'File' . DIRECTORY_SEPARATOR . 'MimeType.php';
