 ...
 * @version   $Id: WordCount.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Validate_File_Count
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR . 'File' . DIRECTORY_SEPARATOR . 'Count.php';
