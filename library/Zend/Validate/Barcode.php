 ...
 * @version    $Id: Barcode.php 445 2015-09-29 11:32:47Z nm $
 */
...
class Zend_Validate_Barcode extends Zend_Validate_Abstract
{
    ...
    public function setAdapter($adapter, $options = null)
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Loader.php';
        if (Zend_Loader::isReadable('Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR . 'Barcode' . DIRECTORY_SEPARATOR . $adapter. '.php')) {
