 ...
 * @version    $Id: Class.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_CodeGenerator_Php_Abstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'CodeGenerator' . DIRECTORY_SEPARATOR . 'Php' . DIRECTORY_SEPARATOR . 'Abstract.php';

/**
 * @see Zend_CodeGenerator_Php_Member_Container
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'CodeGenerator' . DIRECTORY_SEPARATOR . 'Php' . DIRECTORY_SEPARATOR . 'Member' . DIRECTORY_SEPARATOR . 'Container.php';

/**
 * @see Zend_CodeGenerator_Php_Method
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'CodeGenerator' . DIRECTORY_SEPARATOR . 'Php' . DIRECTORY_SEPARATOR . 'Method.php';

/**
 * @see Zend_CodeGenerator_Php_Property
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'CodeGenerator' . DIRECTORY_SEPARATOR . 'Php' . DIRECTORY_SEPARATOR . 'Property.php';

/**
 * @see Zend_CodeGenerator_Php_Docblock
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'CodeGenerator' . DIRECTORY_SEPARATOR . 'Php' . DIRECTORY_SEPARATOR . 'Docblock.php';
...
class Zend_CodeGenerator_Php_Class extends Zend_CodeGenerator_Php_Abstract
{
    ...
    public function setDocblock($docblock)
    {
        ...
        if (is_array($docblock)) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'CodeGenerator' . DIRECTORY_SEPARATOR . 'Php' . DIRECTORY_SEPARATOR . 'Exception.php';
