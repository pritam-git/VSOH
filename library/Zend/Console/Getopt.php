 ...
 * @version    $Id: Getopt.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Console_Getopt
{
    ...
    public function __construct($rules, $argv = null, $getoptConfig = array())
    {
        if (!isset($_SERVER['argv'])) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Console' . DIRECTORY_SEPARATOR . 'Getopt' . DIRECTORY_SEPARATOR . 'Exception.php';
