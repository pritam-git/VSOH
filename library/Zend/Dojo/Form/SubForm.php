...
/** Zend_Form_SubForm */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Form' . DIRECTORY_SEPARATOR . 'SubForm.php';
 ...
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 * @version    $Id: SubForm.php 441 2015-09-29 09:41:22Z nm $
 */
class Zend_Dojo_Form_SubForm extends Zend_Form_SubForm
{
    ...
    {
        $this->addPrefixPath('Zend_Dojo_Form_Decorator', 'Zend' . DIRECTORY_SEPARATOR . 'Dojo' . DIRECTORY_SEPARATOR . 'Form' . DIRECTORY_SEPARATOR . 'Decorator', 'decorator')
