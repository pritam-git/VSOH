 ...
 * @version    $Id: Dojo.php 435 2015-09-28 15:14:38Z nm $
...
class Zend_Dojo_View_Helper_Dojo
{
    ...
    public function __construct()
    {
        ...
        if (!isset($registry[__CLASS__])) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Dojo' . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR . 'Helper' . DIRECTORY_SEPARATOR . 'Dojo' . DIRECTORY_SEPARATOR . 'Container.php';
    ...
    public function __call($method, $args)
    {
        if (!method_exists($this->_container, $method)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Dojo' . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR . 'Exception.php';
