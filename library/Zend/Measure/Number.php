 ...
 * @version   $Id: Number.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * Implement needed classes
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Measure' . DIRECTORY_SEPARATOR . 'Abstract.php';
...
class Zend_Measure_Number extends Zend_Measure_Abstract
{
    ...
    public function __construct($value, $type, $locale = null)
    {
        ...
        if (!Zend_Locale::isLocale($locale, true, false)) {
            if (!Zend_Locale::isLocale($locale, true, false)) {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Measure' . DIRECTORY_SEPARATOR . 'Exception.php';
