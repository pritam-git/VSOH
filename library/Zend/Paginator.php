 ...
 * @version    $Id: Paginator.php 446 2015-09-29 11:45:22Z nm $
 */
 ...
 * @see Zend_Json
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Json.php';
        ...
        if ($data instanceof Zend_Paginator_AdapterAggregate) {
            ...
            if ($adapter == self::INTERNAL_ADAPTER) {
                if (is_array($data)) {
                     ...
                     */
                    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Paginator' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    public static function getAdapterLoader()
    {
        if (self::$_adapterLoader === null) {
            self::$_adapterLoader = new Zend_Loader_PluginLoader(
                array('Zend_Paginator_Adapter' => 'Zend' . DIRECTORY_SEPARATOR . 'Paginator' . DIRECTORY_SEPARATOR . 'Adapter')
            );
        }
    ...
    public static function getScrollingStyleLoader()
    {
        if (self::$_scrollingStyleLoader === null) {
            self::$_scrollingStyleLoader = new Zend_Loader_PluginLoader(
                array('Zend_Paginator_ScrollingStyle' => 'Zend' . DIRECTORY_SEPARATOR . 'Paginator' . DIRECTORY_SEPARATOR . 'ScrollingStyle')
            );
        }
