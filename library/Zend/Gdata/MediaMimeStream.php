 ...
 * @version    $Id: MediaMimeStream.php 435 2015-09-28 15:14:38Z nm $
 */

/**
*  @see Zend_Gdata_MimeFile
*/
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'MimeFile.php';

/**
* @see Zend_Gdata_MimeBodyString
*/
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'MimeBodyString.php';
