 ...
 * @version    $Id: EmailListRecipientQuery.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Gdata_Gapps_Query
 */
require_once('Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Gapps' . DIRECTORY_SEPARATOR . 'Query.php');
