 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Gapps' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Login.php';

/**
 * @see Zend_Gdata_Gapps_Extension_Name
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Gapps' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Name.php';

/**
 * @see Zend_Gdata_Gapps_Extension_Quota
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Gapps' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Quota.php';
