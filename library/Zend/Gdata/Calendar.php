 ...
 * @version    $Id: Calendar.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Calendar' . DIRECTORY_SEPARATOR . 'EventFeed.php';

/**
 * @see Zend_Gdata_Calendar_EventEntry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Calendar' . DIRECTORY_SEPARATOR . 'EventEntry.php';

/**
 * @see Zend_Gdata_Calendar_ListFeed
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Calendar' . DIRECTORY_SEPARATOR . 'ListFeed.php';

/**
 * @see Zend_Gdata_Calendar_ListEntry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Calendar' . DIRECTORY_SEPARATOR . 'ListEntry.php';
