 ...
 * @version    $Id: FeedSourceParent.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Gdata_App_Entry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Entry.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Generator.php';

/**
 * @see Zend_Gdata_App_Extension_Icon
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Icon.php';

/**
 * @see Zend_Gdata_App_Extension_Logo
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Logo.php';

/**
 * @see Zend_Gdata_App_Extension_Subtitle
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Subtitle.php';
