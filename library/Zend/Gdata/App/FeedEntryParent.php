 ...
 * @version    $Id: FeedEntryParent.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Gdata_App_Extension_Element
*/
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Element.php';

/**
 * @see Zend_Gdata_App_Extension_Author
*/
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Author.php';
...
*/
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Contributor.php';

/**
 * @see Zend_Gdata_App_Extension_Id
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Id.php';

/**
 * @see Zend_Gdata_App_Extension_Link
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Link.php';

/**
 * @see Zend_Gdata_App_Extension_Rights
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Rights.php';

/**
 * @see Zend_Gdata_App_Extension_Title
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Title.php';

/**
 * @see Zend_Gdata_App_Extension_Updated
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Updated.php';

/**
 * Zend_Version
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Version.php';
