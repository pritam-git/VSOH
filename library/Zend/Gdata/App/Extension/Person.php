 ...
 * @version    $Id: Person.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Name.php';

/**
 * @see Zend_Gdata_App_Extension_Email
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Email.php';

/**
 * @see Zend_Gdata_App_Extension_Uri
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Uri.php';
