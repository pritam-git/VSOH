 ...
 * @version    $Id: Entry.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Gdata_App_FeedEntryParent
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'FeedEntryParent.php';

/**
 * @see Zend_Gdata_App_Extension_Content
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Content.php';

/**
 * @see Zend_Gdata_App_Extension_Edited
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Edited.php';

/**
 * @see Zend_Gdata_App_Extension_Published
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Published.php';

/**
 * @see Zend_Gdata_App_Extension_Source
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Source.php';

/**
 * @see Zend_Gdata_App_Extension_Summary
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Summary.php';

/**
 * @see Zend_Gdata_App_Extension_Control
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Control.php';
