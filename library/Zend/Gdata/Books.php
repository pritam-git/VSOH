 ...
 * @version    $Id: Books.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'DublinCore.php';

/**
 * @see Zend_Gdata_Books_CollectionEntry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Books' . DIRECTORY_SEPARATOR . 'CollectionEntry.php';

/**
 * @see Zend_Gdata_Books_CollectionFeed
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Books' . DIRECTORY_SEPARATOR . 'CollectionFeed.php';

/**
 * @see Zend_Gdata_Books_VolumeEntry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Books' . DIRECTORY_SEPARATOR . 'VolumeEntry.php';

/**
 * @see Zend_Gdata_Books_VolumeFeed
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Books' . DIRECTORY_SEPARATOR . 'VolumeFeed.php';
