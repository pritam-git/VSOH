 ...
 * @version    $Id: App.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * Zend_Gdata_Feed
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Feed.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'MediaSource.php';
...
class Zend_Gdata_App
{
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Exception.php';
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Uri' . DIRECTORY_SEPARATOR . 'Http.php';
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'HttpAdapterStreamingProxy.php';
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'HttpAdapterStreamingSocket.php';
