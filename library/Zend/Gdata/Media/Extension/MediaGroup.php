 ...
 * @version    $Id: MediaGroup.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Gdata_Extension
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaContent.php';

/**
 * @see Zend_Gdata_Media_Extension_MediaCategory
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaCategory.php';

/**
 * @see Zend_Gdata_Media_Extension_MediaCopyright
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaCopyright.php';

/**
 * @see Zend_Gdata_Media_Extension_MediaCredit
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaCredit.php';

/**
 * @see Zend_Gdata_Media_Extension_MediaDescription
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaDescription.php';

/**
 * @see Zend_Gdata_Media_Extension_MediaHash
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaHash.php';

/**
 * @see Zend_Gdata_Media_Extension_MediaKeywords
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaKeywords.php';

/**
 * @see Zend_Gdata_Media_Extension_MediaPlayer
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaPlayer.php';

/**
 * @see Zend_Gdata_Media_Extension_MediaRating
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaRating.php';

/**
 * @see Zend_Gdata_Media_Extension_MediaRestriction
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaRestriction.php';

/**
 * @see Zend_Gdata_Media_Extension_MediaText
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaText.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaTitle.php';
