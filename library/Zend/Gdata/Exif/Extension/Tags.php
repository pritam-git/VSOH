 ...
 * @version    $Id: Tags.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 * @see Zend_Gdata_Exif
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Exif.php';

/**
 * @see Zend_Gdata_Exif_Extension_Distance
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Exif' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Distance.php';

/**
 * @see Zend_Gdata_Exif_Extension_Exposure
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Exif' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Exposure.php';

/**
 * @see Zend_Gdata_Exif_Extension_Flash
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Exif' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Flash.php';

/**
 * @see Zend_Gdata_Exif_Extension_FocalLength
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Exif' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'FocalLength.php';

/**
 * @see Zend_Gdata_Exif_Extension_FStop
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Exif' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'FStop.php';

/**
 * @see Zend_Gdata_Exif_Extension_ImageUniqueId
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Exif' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'ImageUniqueId.php';

/**
 * @see Zend_Gdata_Exif_Extension_Iso
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Exif' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Iso.php';

/**
 * @see Zend_Gdata_Exif_Extension_Make
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Exif' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Make.php';

/**
 * @see Zend_Gdata_Exif_Extension_Model
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Exif' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Model.php';

/**
 * @see Zend_Gdata_Exif_Extension_Time
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Exif' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Time.php';
