 ...
 * @version    $Id: AlbumEntry.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Access.php';

/**
 * @see Zend_Gdata_Photos_Extension_BytesUsed
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'BytesUsed.php';

/**
 * @see Zend_Gdata_Photos_Extension_Location
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Location.php';

/**
 * @see Zend_Gdata_Photos_Extension_Name
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Name.php';

/**
 * @see Zend_Gdata_Photos_Extension_NumPhotos
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'NumPhotos.php';

/**
 * @see Zend_Gdata_Photos_Extension_NumPhotosRemaining
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'NumPhotosRemaining.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaGroup.php';
