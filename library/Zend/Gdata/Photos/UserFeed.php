 ...
 * @version    $Id: UserFeed.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Gdata_Photos
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos.php';

/**
 * @see Zend_Gdata_Feed
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Feed.php';

/**
 * @see Zend_Gdata_Photos_UserEntry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'UserEntry.php';

/**
 * @see Zend_Gdata_Photos_AlbumEntry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'AlbumEntry.php';

/**
 * @see Zend_Gdata_Photos_PhotoEntry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'PhotoEntry.php';

/**
 * @see Zend_Gdata_Photos_TagEntry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'TagEntry.php';

/**
 * @see Zend_Gdata_Photos_CommentEntry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'CommentEntry.php';
