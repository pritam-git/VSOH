 ...
 * @version    $Id: PhotoEntry.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Gdata_MediaEntry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Entry.php';

/**
 * @see Zend_Gdata_Photos_Extension_PhotoId
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'PhotoId.php';

/**
 * @see Zend_Gdata_Photos_Extension_Version
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Version.php';

/**
 * @see Zend_Gdata_Photos_Extension_AlbumId
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'AlbumId.php';

/**
 * @see Zend_Gdata_Photos_Extension_Id
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Id.php';

/**
 * @see Zend_Gdata_Photos_Extension_Width
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Width.php';

/**
 * @see Zend_Gdata_Photos_Extension_Height
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Height.php';

/**
 * @see Zend_Gdata_Photos_Extension_Size
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Size.php';

/**
 * @see Zend_Gdata_Photos_Extension_Client
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Client.php';

/**
 * @see Zend_Gdata_Photos_Extension_Checksum
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Checksum.php';

/**
 * @see Zend_Gdata_Photos_Extension_Timestamp
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Timestamp.php';

/**
 * @see Zend_Gdata_Photos_Extension_CommentingEnabled
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'CommentingEnabled.php';

/**
 * @see Zend_Gdata_Photos_Extension_CommentCount
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'CommentCount.php';

/**
 * @see Zend_Gdata_Exif_Extension_Tags
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Exif' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Tags.php';

/**
 * @see Zend_Gdata_Geo_Extension_GeoRssWhere
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Geo' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'GeoRssWhere.php';

/**
 * @see Zend_Gdata_App_Extension_Category
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Category.php';
