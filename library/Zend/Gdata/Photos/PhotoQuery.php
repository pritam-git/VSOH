 ...
 * @version    $Id: PhotoQuery.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Gdata_Gapps_Picasa_AlbumQuery
 */
require_once('Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'AlbumQuery.php');
