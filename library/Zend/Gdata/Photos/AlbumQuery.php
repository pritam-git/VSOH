 ...
 * @version    $Id: AlbumQuery.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Gdata_Photos_UserQuery
 */
require_once('Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'UserQuery.php');
