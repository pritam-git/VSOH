 ...
 * @version    $Id: UserEntry.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Gapps.php';

/**
 * @see Zend_Gdata_Photos_Extension_Nickname
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Nickname.php';

/**
 * @see Zend_Gdata_Photos_Extension_Thumbnail
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Thumbnail.php';

/**
 * @see Zend_Gdata_Photos_Extension_QuotaCurrent
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'QuotaCurrent.php';

/**
 * @see Zend_Gdata_Photos_Extension_QuotaLimit
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'QuotaLimit.php';

/**
 * @see Zend_Gdata_Photos_Extension_MaxPhotosPerAlbum
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MaxPhotosPerAlbum.php';

/**
 * @see Zend_Gdata_Photos_Extension_User
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Photos' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'User.php';
