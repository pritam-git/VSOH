 ...
 * @version    $Id: UserProfileEntry.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Gdata_Entry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Entry.php';

/**
 * @see Zend_Gdata_Extension_FeedLink
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'FeedLink.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Description
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Description.php';

/**
 * @see Zend_Gdata_YouTube_Extension_AboutMe
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'AboutMe.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Age
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Age.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Username
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Username.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Books
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Books.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Company
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Company.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Hobbies
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Hobbies.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Hometown
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Hometown.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Location
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Location.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Movies
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Movies.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Music
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Music.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Occupation
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Occupation.php';

/**
 * @see Zend_Gdata_YouTube_Extension_School
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'School.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Gender
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Gender.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Relationship
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Relationship.php';

/**
 * @see Zend_Gdata_YouTube_Extension_FirstName
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'FirstName.php';

/**
 * @see Zend_Gdata_YouTube_Extension_LastName
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'LastName.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Statistics
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Statistics.php';

/**
 * @see Zend_Gdata_Media_Extension_MediaThumbnail
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaThumbnail.php';
    ...
    public function setAboutMe($aboutMe = null)
    {
        if (($this->getMajorProtocolVersion() == null) ||
           ($this->getMajorProtocolVersion() == 1)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'VersionException.php';
