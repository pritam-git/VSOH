 ...
 * @version    $Id: SubscriptionEntry.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'PlaylistTitle.php';

/**
 * @see Zend_Gdata_YouTube_Extension_PlaylistId
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'PlaylistId.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'CountHint.php';

/**
 * @see Zend_Gdata_YouTube_Extension_QueryString
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'QueryString.php';
