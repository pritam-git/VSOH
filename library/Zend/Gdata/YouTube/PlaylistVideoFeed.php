 ...
 * @version    $Id: PlaylistVideoFeed.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Gdata_Media_Feed
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Media' . DIRECTORY_SEPARATOR . 'Feed.php';

/**
 * @see Zend_Gdata_YouTube_PlaylistVideoEntry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'PlaylistVideoEntry.php';
