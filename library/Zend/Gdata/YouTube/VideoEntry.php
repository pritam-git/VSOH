 ...
 * @version    $Id: VideoEntry.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'MediaEntry.php';

/**
 * @see Zend_Gdata_YouTube_Extension_MediaGroup
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'MediaGroup.php';

/**
 * @see Zend_Gdata_YouTube_Extension_NoEmbed
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'NoEmbed.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Link.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Racy
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Racy.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Control.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Recorded
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Recorded.php';
...
class Zend_Gdata_YouTube_VideoEntry extends Zend_Gdata_YouTube_MediaEntry
{
    ...
    public function setVideoRating($ratingValue)
    {
        if ($ratingValue < 1 || $ratingValue > 5) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'InvalidArgumentException.php';
