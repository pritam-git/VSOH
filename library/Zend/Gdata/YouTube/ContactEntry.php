 ...
 * @version    $Id: ContactEntry.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Gdata_YouTube_UserProfileEntry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'UserProfileEntry.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Status
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'YouTube' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Status.php';
