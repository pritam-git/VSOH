 ...
 * @version    $Id: ClientLogin.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * Zend_Gdata_HttpClient
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'HttpClient.php';
        ...
        $accountType = 'HOSTED_OR_GOOGLE')
    {
        ...
        if ($response->getStatus() == 200) {
            ...
            if (array_key_exists('Error', $goog_resp) &&
                ...
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'CaptchaRequiredException.php';
