 ...
 * @version    $Id: ListEntry.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Calendar' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'AccessLevel.php';

/**
 * @see Zend_Calendar_Extension_Color
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Calendar' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Color.php';

/**
 * @see Zend_Calendar_Extension_Hidden
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Calendar' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Hidden.php';

/**
 * @see Zend_Calendar_Extension_Selected
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Calendar' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Selected.php';
