 ...
 * @version    $Id: VolumeEntry.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Comments.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Creator
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'DublinCore' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Creator.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Date
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'DublinCore' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Date.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Description
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'DublinCore' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Description.php';

/**
 * @see Zend_Gdata_Books_Extension_Embeddability
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Books' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Embeddability.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Format
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'DublinCore' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Format.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Identifier
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'DublinCore' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Identifier.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Language
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'DublinCore' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Language.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Publisher
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'DublinCore' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Publisher.php';

/**
 * @see Zend_Gdata_Extension_Rating
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Rating.php';

/**
 * @see Zend_Gdata_Books_Extension_Review
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Books' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Review.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Subject
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'DublinCore' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Subject.php';

/**
 * @see Zend_Gdata_DublinCore_Extension_Title
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'DublinCore' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Title.php';

/**
 * @see Zend_Gdata_Books_Extension_Viewability
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Books' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Viewability.php';
...
class Zend_Gdata_Books_VolumeEntry extends Zend_Gdata_Entry
{
    ...
    public function getVolumeId()
    {
        ...
        if ($position === false) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Exception.php';
