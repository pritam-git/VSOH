 ...
 * @version    $Id: EventEntry.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'App' . DIRECTORY_SEPARATOR . 'Extension.php';

/**
 * @see Zend_Gdata_Extension_Where
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Where.php';

/**
 * @see Zend_Gdata_Extension_When
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'When.php';

/**
 * @see Zend_Gdata_Extension_Who
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Who.php';

/**
 * @see Zend_Gdata_Extension_Recurrence
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Recurrence.php';

/**
 * @see Zend_Gdata_Extension_EventStatus
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'EventStatus.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Transparency.php';

/**
 * @see Zend_Gdata_Extension_Visibility
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Visibility.php';

/**
 * @see Zend_Gdata_Extension_ExtendedProperty
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'ExtendedProperty.php';

/**
 * @see Zend_Gdata_Extension_OriginalEvent
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'OriginalEvent.php';

/**
 * @see Zend_Gdata_Extension_EntryLink
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'EntryLink.php';
...
class Zend_Gdata_Kind_EventEntry extends Zend_Gdata_Entry
{
    ...
    protected function takeChildFromDOM($child)
    {
        ...
        case $this->lookupNamespace('gd') . ':' . 'recurrenceException';
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Gdata' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'RecurrenceException.php';
