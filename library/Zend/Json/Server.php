 ...
 * @version    $Id: Server.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Json_Server extends Zend_Server_Abstract
{
    ...
    public function addFunction($function, $namespace = '')
    {
        if (!is_string($function) && (!is_array($function) || (2 > count($function)))) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Json' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Json' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Error.php';
    ...
    public function getRequest()
    {
        if (null === ($request = $this->_request)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Json' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Request' . DIRECTORY_SEPARATOR . 'Http.php';
    ...
    public function getResponse()
    {
        if (null === ($response = $this->_response)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Json' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Response' . DIRECTORY_SEPARATOR . 'Http.php';
    ...
    public function getServiceMap()
    {
        if (null === $this->_serviceMap) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Json' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Smd.php';
