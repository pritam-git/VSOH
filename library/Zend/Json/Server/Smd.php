 ...
 * @version    $Id: Smd.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Json_Server_Smd
{
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Json' . DIRECTORY_SEPARATOR . 'Server' . DIRECTORY_SEPARATOR . 'Smd' . DIRECTORY_SEPARATOR . 'Service.php';
