 ...
 * @version    $Id: Format.php 509 2016-07-27 14:24:23Z nm $
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Locale' . DIRECTORY_SEPARATOR . 'Data.php';
...
class Zend_Locale_Format
{
            ...
            switch($name) {
                case 'number_format' :
                    if ($value == Zend_Locale_Format::STANDARD) {
                        ...
                        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Locale' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    public static function toNumber($value, array $options = array())
    {
        ...
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Locale' . DIRECTORY_SEPARATOR . 'Math.php';
        ...
        if (iconv_strpos($format, '0') === false) {
            (PHP_VERSION_ID < 50600) ? iconv_set_encoding('internal_encoding', $oenc) : ini_set('default_charset', $oenc);
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Locale' . DIRECTORY_SEPARATOR . 'Exception.php';
