...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Form' . DIRECTORY_SEPARATOR . 'Decorator' . DIRECTORY_SEPARATOR . 'Marker' . DIRECTORY_SEPARATOR . 'File' . DIRECTORY_SEPARATOR . 'Interface.php';

/** Zend_File_Transfer_Adapter_Http */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'File' . DIRECTORY_SEPARATOR . 'Transfer' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Http.php';
