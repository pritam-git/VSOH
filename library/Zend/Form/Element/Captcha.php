 ...
 * @version    $Id: Captcha.php 443 2015-09-29 11:12:31Z nm $
 */
...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Captcha' . DIRECTORY_SEPARATOR . 'Adapter.php';
        ...
        if ($type == self::CAPTCHA) {
            if (!isset($this->_loaders[$type])) {
                ...
                $this->_loaders[$type] = new Zend_Loader_PluginLoader(
                    array('Zend_Captcha' => 'Zend' . DIRECTORY_SEPARATOR . 'Captcha' . DIRECTORY_SEPARATOR)
                );
            }
