...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Form' . DIRECTORY_SEPARATOR . 'Element' . DIRECTORY_SEPARATOR . 'Xhtml.php';
 ...
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 * @version    $Id: File.php 443 2015-09-29 11:12:31Z nm $
 */
    ...
    public function getPluginLoader($type)
    {
        ...
        if (!array_key_exists($type, $this->_loaders)) {
            ...
            $loader = new Zend_Loader_PluginLoader(array(
                'Zend_File_Transfer_Adapter' => 'Zend' . DIRECTORY_SEPARATOR . 'File' . DIRECTORY_SEPARATOR . 'Transfer' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR,
            ));
