...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR . 'Interface.php';
 ...
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 * @version    $Id: Element.php 443 2015-09-29 11:12:31Z nm $
 */
class Zend_Form_Element implements Zend_Validate_Interface
{
    ...
    public function __construct($spec, $options = null)
    {
        ...
        if (null === $this->getName()) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Form' . DIRECTORY_SEPARATOR . 'Exception.php';
...
//        }
    ...
    public function __call($method, $args)
    {
        if ('render' == substr($method, 0, 6)) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Form' . DIRECTORY_SEPARATOR . 'Element' . DIRECTORY_SEPARATOR . 'Exception.php';
            ...
            case self::DECORATOR:
                ...
                if (!isset($this->_loaders[$type])) {
                    ...
                    $this->_loaders[$type] = new Zend_Loader_PluginLoader(
                        array('Zend_' . $prefixSegment . '_' => 'Zend' . DIRECTORY_SEPARATOR . $pathSegment . DIRECTORY_SEPARATOR)
                    );
                }
