 ...
 * @version    $Id: Access.php 435 2015-09-28 15:14:38Z nm $
 */

/** Zend_Oauth_Token */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Oauth' . DIRECTORY_SEPARATOR . 'Token.php';

/** Zend_Oauth_Http */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Oauth' . DIRECTORY_SEPARATOR . 'Http.php';

/** Zend_Uri_Http */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Uri' . DIRECTORY_SEPARATOR . 'Http.php';

/** Zend_Oauth_Client */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Oauth' . DIRECTORY_SEPARATOR . 'Client.php';
