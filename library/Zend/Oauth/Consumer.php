 ...
 * @version    $Id: Consumer.php 435 2015-09-28 15:14:38Z nm $
 */

/** Zend_Oauth */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Oauth.php';

/** Zend_Uri */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Uri.php';

/** Zend_Oauth_Http_RequestToken */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Oauth' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'RequestToken.php';

/** Zend_Oauth_Http_UserAuthorization */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Oauth' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'UserAuthorization.php';

/** Zend_Oauth_Http_AccessToken */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Oauth' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'AccessToken.php';

/** Zend_Oauth_Token_AuthorizedRequest */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Oauth' . DIRECTORY_SEPARATOR . 'Token' . DIRECTORY_SEPARATOR . 'AuthorizedRequest.php';

/** Zend_Oauth_Config */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Oauth' . DIRECTORY_SEPARATOR . 'Config.php';
...
class Zend_Oauth_Consumer extends Zend_Oauth
{
    ...
    public function getAccessToken(
        ...
        if (!$authorizedToken->isValid()) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Oauth' . DIRECTORY_SEPARATOR . 'Exception.php';
