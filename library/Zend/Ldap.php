 ...
 * @version    $Id: Ldap.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Ldap
{
    ...
    public static function filterEscape($str)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Filter' . DIRECTORY_SEPARATOR . 'Abstract.php';
    ...
    public static function explodeDn($dn, array &$keys = null, array &$vals = null)
    {
         ...
         * @see Zend_Ldap_Dn
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Dn.php';
    ...
    public function __construct($options = array())
    {
        if (!extension_loaded('ldap')) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Exception.php';
        ...
        $sort = null, $collectionClass = null, $sizelimit = 0, $timelimit = 0)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Collection' . DIRECTORY_SEPARATOR . 'Iterator' . DIRECTORY_SEPARATOR . 'Default.php';
    ...
    protected function _createCollection(Zend_Ldap_Collection_Iterator_Default $iterator, $collectionClass)
    {
        if ($collectionClass === null) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Collection.php';
    ...
    public function getNode($dn)
    {
         ...
         * Zend_Ldap_Node
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node.php';
    ...
    public function getRootDse()
    {
        if ($this->_rootDse === null) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'RootDse.php';
    ...
    public function getSchema()
    {
        if ($this->_schema === null) {
             ...
             * @see Zend_Ldap_Node_Schema
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Node' . DIRECTORY_SEPARATOR . 'Schema.php';
