 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Soap' . DIRECTORY_SEPARATOR . 'Server.php';

/**
 * @see Zend_Soap_Client_Local
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Soap' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Local.php';

/**
 * @see Zend_Soap_Client_Common
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Soap' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Common.php';
...
class Zend_Soap_Client
{
    ...
    public function __construct($wsdl = null, $options = null)
    {
        if (!extension_loaded('soap')) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Soap' . DIRECTORY_SEPARATOR . 'Client' . DIRECTORY_SEPARATOR . 'Exception.php';
