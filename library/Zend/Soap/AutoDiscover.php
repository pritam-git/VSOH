 ...
 * @version    $Id: AutoDiscover.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 * @see Zend_Soap_Wsdl
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Soap' . DIRECTORY_SEPARATOR . 'Wsdl.php';
/**
...
class Zend_Soap_AutoDiscover implements Zend_Server_Interface
{
    ...
    public function setUri($uri)
    {
        if (!is_string($uri) && !($uri instanceof Zend_Uri)) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Soap' . DIRECTORY_SEPARATOR . 'AutoDiscover' . DIRECTORY_SEPARATOR . 'Exception.php';
