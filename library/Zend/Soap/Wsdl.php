 ...
 * @version    $Id: Wsdl.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Soap' . DIRECTORY_SEPARATOR . 'Wsdl' . DIRECTORY_SEPARATOR . 'Strategy' . DIRECTORY_SEPARATOR . 'Abstract.php';
...
class Zend_Soap_Wsdl
{
    ...
    {
        if($strategy === true) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Soap' . DIRECTORY_SEPARATOR . 'Wsdl' . DIRECTORY_SEPARATOR . 'Strategy' . DIRECTORY_SEPARATOR . 'DefaultComplexType.php';
            $strategy = new Zend_Soap_Wsdl_Strategy_DefaultComplexType();
        } else if($strategy === false) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Soap' . DIRECTORY_SEPARATOR . 'Wsdl' . DIRECTORY_SEPARATOR . 'Strategy' . DIRECTORY_SEPARATOR . 'AnyType.php';
            $strategy = new Zend_Soap_Wsdl_Strategy_AnyType();
        } else if(is_string($strategy)) {
            if(class_exists($strategy)) {
                $strategy = new $strategy();
            } else {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Soap' . DIRECTORY_SEPARATOR . 'Wsdl' . DIRECTORY_SEPARATOR . 'Exception.php';
