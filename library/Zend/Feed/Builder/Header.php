 ...
 * @version    $Id: Header.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Feed_Builder_Header_Itunes
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Builder' . DIRECTORY_SEPARATOR . 'Header' . DIRECTORY_SEPARATOR . 'Itunes.php';
...
class Zend_Feed_Builder_Header extends ArrayObject
{
    ...
    public function setEmail($email)
    {
        ...
        if (!$validate->isValid($email)) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Builder' . DIRECTORY_SEPARATOR . 'Exception.php';
