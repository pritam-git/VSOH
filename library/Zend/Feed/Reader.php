 ...
 * @version    $Id: Reader.php 441 2015-09-29 09:41:22Z nm $
 */

/**
 * @see Zend_Feed
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed.php';

/**
 * @see Zend_Feed_Reader_Feed_Rss
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Rss.php';

/**
 * @see Zend_Feed_Reader_Feed_Atom
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Atom.php';

/**
 * @see Zend_Feed_Reader_FeedSet
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'FeedSet.php';
    ...
    public static function getPluginLoader()
    {
        if (!isset(self::$_pluginLoader)) {
            ...
            self::$_pluginLoader = new Zend_Loader_PluginLoader(array(
                'Zend_Feed_Reader_Extension_' => 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR,
            ));
        }
