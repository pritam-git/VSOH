 ...
 * @version    $Id: CallbackAbstract.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Feed_Pubsubhubbub_CallbackInterface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Pubsubhubbub' . DIRECTORY_SEPARATOR . 'CallbackInterface.php';

/**
 * @see Zend_Feed_Pubsubhubbub_HttpResponse
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Pubsubhubbub' . DIRECTORY_SEPARATOR . 'HttpResponse.php';
