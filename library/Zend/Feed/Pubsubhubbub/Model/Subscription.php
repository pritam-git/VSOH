 ...
 * @version    $Id: Subscription.php 435 2015-09-28 15:14:38Z nm $
 */

/** @see Zend_Feed_Pubsubhubbub_Model_ModelAbstract */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Pubsubhubbub' . DIRECTORY_SEPARATOR . 'Model' . DIRECTORY_SEPARATOR . 'ModelAbstract.php';

/** @see Zend_Feed_Pubsubhubbub_Model_SubscriptionInterface */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Pubsubhubbub' . DIRECTORY_SEPARATOR . 'Model' . DIRECTORY_SEPARATOR . 'SubscriptionInterface.php';
    ...
    implements Zend_Feed_Pubsubhubbub_Model_SubscriptionInterface
{
    ...
    {
        if (!isset($data['id'])) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Pubsubhubbub' . DIRECTORY_SEPARATOR . 'Exception.php';
