 ...
 * @version    $Id: Callback.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Feed_Pubsubhubbub
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Pubsubhubbub.php';

/**
 * @see Zend_Feed_Pubsubhubbub
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Pubsubhubbub' . DIRECTORY_SEPARATOR . 'CallbackAbstract.php';
