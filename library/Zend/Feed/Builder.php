 ...
 * @version    $Id: Builder.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Builder' . DIRECTORY_SEPARATOR . 'Interface.php';

/**
 * @see Zend_Feed_Builder_Header
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Builder' . DIRECTORY_SEPARATOR . 'Header.php';

/**
 * @see Zend_Feed_Builder_Entry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Builder' . DIRECTORY_SEPARATOR . 'Entry.php';
