 ...
 * @version    $Id: Rss.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Feed_Reader
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader.php';

/**
 * @see Zend_Feed_Reader_EntryInterface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'EntryInterface.php';

/**
 * @see Zend_Feed_Reader_EntryAbstract
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'EntryAbstract.php';

/**
 * @see Zend_Feed_Reader_Extension_DublinCore_Entry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'DublinCore' . DIRECTORY_SEPARATOR . 'Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_Content_Entry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Content' . DIRECTORY_SEPARATOR . 'Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_Atom_Entry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Atom' . DIRECTORY_SEPARATOR . 'Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_WellformedWeb_Entry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'WellFormedWeb' . DIRECTORY_SEPARATOR . 'Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_Slash_Entry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Slash' . DIRECTORY_SEPARATOR . 'Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_Thread_Entry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Thread' . DIRECTORY_SEPARATOR . 'Entry.php';

/**
 * @see Zend_Date
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Date.php';

/**
 * @see Zend_Feed_Reader_Collection_Category
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Collection' . DIRECTORY_SEPARATOR . 'Category.php';
                    ...
                    foreach ($dateStandards as $standard) {
                        try {
                            ...
                            if ($standard == Zend_Date::DATES) {
                                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Exception.php';
