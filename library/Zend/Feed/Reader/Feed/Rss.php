 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'FeedAbstract.php';

/**
 * @see Zend_feed_Reader_Extension_Atom_Feed
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'Atom' . DIRECTORY_SEPARATOR . 'Feed.php';

/**
 * @see Zend_Feed_Reader_Extension_DublinCore_Feed
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR . 'DublinCore' . DIRECTORY_SEPARATOR . 'Feed.php';
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Collection' . DIRECTORY_SEPARATOR . 'Author.php';
