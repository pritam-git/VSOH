 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Entry' . DIRECTORY_SEPARATOR . 'Atom.php';


/**
 * @see Zend_Feed_Reader_Entry_Rss
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Reader' . DIRECTORY_SEPARATOR . 'Entry' . DIRECTORY_SEPARATOR . 'Rss.php';
