 ...
 * @version    $Id: Writer.php 441 2015-09-29 09:41:22Z nm $
 */
    ...
    public static function getPluginLoader()
    {
        if (!isset(self::$_pluginLoader)) {
            ...
            self::$_pluginLoader = new Zend_Loader_PluginLoader(array(
                'Zend_Feed_Writer_Extension_' => 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Extension' . DIRECTORY_SEPARATOR,
            ));
        }
