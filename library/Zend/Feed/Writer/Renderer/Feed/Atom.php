 ...
 * @version    $Id: Atom.php 435 2015-09-28 15:14:38Z nm $
 */

/** @see Zend_Feed_Writer_Feed */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Feed.php';

/** @see Zend_Version */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Version.php';

/** @see Zend_Feed_Writer_Renderer_RendererInterface */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'RendererInterface.php';

/** @see Zend_Feed_Writer_Renderer_Entry_Atom */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'Entry' . DIRECTORY_SEPARATOR . 'Atom.php';

/** @see Zend_Feed_Writer_Renderer_Entry_Atom_Deleted */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'Entry' . DIRECTORY_SEPARATOR . 'Atom' . DIRECTORY_SEPARATOR . 'Deleted.php';

/** @see Zend_Feed_Writer_Renderer_RendererAbstract */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'RendererAbstract.php';

require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Atom' . DIRECTORY_SEPARATOR . 'AtomAbstract.php';
