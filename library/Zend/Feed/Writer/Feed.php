 ...
 * @version    $Id: Feed.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 * @see Zend_Date
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Uri.php';

/**
 * @see Zend_Feed_Writer
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Writer.php';

/**
 * @see Zend_Feed_Writer_Entry
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Entry.php';

/**
 * @see Zend_Feed_Writer_Deleted
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Deleted.php';

/**
 * @see Zend_Feed_Writer_Renderer_Feed_Atom
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Atom.php';

/**
 * @see Zend_Feed_Writer_Renderer_Feed_Rss
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Rss.php';

require_once 'Zend' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'Writer' . DIRECTORY_SEPARATOR . 'Feed' . DIRECTORY_SEPARATOR . 'FeedAbstract.php';
