 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Auth' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'Resolver' . DIRECTORY_SEPARATOR . 'Interface.php';
...
class Zend_Auth_Adapter_Http_Resolver_File implements Zend_Auth_Adapter_Http_Resolver_Interface
{
    ...
    public function setFile($path)
    {
        if (empty($path) || !is_readable($path)) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Auth' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'Resolver' . DIRECTORY_SEPARATOR . 'Exception.php';
