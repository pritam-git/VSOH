 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Auth' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Interface.php';
...
class Zend_Auth_Adapter_Ldap implements Zend_Auth_Adapter_Interface
{
    ...
    public function authenticate()
    {
        ...
        foreach ($this->_options as $name => $options) {
            ...
            if (!is_array($options)) {
                 ...
                 */
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Auth' . DIRECTORY_SEPARATOR . 'Adapter' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    protected function _checkGroupMembership(Zend_Ldap $ldap, $canonicalName, $dn, array $adapterOptions)
    {
         ...
         */
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Ldap' . DIRECTORY_SEPARATOR . 'Filter.php';
