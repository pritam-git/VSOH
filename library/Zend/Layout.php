 ...
 * @version    $Id: Layout.php 435 2015-09-28 15:14:38Z nm $
 */
...
class Zend_Layout
{
    ...
    public function __construct($options = null, $initMvc = false)
    {
        if (null !== $options) {
            if (is_string($options)) {
                ...
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Layout' . DIRECTORY_SEPARATOR . 'Exception.php';
    ...
    protected function _initVarContainer()
    {
        if (null === $this->_container) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR . 'Helper' . DIRECTORY_SEPARATOR . 'Placeholder' . DIRECTORY_SEPARATOR . 'Registry.php';
