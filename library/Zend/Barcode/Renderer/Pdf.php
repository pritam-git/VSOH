...
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Barcode' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'RendererAbstract.php';
...
class Zend_Barcode_Renderer_Pdf extends Zend_Barcode_Renderer_RendererAbstract
{
    ...
    public function setResource($pdf, $page = 0)
    {
        if (!$pdf instanceof Zend_Pdf) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Barcode' . DIRECTORY_SEPARATOR . 'Renderer' . DIRECTORY_SEPARATOR . 'Exception.php';
