 ...
 * @version    $Id: Upce.php 435 2015-09-28 15:14:38Z nm $
 */

/**
 * @see Zend_Barcode_Object_Ean13
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Barcode' . DIRECTORY_SEPARATOR . 'Object' . DIRECTORY_SEPARATOR . 'Ean13.php';

/**
 * @see Zend_Validate_Barcode
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Validate' . DIRECTORY_SEPARATOR . 'Barcode.php';
...
class Zend_Barcode_Object_Upce extends Zend_Barcode_Object_Ean13
{
    ...
    protected function _validateText($value, $options = array())
    {
        ...
        if (!$validator->isValid($value)) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Barcode' . DIRECTORY_SEPARATOR . 'Object' . DIRECTORY_SEPARATOR . 'Exception.php';
