 ...
 * @version    $Id: Pdf.php 435 2015-09-28 15:14:38Z nm $
 */
...
/** Zend_Pdf_Page */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Page.php';

/** Zend_Pdf_Style */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Style.php';

/** Zend_Pdf_Color_GrayScale */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Color' . DIRECTORY_SEPARATOR . 'GrayScale.php';

/** Zend_Pdf_Color_Rgb */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Color' . DIRECTORY_SEPARATOR . 'Rgb.php';

/** Zend_Pdf_Color_Cmyk */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Color' . DIRECTORY_SEPARATOR . 'Cmyk.php';

/** Zend_Pdf_Color_Html */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Color' . DIRECTORY_SEPARATOR . 'Html.php';

/** Zend_Pdf_Image */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Image.php';

/** Zend_Pdf_Font */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Font.php';

/** Zend_Pdf_Resource_Extractor */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Extractor.php';

/** Zend_Pdf_Canvas */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Canvas.php';


/** Internally used classes */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Element.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Element' . DIRECTORY_SEPARATOR . 'Array.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Element' . DIRECTORY_SEPARATOR . 'String' . DIRECTORY_SEPARATOR . 'Binary.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Element' . DIRECTORY_SEPARATOR . 'Boolean.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Element' . DIRECTORY_SEPARATOR . 'Dictionary.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Element' . DIRECTORY_SEPARATOR . 'Name.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Element' . DIRECTORY_SEPARATOR . 'Null.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Element' . DIRECTORY_SEPARATOR . 'Numeric.php';
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Element' . DIRECTORY_SEPARATOR . 'String.php';
  ...
  /**** Class Constants ****/
    ...
    static public function getMemoryManager()
    {
        if (self::$_memoryManager === null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Memory.php';
    ...
    {
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'ElementFactory.php';
        $this->_objFactory = Zend_Pdf_ElementFactory::createFactory(1);

        if ($source !== null) {
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Parser.php';
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Trailer' . DIRECTORY_SEPARATOR . 'Generator.php';
    ...
    protected function _loadNamedDestinations(Zend_Pdf_Element_Reference $root, $pdfHeaderVersion)
    {
        ...
        if ($versionIs_1_2_plus) {
            ...
            if ($root->Names !== null  &&  $root->Names->Dests !== null) {
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'NameTree.php';
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Target.php';
    ...
    protected function _loadOutlines(Zend_Pdf_Element_Reference $root)
    {
        ...
        while ($outlineDictionary !== null  &&  !$processedDictionaries->contains($outlineDictionary)) {
            ...
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Outline' . DIRECTORY_SEPARATOR . 'Loaded.php';
    ...
    protected function _dumpPages()
    {
        ...
        // Refresh outlines
        require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'RecursivelyIteratableObjectsContainer.php';
    ...
    public function extractFonts()
    {
        ...
        foreach ($fontResourcesUnique as $resourceId => $fontDictionary) {
            try {
                // Try to extract font
                require_once 'Zend' . DIRECTORY_SEPARATOR . 'Pdf' . DIRECTORY_SEPARATOR . 'Resource' . DIRECTORY_SEPARATOR . 'Font' . DIRECTORY_SEPARATOR . 'Extracted.php';
