 ...
 * @version    $Id: Smtp.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Protocol' . DIRECTORY_SEPARATOR . 'Smtp.php';
...
class Zend_Mail_Transport_Smtp extends Zend_Mail_Transport_Abstract
{
    ...
    protected function _prepareHeaders($headers)
    {
        if (!$this->_mail) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Transport' . DIRECTORY_SEPARATOR . 'Exception.php';
