 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Protocol' . DIRECTORY_SEPARATOR . 'Abstract.php';
        ...
        if (isset($config['ssl'])) {
            switch (strtolower($config['ssl'])) {
                ...
                default:
                     ...
                     */
                    require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Protocol' . DIRECTORY_SEPARATOR . 'Exception.php';
