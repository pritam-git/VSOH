 ...
 * @version    $Id: Imap.php 435 2015-09-28 15:14:38Z nm $
 */
 ...
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'Abstract.php';

/**
 * @see Zend_Mail_Protocol_Imap
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Protocol' . DIRECTORY_SEPARATOR . 'Imap.php';

/**
 * @see Zend_Mail_Storage_Writable_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'Writable' . DIRECTORY_SEPARATOR . 'Interface.php';

/**
 * @see Zend_Mail_Storage_Folder_Interface
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'Folder' . DIRECTORY_SEPARATOR . 'Interface.php';

/**
 * @see Zend_Mail_Storage_Folder
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'Folder.php';

/**
 * @see Zend_Mail_Message
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Message.php';

/**
 * @see Zend_Mail_Storage
 */
require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Storage.php';
                             ...
                             implements Zend_Mail_Storage_Folder_Interface, Zend_Mail_Storage_Writable_Interface
{
    ...
    public function countMessages($flags = null)
    {
        if (!$this->_currentFolder) {
             ...
             */
            require_once 'Zend' . DIRECTORY_SEPARATOR . 'Mail' . DIRECTORY_SEPARATOR . 'Storage' . DIRECTORY_SEPARATOR . 'Exception.php';
