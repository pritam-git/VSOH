 ...
 *
 *
 * @filesource /application/controllers/ArchiveOtcController.php
 * @author     Krishna Bhatt <krishna.patel@bcssarl.com>
 * @version    $Id: ArchiveOtcController.php 549 2019-01-07 04:48:59Z nm $
 */

/**
 *
 *
 * ArchiveOtcController
 *
 *
 */
class ArchiveOtcController extends L8M_Controller_Action
{
	/**
	 *
	 *
...
//			))
			->setAction($this->view->url(array('module'=>'default', 'controller'=>'archive-otc', 'action'=>'index'), NULL, TRUE))
		;
