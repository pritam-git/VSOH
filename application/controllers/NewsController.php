 ...
 *
 *
 * @filesource /application/controllers/NewsController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: NewsController.php 549 2017-08-30 08:26:59Z nm $
 */
 ...
 *
 */
class NewsController extends L8M_Controller_Action
{
	/**
	 *
	 *
...
//			))
			->setAction($this->view->url(array('module'=>'default', 'controller'=>'news', 'action'=>'index'), NULL, TRUE))
		;
