 ...
 *
 *
 * @filesource /application/controllers/AssemblyController.php
 * @author     Krishna Bhatt <krishna.patel@bcssarl.com>
 * @version    $Id: AssemblyController.php 549 2019-01-07 05:33:59Z nm $
 */
 ...
 *
 */
class AssemblyController extends L8M_Controller_Action
{
	/**
	 *
	 *
...
//			))
			->setAction($this->view->url(array('module'=>'default', 'controller'=>'assembly', 'action'=>'index'), NULL, TRUE))
		;
