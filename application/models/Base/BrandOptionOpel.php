...
/**
 * Default_Model_Base_BrandOptionOpel
 * 
 ...
 */
abstract class Default_Model_Base_BrandOptionOpel extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('brand_option_opel');
