...
/**
 * Default_Model_Base_MetaConfiguration
 * 
 ...
 */
abstract class Default_Model_Base_MetaConfiguration extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('meta_configuration');
