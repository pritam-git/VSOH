...
/**
 * Default_Model_Base_OtcM2nMediaImage
 * 
 ...
 * @property Default_Model_Otc $Otc
 ...
 */
abstract class Default_Model_Base_OtcM2nMediaImage extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('otc_m2n_media_image');
        ...
        $this->hasColumn('otc_id', 'integer', 11, array(
             'type' => 'integer',
             'unsigned' => true,
             'notnull' => true,
             'length' => '11',
    ...
    {
        parent::setUp();
        $this->hasOne('Default_Model_Otc as Otc', array(
             'local' => 'otc_id',
             'foreign' => 'id'));
