...
/**
 * Default_Model_Base_NewsM2nMediaImage
 * 
 ...
 * @property Default_Model_News $News
 ...
 */
abstract class Default_Model_Base_NewsM2nMediaImage extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('news_m2n_media_image');
    ...
    {
        parent::setUp();
        $this->hasOne('Default_Model_News as News', array(
             'local' => 'news_id',
             'foreign' => 'id'));
