...
/**
 * Default_Model_Base_ProductOptionItems
 * 
 ...
 */
abstract class Default_Model_Base_ProductOptionItems extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('product_option_items');
    ...
    public function setUp()
    {
        ...
        $this->hasMany('Default_Model_ProductOptionsM2nProductOptionItems as ProductOptionsM2nProductOptionItems', array(
             'local' => 'id',
             'foreign' => 'product_option_items_id'));

        $i18n0 = new Doctrine_Template_I18n(array(
             'tableName' => 'product_option_items_translation',
             'fields' => 
             array(
              0 => 'name',
             ),
