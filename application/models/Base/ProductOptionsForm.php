...
/**
 * Default_Model_Base_ProductOptionsForm
 * 
 ...
 */
abstract class Default_Model_Base_ProductOptionsForm extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('product_options_form');
