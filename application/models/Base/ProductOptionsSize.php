...
/**
 * Default_Model_Base_ProductOptionsSize
 * 
 ...
 */
abstract class Default_Model_Base_ProductOptionsSize extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('product_options_size');
