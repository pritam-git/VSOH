...
/**
 * Default_Model_Base_TinymceTemplate
 * 
 ...
 */
abstract class Default_Model_Base_TinymceTemplate extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('tinymce_template');
