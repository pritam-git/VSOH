...
/**
 * Default_Model_Base_NewsM2nDepartment
 * 
 ...
 */
abstract class Default_Model_Base_NewsM2nDepartment extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('news_m2n_department');
