 ...
 * @property integer $rollover_media_image_id
 ...
 * @property Default_Model_MediaImage $RolloverMediaImage
 * 
 * @package    L8M
 ...
 */
abstract class Default_Model_Base_ContentBox extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('content_box');
        ...
        $this->hasColumn('rollover_media_image_id', 'integer', 11, array(
             'type' => 'integer',
             'unsigned' => true,
             'notnull' => true,
             'length' => '11',
        ...
        $this->index('rollover_media_image_id_idx', array(
             'fields' => 
             array(
              0 => 'rollover_media_image_id',
             ),
             ));
    ...
    public function setUp()
    {
        ...
        $this->hasOne('Default_Model_MediaImage as RolloverMediaImage', array(
             'local' => 'rollover_media_image_id',
             'foreign' => 'id'));

        $i18n0 = new Doctrine_Template_I18n(array(
             'tableName' => 'content_box_translation',
             'fields' => 
             array(
              0 => 'title',
              1 => 'content',
