...
/**
 * Default_Model_Base_EntityLogMessage
 * 
 ...
 */
abstract class Default_Model_Base_EntityLogMessage extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('entity_log_message');
