...
/**
 * Default_Model_Base_ResourceTranslator
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 * 
 * @property integer $id
 * @property string $resource
 * @property string $uresource
 * 
 * @package    L8M
 ...
 */
abstract class Default_Model_Base_ResourceTranslator extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('resource_translator');
        ...
        $this->hasColumn('uresource', 'string', 255, array(
             'type' => 'string',
             'notnull' => true,
             'length' => '255',
             ));
    ...
    public function setUp()
    {
        ...
        $i18n0 = new Doctrine_Template_I18n(array(
             'tableName' => 'resource_translator_translation',
             'fields' => 
             array(
              0 => 'uresource',
             ),
