...
/**
 * Default_Model_Base_ProductOptionModel
 * 
 ...
 */
abstract class Default_Model_Base_ProductOptionModel extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('product_option_model');
    ...
    public function setUp()
    {
        ...
        $this->hasMany('Default_Model_ProductM2nProductOptionModel as ProductM2nProductOptionModel', array(
             'local' => 'id',
             'foreign' => 'product_option_model_id'));

        $i18n0 = new Doctrine_Template_I18n(array(
             'tableName' => 'product_option_model_translation',
             'fields' => 
             array(
              0 => 'title',
             ),
