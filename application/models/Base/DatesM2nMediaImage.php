...
/**
 * Default_Model_Base_DatesM2nMediaImage
 * 
 ...
 */
abstract class Default_Model_Base_DatesM2nMediaImage extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('dates_m2n_media_image');
