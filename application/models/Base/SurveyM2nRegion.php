...
/**
 * Default_Model_Base_SurveyM2nRegion
 * 
 ...
 */
abstract class Default_Model_Base_SurveyM2nRegion extends Default_Model_Base_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('survey_m2n_region');
