 ...
 *
 *
 * @filesource /application/models/EntityAdmin/Import.php
 ...
 *
 *
 * Default_Model_EntityAdmin_Import
 *
 *
 */
class Default_Model_EntityAdmin_Import extends L8M_Doctrine_Import_Abstract
{
	...
	protected function _init()
	{
		...
		$w[] = array(
			'id'=>$i,
			'short'=>'admin@hahn-media.ch',
			'login'=>'admin@hahn-media.ch',
			'password'=>L8M_Library::generateDBPasswordHash('admin'),
			'activated_at'=>date('Y-m-d H:i:s'),
			'email'=>'admin@hahn-media.ch',
			'ch_code'=>md5('admin@hahn-media.ch'),
			'ch_code_dara'=>md5('admin@hahn-media.ch'),
			'cadc'=>md5('admin@hahn-media.ch'),
		);
