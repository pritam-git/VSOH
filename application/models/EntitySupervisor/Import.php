 ...
 *
 *
 * @filesource /application/models/EntitySupervisor/Import.php
 ...
 *
 *
 * Default_Model_EntitySupervisor_Import
 *
 *
 */
class Default_Model_EntitySupervisor_Import extends L8M_Doctrine_Import_Abstract
{
	...
	protected function _init()
	{
		...
		$w[] = array(
			'id'=>$i,
			'short'=>'supervisor@hahn-media.ch',
			'login'=>'supervisor@hahn-media.ch',
			'password'=>L8M_Library::generateDBPasswordHash('supervisor'),
			'activated_at'=>date('Y-m-d H:i:s'),
			'email'=>'supervisor@hahn-media.ch',
			'ch_code'=>md5('supervisor@hahn-media.ch'),
			'ch_code_dara'=>md5('supervisor@hahn-media.ch'),
			'cadc'=>md5('supervisor@hahn-media.ch'),
		);
