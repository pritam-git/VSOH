 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ShopProductOptionsController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ShopProductOptionsController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ShopProductOptionsController
 *
 *
 */
class Admin_ShopProductOptionsController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_ProductOptions';
	private $_modelListShort = 'spo';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Shop ProductOptions';
	...
	/**
	 * Initializes Admin_ShopProductOptionsController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			...
			'columnLabels'=>array(
				'relation_m2n_productoptionsm2nproductoptionitems'=>'ProductOptionItems',
			),
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
			),
