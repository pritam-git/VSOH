 ...
 *
 *
 * @filesource /application/modules/admin/controllers/LoginController.php
 ...
 *
 */
class Admin_LoginController extends L8M_Controller_Action
{
	/**
	 *
	 *
	...
	public function indexAction ()
	{
		...
		$form
			->setAction($this->_helper->url('index', 'login', 'admin', array('comingFrom'=>$paramComingFrom)))
		;
