 ...
 *
 *
 * @filesource /application/modules/admin/controllers/TinymceTemplateController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: TinymceTemplateController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_TinymceTemplateController
 *
 *
 */
class Admin_TinymceTemplateController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_TinymceTemplate';
	private $_modelListShort = 'tymce';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'TinymceTemplate';
	...
	/**
	 * Initializes Admin_TinymceTemplateController.
	 *
	 * @return void
	 */
