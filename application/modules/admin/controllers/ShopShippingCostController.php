 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ShopShippingCostController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ShopShippingCostController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ShopShippingCostController
 *
 *
 */
class Admin_ShopShippingCostController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_ShippingCost';
	private $_modelListShort = 'spoc';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Shop ShippingCost';
	...
	/**
	 * Initializes Admin_ShopShippingCostController.
	 *
	 * @return void
	 */
