 ...
 *
 *
 * @filesource /application/modules/admin/controllers/SiteConfigController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: SiteConfigController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_SiteConfigController
 *
 *
 */
class Admin_SiteConfigController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_SiteConfig';
	private $_modelListShort = 'scfg';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'SiteConfig';
	...
	/**
	 * Initializes Admin_SiteConfigController.
	 *
	 * @return void
	 */
