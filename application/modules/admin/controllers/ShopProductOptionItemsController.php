 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ShopProductOptionItemsController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ShopProductOptionItemsController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ShopProductOptionItemsController
 *
 *
 */
class Admin_ShopProductOptionItemsController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_ProductOptionItems';
	private $_modelListShort = 'spoi';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Shop ProductOptionItems';
	...
	/**
	 * Initializes Admin_ShopProductOptionItemsController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			'order'=>array(
				'name',
				'price',
				'relation_m2n_productoptionsm2nproductoptionitems',
			),
			...
			'columnLabels'=>array(
				'price'=>'Extra Price',
				'relation_m2n_productoptionsm2nproductoptionitems'=>'ProductOptions',
			),
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
			),
