 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ShopTemporaryOfferController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ShopTemporaryOfferController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ShopTemporaryOfferController
 *
 *
 */
class Admin_ShopTemporaryOfferController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_TemporaryOffer';
	private $_modelListShort = 'spott';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Shop TemporaryOffer';
	...
	/**
	 * Initializes Admin_ShopTemporaryOfferController.
	 *
	 * @return void
	 */
