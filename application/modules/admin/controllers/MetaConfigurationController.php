 ...
 *
 *
 * @filesource /application/modules/admin/controllers/MetaConfigurationController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: MetaConfigurationController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_MetaConfigurationController
 *
 *
 */
class Admin_MetaConfigurationController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_MetaConfiguration';
	private $_modelListShort = 'meco';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'MetaConfiguration';
	...
	/**
	 * Initializes Admin_MetaConfigurationController.
	 *
	 * @return void
	 */
