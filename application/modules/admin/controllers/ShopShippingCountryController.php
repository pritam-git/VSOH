 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ShopShippingCountryController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ShopShippingCountryController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ShopShippingCountryController
 *
 *
 */
class Admin_ShopShippingCountryController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_ShippingCountry';
	private $_modelListShort = 'shpc';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'ShippingCountry';
	...
	/**
	 * Initializes Admin_ShopShippingCountryController.
	 *
	 * @return void
	 */
