 ...
 *
 *
 * @filesource /application/modules/admin/controllers/NewsletterUserController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: NewsletterUserController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_NewsletterUserController
 *
 *
 */
class Admin_NewsletterUserController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_NewsletterSubscriber';
	private $_modelListShort = 'nwsu';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'NewsletterSubscriber';
	...
	/**
	 * Initializes Admin_NewsletterSubscriberController.
	 *
	 * @return void
	 */
