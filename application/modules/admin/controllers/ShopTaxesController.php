 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ShopTaxesController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ShopTaxesController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ShopTaxesController
 *
 *
 */
class Admin_ShopTaxesController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_Taxes';
	private $_modelListShort = 'st';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Shop Taxes';
	...
	/**
	 * Initializes Admin_ShopTaxesController.
	 *
	 * @return void
	 */
