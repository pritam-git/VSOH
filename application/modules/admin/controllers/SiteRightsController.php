 ...
 *
 *
 * @filesource /application/modules/admin/controllers/SiteRightsController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: SiteRightsController.php 307 2015-03-31 11:00:06Z nm $
 */

/**
 *
 *
 * Admin_SiteRightsController
 *
 *
 */
class Admin_SiteRightsController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_SiteRights';
	private $_modelListShort = 'srights';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'SiteRights';
	...
	/**
	 * Initializes Admin_SiteRightsController.
	 *
	 * @return void
	 */
...
// 				'name',
			...
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
				'email_text_plain'=>'textarea',
				'email_text_html'=>'textarea',
			),
