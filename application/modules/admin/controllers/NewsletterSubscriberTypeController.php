 ...
 *
 *
 * @filesource /application/modules/admin/controllers/NewsletterSubscriberTypeController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: NewsletterSubscriberTypeController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_NewsletterSubscriberTypeController
 *
 *
 */
class Admin_NewsletterSubscriberTypeController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_NewsletterSubscriberType';
	private $_modelListShort = 'nwst';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'NewsletterSubscriberType';
	...
	/**
	 * Initializes Admin_NewsletterSubscriberTypeController.
	 *
	 * @return void
	 */
