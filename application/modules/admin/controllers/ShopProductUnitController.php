 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ShopProductUnitController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ShopProductUnitController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ShopProductUnitController
 *
 *
 */
class Admin_ShopProductUnitController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_ProductUnit';
	private $_modelListShort = 'spou';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Shop ProductUnit';
	...
	/**
	 * Initializes Admin_ShopProductUnitController.
	 *
	 * @return void
	 */
