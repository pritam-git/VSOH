 ...
 *
 *
 * @filesource /application/modules/admin/controllers/RegionController.php
 * @author     Debopam Parua <debopam.parua@bcssarl.com>
 * @version    $Id: RegionController.php 299 2018-12-11 19:24:38Z dp $
 */

/**
 *
 *
 * Admin_RegionController
 *
 *
 */
class Admin_RegionController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_Region';
	private $_modelListShort = 'Region';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Region';
	...
	/**
	 * Initializes Admin_RegionController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			...
			'columnLabels'=>array(
				'region_media_image_id'=>'Image',
				'relation_m2n_otcm2nregion'=>'OTC',
				'relation_m2n_datesm2nregion'=>'Dates',
				'relation_m2n_protocolm2nregion'=>'Protocol',
				'relation_m2n_assemblym2nregion'=>'Assembly',
			),
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
				'title'=>'text',
