 ...
 *
 *
 * @filesource /application/modules/admin/controllers/MediaConfigController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: MediaConfigController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_MediaConfigController
 *
 *
 */
class Admin_MediaConfigController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_MediaConfig';
	private $_modelListShort = 'imco';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'MediaConfig';
	...
	/**
	 * Initializes Admin_MediaConfigController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			...
			'mediaDirectory'=>array(
				'media_id'=>'/media/mediaconfig',
			),
			'mediaRole'=>array(
				'media_image_id'=>'guest',
			),
			'columnLabels'=>array(
				'media_config_media_id'=>'Media',
			),
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
			),
