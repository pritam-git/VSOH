 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ShopPaymentServicesController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ShopPaymentServicesController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ShopPaymentServicesController
 *
 *
 */
class Admin_ShopPaymentServicesController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_PaymentService';
	private $_modelListShort = 'sps';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Shop PaymentServices';
	...
	/**
	 * Initializes Admin_ShopPaymentServicesController.
	 *
	 * @return void
	 */
