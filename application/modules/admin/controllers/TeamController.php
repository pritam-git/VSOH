 ...
 *
 *
 * @filesource /application/modules/admin/controllers/TeamController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: TeamController.php 299 2015-03-31 10:59:38Z nm $
 */
 ...
 *
 */
class Admin_TeamController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_Team';
	private $_modelListShort = 'team';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Team';
	...
	/**
	 * Initializes Admin_TeamController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			...
			'mediaDirectory'=>array(
				'media_image_id'=>'/images/team',
			),
			'mediaRole'=>array(
				'media_image_id'=>'guest',
			),
			'columnLabels'=>array(
				'team_media_image_id'=>'MediaImage',
			),
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
			),
