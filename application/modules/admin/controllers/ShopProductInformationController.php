 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ShopProductInformationController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ShopProductInformationController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ShopProductInformationController
 *
 *
 */
class Admin_ShopProductInformationController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_ProductInformation';
	private $_modelListShort = 'proinf';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'ShopProductInformation';
	...
	/**
	 * Initializes Admin_ShopProductInformationController.
	 *
	 * @return void
	 */
