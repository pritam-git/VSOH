 ...
 *
 *
 * @filesource /application/modules/admin/controllers/DepartmentController.php
 * @author     Debopam Parua <debopam.parua@bcssarl.com>
 * @version    $Id: DepartmentController.php 299 2018-12-11 19:24:38Z dp $
 */
 ...
 *
 */
class Admin_DepartmentController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_Department';
	private $_modelListShort = 'department';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Department';
	...
	/**
	 * Initializes Admin_DepartmentController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			...
			'addIgnoredM2nRelations'=>array(
				'ProtocolM2nDepartment',
				'DatesM2nDepartment',
				'NewsM2nDepartment',
				'OtcM2nDepartment',
				'AssemblyM2nDepartment',
			),
