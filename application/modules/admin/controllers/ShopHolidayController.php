 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ShopHolidayController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ShopHolidayController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ShopHolidayController
 *
 *
 */
class Admin_ShopHolidayController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_Holiday';
	private $_modelListShort = 'holi';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Holiday';
	...
	/**
	 * Initializes Admin_ShopHolidayController.
	 *
	 * @return void
	 */
