 ...
 *
 *
 * @filesource /application/modules/admin/controllers/EmailTemplateReplacementController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: EmailTemplateReplacementController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_EmailTemplateReplacementController
 *
 *
 */
class Admin_EmailTemplateReplacementController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_EmailTemplateReplacement';
	private $_modelListShort = 'maltr';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'EmailTemplateReplacement';
	...
	/**
	 * Initializes Admin_EmailTemplateReplacementController.
	 *
	 * @return void
	 */
