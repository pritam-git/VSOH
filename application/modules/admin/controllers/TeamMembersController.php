 ...
 *
 *
 * @filesource /application/modules/admin/controllers/TeamMembersController.php
 * @author     Debopam Parua <debopam.parua@bcssarl.com>
 * @version    $Id: TeamMembersController.php 299 2019-05-06 19:08:15Z dp $
 */

/**
 *
 *
 * Admin_TeamMembersController
 *
 *
 */
class Admin_TeamMembersController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_TeamMembers';
	private $_modelListShort = 'tmembers';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'TeamMembers';
	...
	/**
	 * Initializes Admin_TeamMembersController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			...
			'columnLabels'=>array(
				'team_members_media_image_id'=>'MediaImage',
			),
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
			),
	...
	public function createAction ()
	{
		...
		$this->_modelList->createModel($this->_modelListShort, array_merge($this->_modelListConfig, array(
			'doBeforeSave'=>array(
				'PRJ_TeamMembers_Create_BeforeSave',
			),
	...
	public function editAction ()
	{
		...
		$this->_modelList->editModel($this->_modelListShort, array_merge($this->_modelListConfig, array(
			...
			'doBeforeSave'=>array(
				'PRJ_TeamMembers_Edit_BeforeSave',
			),
			'addGeneratedColumnValues'=>array(
			),
			'addGeneratedValues'=>array(
