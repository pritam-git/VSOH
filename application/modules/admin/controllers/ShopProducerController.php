 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ShopProducerController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ShopProducerController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ShopProducerController
 *
 *
 */
class Admin_ShopProducerController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_Producer';
	private $_modelListShort = 'sprod';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Producer';
	...
	/**
	 * Initializes Admin_ShopProducerController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			...
			'mediaDirectory'=>array(
				'media_image_id'=>'/images/producer',
			),
			'mediaRole'=>array(
				'media_image_id'=>'guest',
			),
			'columnLabels'=>array(
				'producer_media_image_id'=>'Image',
			),
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
				'name'=>'text',
