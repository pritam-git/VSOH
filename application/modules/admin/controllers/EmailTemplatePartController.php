 ...
 *
 *
 * @filesource /application/modules/admin/controllers/EmailTemplatePartController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: EmailTemplatePartController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_EmailTemplatePartController
 *
 *
 */
class Admin_EmailTemplatePartController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_EmailTemplatePart';
	private $_modelListShort = 'maltp';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'EmailTemplatePart';
	...
	/**
	 * Initializes Admin_EmailTemplatePartController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			...
			'columnLabels'=>array(
				'relation_m2n_emailtemplatem2nemailtemplatepart'=>'EmailTemplate',
			),
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
