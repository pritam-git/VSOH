 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ShopProductStatusController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ShopProductStatusController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ShopProductStatusController
 *
 *
 */
class Admin_ShopProductStatusController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_ProductStatus';
	private $_modelListShort = 'spst';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'ProductStatus';
	...
	/**
	 * Initializes Admin_ShopProductStatusController.
	 *
	 * @return void
	 */
