 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ShopTagController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ShopTagController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ShopTagController
 *
 *
 */
class Admin_ShopTagController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_Tag';
	private $_modelListShort = 'shta';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Tag';
	...
	/**
	 * Initializes Admin_ShopTagController.
	 *
	 * @return void
	 */
