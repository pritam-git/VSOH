 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ContentSiteImagesController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ContentSiteImagesController.php 338 2015-04-28 09:59:47Z nm $
 */

/**
 *
 *
 * Admin_ContentSiteImagesController
 *
 *
 */
class Admin_ContentSiteImagesController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_MediaImageM2nAction';
	private $_modelListShort = 'cis';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'ContentSiteImages';
	...
	/**
	 * Initializes Admin_ContentSiteImagesController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			...
			'mediaDirectory'=>array(
				'media_image_id'=>'/images/contentsiteimages',
			),
			'mediaRole'=>array(
				'media_image_id'=>'guest',
			),
			'columnLabels'=>array(
				'media_image_m2n_action_media_image_id'=>'MediaImage',
			),
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
			),
