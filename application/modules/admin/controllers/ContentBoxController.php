 ...
 *
 *
 * @filesource /application/modules/admin/controllers/ContentBoxController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: ContentBoxController.php 299 2015-03-31 10:59:38Z nm $
 */

/**
 *
 *
 * Admin_ContentBoxController
 *
 *
 */
class Admin_ContentBoxController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_ContentBox';
	private $_modelListShort = 'cobo';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'ContentBox';
	...
	/**
	 * Initializes Admin_ContentBoxController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			...
			'mediaDirectory'=>array(
				'media_image_id'=>'/images/contentbox',
				'rollover_media_image_id'=>'/images/contentbox',
			),
			'mediaRole'=>array(
				'media_image_id'=>'guest',
				'rollover_media_image_id'=>'guest',
			),
			'columnLabels'=>array(
				'content_box_action_id'=>'Link',
				'content_box_media_image_id'=>'Image',
				'content_box_rollover_media_image_id'=>'Rollover Image',
			),
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
			),
