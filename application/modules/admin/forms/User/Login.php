 ...
 *
 *
 * @filesource /application/modules/admin/forms/User/Login.php
 ...
 *
 *
 * Admin_Form_User_Login
 *
 *
 */
class Admin_Form_User_Login extends L8M_Form
{
	...
	/**
	 * Initializes Admin_Form_User_Login instance.
	 *
	 * @return void
	 */
	public function init()
	{
		...
		if (L8M_Environment::ENVIRONMENT_DEVELOPMENT != L8M_Environment::getInstance()->getEnvironment()) {
			...
			$formEntityOptions = Doctrine_Query::create()
				->from('Default_Model_EntitySupervisor m')
				->select('m.login')
