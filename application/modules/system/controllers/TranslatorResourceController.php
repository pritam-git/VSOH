 ...
 *
 *
 * @filesource /application/modules/system/controllers/TranslatorResourceController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: TranslatorResourceController.php 303 2015-03-31 11:47:30Z nm $
 */

/**
 *
 *
 * System_TranslatorResourceController
 *
 *
 */
class System_TranslatorResourceController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_ResourceTranslator';
	private $_modelListShort = 'rtrans';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'ResourceTranslator';
	...
	/**
	 * Initializes System_TranslatorResourceController.
	 *
	 * @return void
	 */
...
//			->disableSaveWhere()
			->showListColumn('resource', 'Resource', 125, TRUE)
			->showListTranslateColumn('uresource', $this->view->translate('Translated Resource'), 125, TRUE)
//			->useDbWhere(FALSE)
//			->showAjax();
//			->doNotRedirect()
//			->setDeleteOldList()
