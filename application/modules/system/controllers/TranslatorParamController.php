 ...
 *
 *
 * @filesource /application/modules/syste/controllers/TranslatorParamController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: TranslatorParamController.php 303 2015-03-31 11:47:30Z nm $
 */

/**
 *
 *
 * System_TranslatorParamController
 *
 *
 */
class System_TranslatorParamController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_ParamTranslator';
	private $_modelListShort = 'ptrans';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'ParamTranslator';
	...
	/**
	 * Initializes System_TranslatorParamController.
	 *
	 * @return void
	 */
...
//			->disableSaveWhere()
			->showListColumn('param', 'Param', 125, TRUE)
			->showListTranslateColumn('uparam', $this->view->translate('Translated Param'), 125, TRUE)
//			->useDbWhere(FALSE)
//			->showAjax();
//			->doNotRedirect()
//			->setDeleteOldList()
