 ...
 *
 *
 * @filesource /application/modules/system/controllers/NavigationController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: NavigationController.php 303 2015-03-31 11:47:30Z nm $
 */

/**
 *
 *
 * System_NavigationController
 *
 *
 */
class System_NavigationController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_Navigation';
	private $_modelListShort = 'snav';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Navigation';
	...
	/**
	 * Initializes System_NavigationController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			...
			'columnLabels'=>array(
				'navigation_navigation_id'=>'Parent Element',
			),
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
				'title'=>'text',
