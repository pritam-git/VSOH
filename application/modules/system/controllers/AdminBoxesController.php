 ...
 *
 *
 * @filesource /application/modules/system/controllers/AdminBoxesController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: AdminBoxesController.php 303 2015-03-31 11:47:30Z nm $
 */
 ...
 *
 *
 * System_AdminBoxesController
 *
 *
 */
class System_AdminBoxesController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_BackendAdminBoxes';
	private $_modelListShort = 'admbo';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Backend - AdminBoxes';
	...
	/**
	 * Initializes System_AdminBoxesController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			'order'=>array(
				...
				'title',
				'description',
				'relation_m2n_backendadminboxesactionm2nbackendadminboxes',
				'position',
			),
			...
			'columnLabels'=>array(
				'relation_m2n_backendadminboxesactionm2nbackendadminboxes'=>'Backend AdminBox-Action',
			),
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
