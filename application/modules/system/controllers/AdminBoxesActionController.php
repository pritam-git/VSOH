 ...
 *
 *
 * @filesource /application/modules/system/controllers/AdminBoxesActionController.php
 * @author     Norbert Marks <nm@l8m.com>
 * @version    $Id: AdminBoxesActionController.php 303 2015-03-31 11:47:30Z nm $
 */
 ...
 *
 *
 * System_AdminBoxesActionController
 *
 *
 */
class System_AdminBoxesActionController extends L8M_Controller_Action
{
	/**
	 *
	 *
	 ...
	 *
	 */
	private $_modelListName = 'Default_Model_BackendAdminBoxesAction';
	private $_modelListShort = 'admba';
	private $_modelListConfig = array();
	private $_modelListUntranslatedTitle = 'Backend - AdminBoxesAction';
	...
	/**
	 * Initializes System_AdminBoxesActionController.
	 *
	 * @return void
	 */
...
//			->setDeleteOldList()
		...
		$this->_modelListConfig = array(
			...
			'columnLabels'=>array(
				'backend_admin_boxes_action_model_name_id'=>'Count new rows of Model',
				'count_not_new'=>'Count the not new rows',
			),
			'buttonLabel'=>'Save',
			'columnTypes'=>array(
			),
