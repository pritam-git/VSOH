...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
            ...
            '<div class="qq-upload-button"><a href="/" class="qq-upload-link" id="qq_upload_link_' + u.toString() + '">{uploadButtonText}</a></div>' +
        ...
        classes: {
            ...
            uploadLink: 'qq-upload-link',
            uploadInputFile: 'qq-upload-input-file',
    ...
    this._uploadLinkElement = this._options.uploadLinkElement || this._find(this._element, 'uploadLink');

    this._classes = this._options.classes;

    this._button = this._createUploadButton(this._find(this._element, 'button'));
    this._uploadInputFileElement = this._options.uploadInputElement || this._find(this._element, 'uploadInputFile');

    this._bindCancelEvent();
    this._bindUploadLinkEvent();
    this._setupDragDrop();
};
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _onComplete: function(id, fileName, result){
        ...
        if (result.success){
            ...
            var oldReason = $(this._find(item, 'failedText')).html();
            $(this._find(item, 'failedText')).html(oldReason + ': ' + errorReason);
    ...
    /**
     * delegate click event for upload link
     **/
    _bindUploadLinkEvent: function(){
        var self = this,
            uploadLink = this._uploadLinkElement;
        $('#' + uploadLink.id).attr('data-file', this._uploadInputFileElement.id);
        $('body').on('click', '#' + uploadLink.id, function(){
            $('#' + $(this).attr('data-file')).click();
            return false;
        });
    }
});
...
qq.UploadButton.prototype = {
    ...
    _createInput: function(){
        ...
        input.setAttribute("class", "qq-upload-input-file");

        var d = new Date(),
        m = d.getMilliseconds() + "",
        u = ++d + m;
        input.setAttribute("id", "qq_upload_input_file_" + u.toString());
        ...
        $('#' + input.id).parent().find('a').attr('data-file', input.id);
        return input;
    }
};
