...
--
-- Host: localhost:3306
-- Erstellungszeit: 25. Jan 2019 um 11:06
...
--
-- Tabellenstruktur für Tabelle `sales_statistics_protocol`
--

CREATE TABLE `sales_statistics_protocol` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `short` varchar(45) COLLATE utf8_bin NOT NULL,
  `name` varchar(45) COLLATE utf8_bin NOT NULL,
  `sales_statistics_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `sales_statistics_protocol_m2n_department`
--

CREATE TABLE `sales_statistics_protocol_m2n_department` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `sales_statistics_protocol_id` bigint(20) UNSIGNED NOT NULL,
  `department_id` bigint(20) UNSIGNED NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `deleted_at` datetime DEFAULT NULL
...
--
-- Tabellenstruktur für Tabelle `sales_statistics_protocol_translation`
--

CREATE TABLE `sales_statistics_protocol_translation` (
  `id` bigint(20) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `description` varchar(120) COLLATE utf8_bin DEFAULT NULL,
  `content` mediumtext COLLATE utf8_bin,
...
ALTER TABLE `action`
  ...
  ADD KEY `controller_id_idx` (`controller_id`),
...
ALTER TABLE `backend_admin_boxes_action`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `short` (`short`),
  ADD KEY `model_name_id` (`model_name_id`),
...
ALTER TABLE `backend_admin_boxes_action_m2n_backend_admin_boxes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `backend_admin_boxes_action_id` (`backend_admin_boxes_action_id`),
  ADD KEY `backend_admin_boxes_id` (`backend_admin_boxes_id`),
...
ALTER TABLE `commission_m2n_media_image`
  ADD PRIMARY KEY (`id`),
  ADD KEY `commission_id_idx` (`commission_id`),
  ADD KEY `media_image_id_idx` (`media_image_id`);
...
ALTER TABLE `content_box`
  ...
  ADD KEY `action_id_idx` (`action_id`),
  ADD KEY `position_idx` (`position`),
  ADD KEY `rollover_media_image_id_idx` (`rollover_media_image_id`);
...
ALTER TABLE `country`
  ADD PRIMARY KEY (`id`),
  ADD KEY `territory_iso_nr_idx` (`territory_iso_nr`),
  ADD KEY `iso_2` (`iso_2`),
  ADD KEY `iso_3` (`iso_3`);
...
ALTER TABLE `country_zone`
  ADD PRIMARY KEY (`id`),
  ADD KEY `country_iso_3_idx` (`country_iso_3`);
...
ALTER TABLE `coupon`
  ...
  ADD KEY `user_id` (`entity_user_id`);
...
ALTER TABLE `email_template_m2n_email_template_part`
  ...
  ADD KEY `email_template_part_id` (`email_template_part_id`),
  ADD KEY `position_idx` (`position`);
...
ALTER TABLE `entity`
  ...
  ADD KEY `fax` (`fax`),
  ADD KEY `www` (`www`),
  ADD KEY `media_image_id` (`media_image_id`),
  ADD KEY `role_id_idx` (`role_id`),
  ADD KEY `salutation_id_idx` (`salutation_id`),
  ADD KEY `billing_country_id_idx` (`billing_country_id`),
  ADD KEY `entity_role_id` (`role_id`),
...
ALTER TABLE `entity_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `entity_log_message_id_idx` (`entity_log_message_id`),
...
ALTER TABLE `flyer`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `short` (`short`),
  ADD KEY `media_image_idx` (`media_image_id`),
  ADD KEY `media_id_idx` (`media_id`);
...
ALTER TABLE `info_page`
  ...
  ADD UNIQUE KEY `short` (`short`),
  ADD KEY `position_idx` (`position`),
  ADD KEY `info_page_id_idx` (`info_page_id`);
...
ALTER TABLE `language`
  ADD PRIMARY KEY (`id`),
  ADD KEY `country_iso_2_idx` (`country_iso_2`),
  ADD KEY `iso_2` (`iso_2`);
...
ALTER TABLE `media`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `short` (`short`),
  ADD KEY `media_folder_id_idx` (`media_folder_id`),
  ADD KEY `media_type_id_idx` (`media_type_id`),
  ADD KEY `role_id_idx` (`role_id`),
  ADD KEY `entity_id_idx` (`entity_id`),
  ADD KEY `width` (`width`),
  ADD KEY `height` (`height`),
  ADD KEY `media_image_id` (`media_image_id`),
  ADD KEY `media_media_type_id` (`media_type_id`);
...
ALTER TABLE `model_column_name`
  ADD PRIMARY KEY (`id`),
  ADD KEY `model_column_id` (`model_name_id`),
  ADD KEY `model_column_name_edit_as_id` (`model_column_name_edit_as_id`),
  ADD KEY `position_idx` (`position`);
...
ALTER TABLE `model_list_column`
  ADD PRIMARY KEY (`id`),
  ADD KEY `model_list_id` (`model_list_id`),
  ADD KEY `model_column_name_id` (`model_column_name_id`),
  ADD KEY `model_list_connction_id` (`model_list_connection_id`),
  ADD KEY `position_idx` (`position`);
...
ALTER TABLE `model_list_column_export`
  ADD PRIMARY KEY (`id`),
  ADD KEY `model_list_export_id_idx` (`model_list_export_id`);
...
ALTER TABLE `navigation`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `short` (`short`),
  ADD KEY `navigation_id_idx` (`navigation_id`),
  ADD KEY `role_short_idx` (`role_short`),
  ADD KEY `position_idx` (`position`),
  ADD KEY `action_resource_idx` (`action_resource`);
...
ALTER TABLE `newsletter_subscriber`
  ADD PRIMARY KEY (`id`),
  ADD KEY `newsletter_subscriber_type_id_idx` (`newsletter_subscriber_type_id`),
  ADD KEY `salutation_id_idx` (`salutation_id`);
...
ALTER TABLE `product`
  ...
  ADD KEY `media_id_idx` (`media_id`),
  ADD KEY `product_status_id_idx` (`product_status_id`);
...
ALTER TABLE `products_options`
  ...
  ADD KEY `product_options_id_idx` (`product_options_id`);
...
ALTER TABLE `product_group`
  ...
  ADD KEY `media_image_id` (`media_image_id`),
  ADD KEY `position_idx` (`position`),
  ADD KEY `small_media_image_id_idx` (`small_media_image_id`);
...
ALTER TABLE `product_m2n_product_option_model`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_id` (`product_id`),
  ADD KEY `product_option_model_id` (`product_option_model_id`),
  ADD KEY `position_idx` (`position`);
...
ALTER TABLE `product_m2n_product_option_model_values`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_m2n_product_option_model_id_idx` (`product_m2n_product_option_model_id`);
...
ALTER TABLE `product_options_m2n_product_option_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_options_id_idx` (`product_options_id`),
  ADD KEY `product_option_items_id_idx` (`product_option_items_id`);
...
ALTER TABLE `product_order`
  ...
  ADD KEY `delivery_country_id_idx` (`delivery_country_id`),
  ADD KEY `billing_country_id_idx` (`billing_country_id`),
  ADD KEY `payment_service_id_idx` (`payment_service_id`),
  ADD KEY `entity_user_id_idx` (`entity_user_id`);
...
ALTER TABLE `product_order_item_units`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_order_item_id` (`product_order_item_id`);
...
ALTER TABLE `protocol`
  ADD PRIMARY KEY (`id`),
  ADD KEY `commission_id_idx` (`commission_id`),
  ADD KEY `en_media_id_idx` (`en_media_id`),
  ADD KEY `fr_media_id_idx` (`fr_media_id`),
  ADD KEY `de_media_id_idx` (`de_media_id`),
  ADD KEY `it_media_id_idx` (`it_media_id`);
...
--
-- Indizes für die Tabelle `sales_statistics_protocol`
--
ALTER TABLE `sales_statistics_protocol`
  ADD PRIMARY KEY (`id`),
  ADD KEY `en_media_id_idx_idx` (`en_media_id`),
  ADD KEY `fr_media_id_idx_idx` (`fr_media_id`),
  ADD KEY `de_media_id_idx_idx` (`de_media_id`),
...
--
-- Indizes für die Tabelle `sales_statistics_protocol_m2n_department`
--
ALTER TABLE `sales_statistics_protocol_m2n_department`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sales_statistics_protocol_id_idx` (`sales_statistics_protocol_id`),
  ADD KEY `department_id_idx` (`department_id`);

--
-- Indizes für die Tabelle `sales_statistics_protocol_translation`
--
ALTER TABLE `sales_statistics_protocol_translation`
  ADD PRIMARY KEY (`id`,`lang`);
...
ALTER TABLE `sales_statistics`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `sales_statistics_protocol`
--
ALTER TABLE `sales_statistics_protocol`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `sales_statistics_protocol_m2n_department`
--
ALTER TABLE `sales_statistics_protocol_m2n_department`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `dates`
  ...
  ADD CONSTRAINT `dates_en_media_id_media_id` FOREIGN KEY (`en_media_id`) REFERENCES `media` (`id`),
  ADD CONSTRAINT `dates_fr_media_id_media_id` FOREIGN KEY (`fr_media_id`) REFERENCES `media` (`id`),
  ADD CONSTRAINT `dates_it_media_id_media_id` FOREIGN KEY (`it_media_id`) REFERENCES `media` (`id`);
...
ALTER TABLE `news`
  ...
  ADD CONSTRAINT `news_en_media_id_media_id` FOREIGN KEY (`en_media_id`) REFERENCES `media` (`id`),
  ADD CONSTRAINT `news_fr_media_id_media_id` FOREIGN KEY (`fr_media_id`) REFERENCES `media` (`id`),
  ADD CONSTRAINT `news_it_media_id_media_id` FOREIGN KEY (`it_media_id`) REFERENCES `media` (`id`);
...
ALTER TABLE `protocol`
  ...
  ADD CONSTRAINT `protocol_en_media_id_media_id` FOREIGN KEY (`en_media_id`) REFERENCES `media` (`id`),
  ADD CONSTRAINT `protocol_fr_media_id_media_id` FOREIGN KEY (`fr_media_id`) REFERENCES `media` (`id`),
  ADD CONSTRAINT `protocol_it_media_id_media_id` FOREIGN KEY (`it_media_id`) REFERENCES `media` (`id`);
...
--
-- Constraints der Tabelle `sales_statistics_protocol`
--
ALTER TABLE `sales_statistics_protocol`
  ADD CONSTRAINT `sales_statistics_protocol_de_media_id_media_id` FOREIGN KEY (`de_media_id`) REFERENCES `media` (`id`),
  ADD CONSTRAINT `sales_statistics_protocol_en_media_id_media_id` FOREIGN KEY (`en_media_id`) REFERENCES `media` (`id`),
  ADD CONSTRAINT `sales_statistics_protocol_fr_media_id_media_id` FOREIGN KEY (`fr_media_id`) REFERENCES `media` (`id`),
  ADD CONSTRAINT `sales_statistics_protocol_it_media_id_media_id` FOREIGN KEY (`it_media_id`) REFERENCES `media` (`id`),
  ADD CONSTRAINT `sssi` FOREIGN KEY (`sales_statistics_id`) REFERENCES `sales_statistics` (`id`);
...
--
-- Constraints der Tabelle `sales_statistics_protocol_translation`
--
ALTER TABLE `sales_statistics_protocol_translation`
  ADD CONSTRAINT `sisi_1` FOREIGN KEY (`id`) REFERENCES `sales_statistics_protocol` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
